...
var item4a = function(t)
{
	return new Ext.ux.Portlet({
		...
		html: '<br><p style="font-family:helvetica, Georgia, serif; font-size:14px;"><b>Welcome to the OpenGEM Portal!</b><br><br>Before signing in you can view a few of the GEM outputs by selecting maps from the layer tree on the left and viewing then in the 2D or 3D view tabs above.<br><br>If you want to create your own maps, plots or tables of seismic risk- related output you will need to sign up and become a member of the GEM community.<br><br>Members can add their own data related to hazard, exposure, vulnerability, social and /or economic impact. This data can then be added to the OpenGEM calculation engine to run analysis and create new maps, plots or tables of your choice.<br><br>Your data and outputs can be published and shared with other members and might even been selected to be featured on the home page of this portal.<br><br>Sign up now!</p>',
	});
}
...
// Create control panel
		...
		earthPanel.on('earthLoaded', function(){
			...
			// Display KMLs
			// Display KMLs
			//earthPanel.fetchKml('http://www.globalquakemodel.org/gem1/risk/images/Haiti3.kmz');
			earthPanel.fetchKml('http://www.globalquakemodel.org/gem1/risk/data/indonesia.kmz');
			earthPanel.fetchKml('http://www.globalquakemodel.org/gem1/risk/data/chile.kmz');
			//earthPanel.fetchKml('http://earthquake.usgs.gov/earthquakes/catalogs/eqs7day-age_src.kmz');
			earthPanel.fetchKml('http://www.globalquakemodel.org/gem1/risk/data/Haiti3.kmz');
			//earthPanel.fetchKml('http://www.globalquakemodel.org/gem1/risk/data/US_West.kmz');
        ...
        var viewport = new Ext.Viewport({
				...
				items:[
					...
					new Ext.BoxComponent({
						...
						autoEl: {
							tag: 'div',
							html: '<div style="background-image: url(\'images/Bannerb6.png\'); background-repeat: repeat-x;"> <img src="images/Bannera6.png" style="align: left;">  <img src="images/Bannerc6.png ALIGN=RIGHT></div>'
