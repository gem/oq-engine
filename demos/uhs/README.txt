This demo provides an example of a UHS job.
...
UHS is computed on a single site (0.0, 0.0, the middle point of the source), for three periods (0.025, 0.45, 2.5), for two probabilities of exceedance (0.1, 0.02).