...
"""
Module :mod:`openquake.hazardlib.source.base` defines a base class for seismic sources.
"""
import abc
...
class SeismicSource(object):
    ...
    :param mfd:
        Magnitude-Frequency distribution for the source. See :mod:`openquake.hazardlib.mfd`.
    :param rupture_mesh_spacing:
        ...
        <openquake.hazardlib.geo.surface.base.BaseSurface.get_min_distance>` between
        the rupture surface and a site and the precision of that computation.
    :param magnitude_scaling_relationship:
        Instance of subclass of :class:`openquake.hazardlib.scalerel.base.BaseMSR` to
    ...
    def iter_ruptures(self, temporal_occurrence_model):
        ...
        :returns:
            ...
            of :class:`~openquake.hazardlib.source.rupture.ProbabilisticRupture`.
        """
    ...
    def filter_sites_by_distance_to_source(self, integration_distance, sites):
        ...
        :param integration_distance:
            ...
            should be excluded.
        :param sites:
            Instance of :class:`openquake.hazardlib.site.SiteCollection` to filter.
        :returns:
        ...
        :meth:`containment <openquake.hazardlib.geo.polygon.Polygon.intersects>`
        of site locations.
    ...
    def filter_sites_by_distance_to_rupture(cls, rupture, integration_distance,
        ...
        :param rupture:
            Instance of :class:`~openquake.hazardlib.source.rupture.Rupture` that
