...
class EventBasedTestCase(CalculatorTestCase):
    ...
    def test_case_5(self):
        expected = '''\
gmf-smltp_b2-gsimltp_X_b2_1_X_X.csv
gmf-smltp_b2-gsimltp_X_b2_2_X_X.csv
gmf-smltp_b2-gsimltp_X_b2_3_X_X.csv
gmf-smltp_b2-gsimltp_X_b2_4_X_X.csv
gmf-smltp_b2-gsimltp_X_b2_5_X_X.csv
gmf-smltp_b3-gsimltp_X_X_X_b4_1.csv'''.split()
    ...
    def test_case_17(self):  # oversampling
        expected = [
            'hazard_curve-smltp_b1-gsimltp_X-ltr_0.csv',
