...
def rathje_saygili_2009(pga, mag, crit_accel):
    ...
    log_Disp = (4.89 -4.85*(crit_accel/pga) -
                19.64*(np.power((crit_accel/pga), 2)) +
                42.49*(np.power((crit_accel/pga), 3)) -
                29.06*(np.power((crit_accel/pga), 4)) +
                0.72*(np.log(pga)) + 0.89*(mag-6))
