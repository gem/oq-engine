...
class test_lateral_spreading(unittest.TestCase):
    ...
    def test_hazus_displacement_correction_factor(self):
        ...
        corrs = np.array([-0.0163 , 0.02033406, 0.05897747, 0.10031577,
            0.14503448, 0.19381913, 0.24735526, 0.30632838, 0.37142404,
            0.44332776, 0.52272508, 0.61030151, 0.7067426 , 0.81273387,
    ...
    def test_hazus_lateral_spreading_displacements_fn(self):
        ...
        """
        pga = np.linspace(0., 4., num=20)
        pga_threshold = 1.
        mag = 7.5

        disps = np.array([ 0. , 0. , 0. , 0. , 0. , 0.64855263, 3.24276316,
            5.83697368, 8.43118421, 11.02539474, 14.26815789, 18.15947368,
            22.05078947, 25.94210526, 29.83342105, 42.15592105, 57.28881579,
            72.42171053, 87.55460526, 102.6875 ])
    ...
    def test_hazus_lateral_spreading_displacements_2(self):
        mag = 7.5
        pga = 0.7
        ds = hazus_lateral_spreading_displacement(mag, pga, 
            ['n','l', 'm', 'h', 'vh'])

        ds_answer = np.array([0., 1.391073, 3.825452, 5.955533, 9.505667])
    ...
    def test_hazus_lateral_spreading_displacements_3(self):
        ...
        ds_answer = np.array([0. , 3.99933571, 5.04264067, 4.43404611,
            0.41732199])
