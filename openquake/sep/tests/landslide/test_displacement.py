...
class CriticalAccelerationLandslideTestCase(unittest.TestCase):
    def setUp(self):
...
class Jibson2007ALandslideTestCase(unittest.TestCase):
...
class Jibson2007BLandslideTestCase(unittest.TestCase):
...
class ChoRathje2022LandslideTestCase(unittest.TestCase):
...
class FotopoulouPitilakis2015ATestCase(unittest.TestCase):
...
class FotopoulouPitilakis2015BTestCase(unittest.TestCase):
...
class FotopoulouPitilakis2015CTestCase(unittest.TestCase):
...
class FotopoulouPitilakis2015DTestCase(unittest.TestCase):
...
class SaygiliRathje2008LandslideTestCase(unittest.TestCase):    
...
class RathjeSaygili2009LandslideTestCase(unittest.TestCase):
...
class JibsonEtAl2000LandslideTestCase(unittest.TestCase):
