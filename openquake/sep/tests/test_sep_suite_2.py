...
class test_liquefaction_cali_small(unittest.TestCase):
    ...
    #     session_instance = PickableInferenceSession(model_instance.model)
    ...
    def test_todorovic_2022_performance(self):
        model_instance = TodorovicSilva2022NonParametric()
        model_instance.prepare(self.sites)
        session_instance = PickableInferenceSession(model_instance.model)
        ...
        print(f"Average execution time for {num_iterations} iterations: {average_execution_time} seconds")
