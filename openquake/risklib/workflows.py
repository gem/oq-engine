...
class RiskModel(collections.Mapping):
    ...
    def gen_outputs(self, getters):
        ...
        for getter in getters:
            for taxonomy, assets, hazards_by_imt, epsilons in getter.get_all():
                for imt, hazards in hazards_by_imt.iteritems():
...
class HazardGetter(object):
    ...
    def get_all(self):
        ...
        for taxonomy in self.taxonomies:
            ...
            for asset, hazard in zip(self.assets, self.hazards):
