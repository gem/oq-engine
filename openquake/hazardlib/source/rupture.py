...
def from_array(aw):
    ...
    for rec in aw.array:
        ...
        dic['trt'] = aw.trts[int(dic.pop('trt_smrlz'))]
...
class EBRupture(object):
    ...
    """
    def __init__(self, rupture, source_id, trt_smrlz, n_occ, id=None, e0=0):
...
class RuptureProxy(object):
    ...
    def to_ebr(self, trt):
        ...
        ebr = EBRupture(rupture, self.rec['source_id'], self.rec['trt_smrlz'],
