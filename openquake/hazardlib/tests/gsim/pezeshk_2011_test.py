...
class Pezeshk2011NEHRPBCv2EtAlTestCase(BaseGSIMTestCase):
    GSIM_CLASS = PezeshkEtAl2011NEHRPBCv2

    # Test data generated by adjustment using Atkinson & Boore factors

    def test_mean(self):
        self.check('PEZE11/PZ11_NEHRPBCv2_MEAN.csv',
                    max_discrep_percentage=0.1)

    def test_std_total(self):
        self.check('PEZE11/PZ11_NEHRPBCv2_STD_TOTAL.csv',
                    max_discrep_percentage=0.1)
