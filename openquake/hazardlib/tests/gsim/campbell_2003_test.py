...
class Campbell2003TestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('C03/C03_MEAN.csv',
...
class Campbell2003SHARETestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('C03/C03SHARE_MEAN.csv',
...
class Campbell2003MblgAB1987NSHMP2008TestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('C03/C03MblgAB1987NSHMP2008_MEAN.csv',
                       mean_discrep_percentage=0.1)

        self.check_all('C03/C03MblgAB1987NSHMP2008_STD_TOTAL.csv',
                       mean_discrep_percentage=0.1)
...
class Campbell2003MblgJ1996NSHMP2008TestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('C03/C03MblgJ1996NSHMP2008_MEAN.csv',
                       mean_discrep_percentage=0.1)

        self.check_all('C03/C03MblgJ1996NSHMP2008_STD_TOTAL.csv',
                       mean_discrep_percentage=0.1)
...
class Campbell2003MwNSHMP2008TestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('C03/C03MwNSHMP2008_MEAN.csv',
                       mean_discrep_percentage=0.1)

        self.check_all('C03/C03MwNSHMP2008_STD_TOTAL.csv',
                       mean_discrep_percentage=0.1)
