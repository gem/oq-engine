...
class YoungsEtAl1997SInterTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('YOUNGS97/Y97SInter_MEAN.csv',
...
class YoungsEtAl1997SSlabTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('YOUNGS97/Y97SSlab_MEAN.csv',
...
class YoungsEtAl1997GSCSSlabBestTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('YOUNGS97/YoungsEtAl1997GSCSSlabBest_MEAN.csv',
                       mean_discrep_percentage=0.1)

        self.check_all('YOUNGS97/Y97SSlab_STD_TOTAL.csv',
                       mean_discrep_percentage=0.1)
...
class YoungsEtAl1997GSCSSlabUpperLimitTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('YOUNGS97/YoungsEtAl1997GSCSSlabUpperLimit_MEAN.csv',
                       mean_discrep_percentage=0.1)
        self.check_all('YOUNGS97/Y97SSlab_STD_TOTAL.csv',
                       mean_discrep_percentage=0.1)
...
class YoungsEtAl1997GSCSSlabLowerLimitTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('YOUNGS97/YoungsEtAl1997GSCSSlabLowerLimit_MEAN.csv',
                       mean_discrep_percentage=0.1)
        self.check_all('YOUNGS97/Y97SSlab_STD_TOTAL.csv',
                       mean_discrep_percentage=0.1)
...
class YoungsEtAl1997SInterNSHMP2008TestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('YOUNGS97/Y97SInterNSHMP2008_MEAN.csv',
                       'YOUNGS97/Y97SInterNSHMP2008_STD_TOTAL.csv',
                       mean_discrep_percentage=2.5,
