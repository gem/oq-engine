...
class TestHolmgrenEtAl2024:
    def test_compute(self):
        ...
        exp_mean = np.array([
            [-2.4936514159, -3.0783936155, -3.7084378429],
            [-1.9685742536, -2.2137751952, -3.0388964021],
            [-3.9753512378, -4.4172188885, -5.0932912071],
            [1.1588399246, 0.6698328485, 0.2047343766],
        ])
        exp_sig = np.array([
