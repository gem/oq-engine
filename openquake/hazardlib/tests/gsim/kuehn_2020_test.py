...
class KuehnEtAl2020SInterAlaskaTestCase(BaseGSIMTestCase):
    ...
    def test_mean(self):
        self.check_all(self.MEAN_FILE,
                       mean_discrep_percentage=0.1, region="USA-AK")
...
class KuehnEtAl2020SInterCascadiaTestCase(BaseGSIMTestCase):
    ...
    def test_mean(self):
        self.check_all(self.MEAN_FILE,
                       mean_discrep_percentage=0.1, region="CAS")
...
class KuehnEtAl2020SInterCentralAmericaMexicoTestCase(BaseGSIMTestCase):
    ...
    def test_mean(self):
        self.check_all(self.MEAN_FILE,
                       mean_discrep_percentage=0.1, region="CAM")
...
class KuehnEtAl2020SInterJapanTestCase(BaseGSIMTestCase):
    ...
    def test_mean(self):
        self.check_all(self.MEAN_FILE,
                       mean_discrep_percentage=0.1, region="JPN")
...
class KuehnEtAl2020SInterNewZealandTestCase(BaseGSIMTestCase):
    ...
    def test_mean(self):
        self.check_all(self.MEAN_FILE,
                       mean_discrep_percentage=0.1, region="NZL")
...
class KuehnEtAl2020SInterSouthAmericaTestCase(BaseGSIMTestCase):
    ...
    def test_mean(self):
        self.check_all(self.MEAN_FILE,
                       mean_discrep_percentage=0.1, region="SAM")
...
class KuehnEtAl2020SInterTaiwanTestCase(BaseGSIMTestCase):
    ...
    def test_mean(self):
        self.check_all(self.MEAN_FILE,
                       mean_discrep_percentage=0.1, region="TWN")
