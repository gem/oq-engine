...
class ChiouYoungs2008TestCase(BaseGSIMTestCase):
    ...
    def test_total_stddev_hanging_wall_strike_slip_measured(self):
        self.check_all('NGA/CY08/CY08_SIGMEAS_MS_HW_SS.csv',
                       mean_discrep_percentage=0.015)

    def test_total_stddev_hanging_wall_strike_slip_inferred(self):
        self.check_all('NGA/CY08/CY08_SIGINFER_MS_HW_SS.csv',
                       mean_discrep_percentage=0.015)

    def test_mean_hanging_wall_normal_slip(self):
        self.check_all('NGA/CY08/CY08_MEDIAN_MS_HW_NM.csv',
                       mean_discrep_percentage=0.05)

    def test_mean_hanging_wall_reversed_slip(self):
        self.check_all('NGA/CY08/CY08_MEDIAN_MS_HW_RV.csv',
                       mean_discrep_percentage=0.05)

    def test_mean_hanging_wall_strike_slip(self):
        self.check_all('NGA/CY08/CY08_MEDIAN_MS_HW_SS.csv',
                       mean_discrep_percentage=0.05)

    def test_inter_event_stddev(self):
        # data generated from opensha
        self.check_all('NGA/CY08/CY08_INTER_EVENT_SIGMA.csv',
                       mean_discrep_percentage=0.002)

    def test_intra_event_stddev(self):
        # data generated from opensha
        self.check_all('NGA/CY08/CY08_INTRA_EVENT_SIGMA.csv',
