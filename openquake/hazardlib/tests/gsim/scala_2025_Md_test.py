...
"""
from openquake.hazardlib.gsim.scala_2025_Md import (Scala2025CampiFlegrei_repi_Md)
...
class Scala2025CampiFlegrei_repi_MdTestCase(BaseGSIMTestCase):
    """
    Tests the Scala 2025 GMM using Mw and Repi as covariates.
    """
    GSIM_CLASS = Scala2025CampiFlegrei_repi_Md
