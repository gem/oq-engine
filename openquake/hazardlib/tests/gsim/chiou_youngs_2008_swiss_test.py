...
class ChiouYoungs2008SWISS06TestCase(BaseGSIMTestCase):
    ...
    def test_mean_hanging_wall_normal_slip(self):
        self.check('CY08Swiss/CY08_MEDIAN_MS_HW_NM_VsK-6.csv', max_discrep_percentage=0.80) 

    def test_mean_hanging_wall_reversed_slip(self):
        self.check('CY08Swiss/CY08_MEDIAN_MS_HW_RV_VsK-6.csv', max_discrep_percentage=0.80)

    def test_mean_hanging_wall_strike_slip(self):
        self.check('CY08Swiss/CY08_MEDIAN_MS_HW_SS_VsK-6.csv', max_discrep_percentage=0.80)
...
class ChiouYoungs2008SWISS04TestCase(BaseGSIMTestCase):
    ...
    def test_mean_hanging_wall_normal_slip(self):
        self.check('CY08Swiss/CY08_MEDIAN_MS_HW_NM_VsK-4_corr.csv', max_discrep_percentage=0.80) 

    def test_mean_hanging_wall_reversed_slip(self):
        self.check('CY08Swiss/CY08_MEDIAN_MS_HW_RV_VsK-4_corr.csv', max_discrep_percentage=0.80)

    def test_mean_hanging_wall_strike_slip(self):
        self.check('CY08Swiss/CY08_MEDIAN_MS_HW_SS_VsK-4_corr.csv', max_discrep_percentage=0.80)
