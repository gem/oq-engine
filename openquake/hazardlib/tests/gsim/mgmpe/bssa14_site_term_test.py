...
exp_with_bssa14 = np.array([[3.17033675, 3.22928793, 3.28381535, 3.31383328],
       [3.52351981, 3.62115171, 3.71145723, 3.76117136],
       [0.55712445, 0.59754355, 0.63492955, 0.65551094]])


class BSSA14SiteTermTestCase(unittest.TestCase):

    def test_instantiation(self):
        mgmpe = BSSA14SiteTerm(gmpe_name='BooreEtAl2014')
    ...
    def test_all(self):
        """
        Check that the BSSA14 site term applied to reference conditions
        ...
        bssa14 = valid.gsim('BooreEtAl2014')
        gmpe = valid.modified_gsim(bssa14)
        mgmpe = BSSA14SiteTerm(gmpe_name='BooreEtAl2014')
        ...
        ctx.vs30 = 760. # BSSA14 reference velocity
        ctx.vs30measured = 1
        ...
        aae(mea[1], exp_with_bssa14)  # (original vs modified with
        aae(mea[2], exp_with_bssa14)  # with site term)