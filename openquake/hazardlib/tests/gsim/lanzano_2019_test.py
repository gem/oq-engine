...
from openquake.hazardlib.gsim.lanzano_2019 import LanzanoEtAl2019_RJB_OMO_scaled
...
class LanzanoEtAl2019_RJB_OMO_scaled_TestCase(BaseGSIMTestCase):
    GSIM_CLASS = LanzanoEtAl2019_RJB_OMO_scaled
