...
class EdwardsFah2013Foreland10BarsTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('EF13f/for_sd10_table.csv',
                       mean_discrep_percentage=0.55)

    def test_std_total(self):
        self.check_all('EF13f/ef_2013_phis_ss_embeded.csv',
...
class EdwardsFah2013Foreland20BarsTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('EF13f/for_sd20_table.csv',
                   mean_discrep_percentage=0.55)
...
class EdwardsFah2013Foreland30BarsTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('EF13f/for_sd30_table.csv',
                       mean_discrep_percentage=0.55)
...
class EdwardsFah2013Foreland50BarsTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('EF13f/for_sd50_table.csv',
                       mean_discrep_percentage=0.55)
...
class EdwardsFah2013Foreland60BarsTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('EF13f/for_sd60_table.csv',
                       mean_discrep_percentage=0.55)
...
class EdwardsFah2013Foreland75BarsTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('EF13f/for_sd75_table.csv',
                       mean_discrep_percentage=0.55)
...
class EdwardsFah2013Foreland90BarsTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('EF13f/for_sd90_table.csv',
                       mean_discrep_percentage=0.55)
...
class EdwardsFah2013Foreland120BarsTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all('EF13f/for_sd120_table.csv',
                       mean_discrep_percentage=0.55)
