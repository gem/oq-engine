...
class PitilakisEtAl2018TestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all("sera_site/Pitilakis2018Amplification_MEAN.csv",
...
class PitilakisEtAl2020TestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all("sera_site/Pitilakis2020Amplification_MEAN.csv",
                       mean_discrep_percentage=MAX_DISCREP,
                       gmpe_name="BindiEtAl2014Rjb")
...
class Eurocode8AmplificationTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all("sera_site/Eurocode8Amplification_MEAN.csv",
                       mean_discrep_percentage=MAX_DISCREP,
                       gmpe_name="BindiEtAl2014Rjb")
...
class Eurocode8AmplificationDefaultTestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all("sera_site/EurocodeDefaultAmplification_MEAN.csv",
                       mean_discrep_percentage=MAX_DISCREP,
                       gmpe_name="BindiEtAl2014Rjb")
...
class SandikkayaDinsever2018TestCase(BaseGSIMTestCase):
    ...
    def test_all(self):
        self.check_all("sera_site/SandikkayaDinsever2018_DEFAULT_PHI0_MEAN.csv",
                       mean_discrep_percentage=MAX_DISCREP,
                       gmpe_name="BindiEtAl2014Rjb")

    def test_std_intra(self):
        self.check_all("sera_site/SandikkayaDinsever2018_"
