...
class GarciaEtAl2005SSlabTestCase(BaseGSIMTestCase):
    ...
    def test_std_total(self):
        self.check('GA05/GA05SSLab_STD_TOTAL.csv',
                    max_discrep_percentage=0.1)
    def test_std_intra(self):
        self.check('GA05/GA05SSLab_STD_INTRA.csv,
                  max_discrep_percentage=0.1)

    def test_std_inter(self):
        self.check('GA05/GA05SSLab_STD_INTER.csv',
                  max_discrep_percentage=0.1)
...
class GarciaEtAl2005SSlabVertTestCase(BaseGSIMTestCase):
    ...
    def test_mean(self):
        self.check('GA05/GA05SSLab_Vert_MEAN.csv',
                    max_discrep_percentage=0.1)

    def test_std_total(self):
        self.check('GA05/GA05SSLab_Vert_STD_TOTAL.csv',
                    max_discrep_percentage=0.1)
    def test_std_intra(self):
        self.check('GA05/GA05SSLab_Vert_STD_INTRA.csv,
                  max_discrep_percentage=0.1)

    def test_std_inter(self):
        self.check('GA05/GA05SSLab_Vert_STD_INTER.csv',
                  max_discrep_percentage=0.1)
