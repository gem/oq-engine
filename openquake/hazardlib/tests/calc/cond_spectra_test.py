...
class CondSpectraTestCase(unittest.TestCase):
    ...
    def test_1_rlz(self):
        ...
        aac(spectra.flatten(), [0.19164881, 0.23852505, 0.27692626, 0.35103066,
                                ...
                                0.15524817, 0.11027446, 0.04034665], rtol=6E-6)
        aac(s_sigma.flatten(), [0.330842, 0.371069, 0.389733, 0.27167,
                                0.028163, 0.237042, 0.320751, 0.464589,
                                0.558016, 0.598383, 0.708094], atol=6E-6)
