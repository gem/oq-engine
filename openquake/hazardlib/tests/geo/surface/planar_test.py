...
class PlanarSurfaceGetClosestPointsTestCase(unittest.TestCase):
    ...
    def test_point_above_surface(self):
        ...
        aac(res.lats, [-0.00081824,  0.04919223])
        aac(res.depths, [1.0113781, 1.50822185])
...
class PlanarSurfaceGetMiddlePointTestCase(unittest.TestCase):
    def test(self):
        ...
        aac(midpoint.longitude, 0.0, decimal=5)
        aac(midpoint.latitude, 0.044966, decimal=5)
        aac(midpoint.depth, 5.0, decimal=5)
    ...
    def test_topo(self):
        ...
        aac(midpoint.longitude, 0.0, decimal=5)
        aac(midpoint.latitude, 0.044966, decimal=5)
        aac(midpoint.depth, -4.0, decimal=5)
