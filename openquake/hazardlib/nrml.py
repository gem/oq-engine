...
class SourceModel(collections.abc.Sequence):
    ...
    def __fromh5__(self, dic, attrs):
        ...
        for grp_name, grp in dic.items():
            trt = grp.attrs['trt']
            srcs = [grp[src_id] for src_id in sorted(grp)]
...
validators = {
    ...
    'bGR': valid.positivefloat,
    'bAC': valid.positivefloat,
    'gamma': valid.positivefloat,
    'deltaMagAC': valid.positivefloat,
    'totalRate': valid.positivefloat,
    'refMagGR': valid.positivefloat,
    'rateRefGR': valid.positivefloat,
    'refMagAC': valid.positivefloat,
    'rateRefAC': valid.positivefloat,
