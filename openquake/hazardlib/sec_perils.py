...
3. a ``compute(mag, gmfs, sites)`` method called during the calculation of
   the GMFs; gmvs is an array of shape (N1, M) and sites is a (filtered)
   site collection with N1 sites (normally N1 < N, the total number of sites)
...
is the number of outputs, i.e. one array per each output column.
"""
import abc
import inspect
