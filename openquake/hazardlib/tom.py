...
class PoissonTOM(object):
    ...
    """
    _slots_ = ['time_span', 'occurrence_rate', 'mfd_normalised']

    def __init__(self, time_span, occurrence_rate=None, mfd_normalised=False):
        if time_span <= 0:
            raise ValueError('time_span must be positive')
        self.time_span = time_span
        self.occurrence_rate = occurrence_rate
        self.mfd_normalised = mfd_normalised
