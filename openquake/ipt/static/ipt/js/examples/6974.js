...
*/
    ...
    $(cf_obj['vol'].pfx + ' div[name="ashfall-input"] select[name="in-type"]').val('text').triggerHandler('change');
    ...
    $(cf_obj['vol'].pfx + ' div[name="pyroclasticflow-input"] select[name="in-type"]').val('text-to-wkt').triggerHandler('change');
