...
COMMENT ON COLUMN oqmif.exposure_data.coco_deductible IS 'insurance deductible';
COMMENT ON COLUMN oqmif.exposure_data.coco IS 'contents cost';
COMMENT ON COLUMN oqmif.exposure_data.coco_limit IS 'insurance coverage limit';
