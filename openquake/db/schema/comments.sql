...
COMMENT ON COLUMN uiapi.oq_params.disagg_results_dir IS 'Path where intermediate and final disaggregation matrix results should be saved. In a distributed environment this would be the path to an NFS mount';
