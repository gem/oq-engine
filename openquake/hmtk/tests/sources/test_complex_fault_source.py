...
class TestComplexFaultSource(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.trace_line = [
            line.Line([point.Point(1.0, 0.0, 1.0), point.Point(0.0, 1.0, 0.9)])
        ]
        self.trace_line.append(
            line.Line(
                [
                    point.Point(1.2, 0.0, 40.0),
                    point.Point(1.0, 1.0, 45.0),
                    point.Point(0.0, 1.3, 42.0),
                ]
            )
        )
        self.trace_array = [np.array([[1.0, 0.0, 1.0], [0.0, 1.0, 0.9]])]
        self.trace_array.append(
            np.array([[1.2, 0.0, 40.0], [1.0, 1.0, 45.0], [0.0, 1.3, 42.0]])
        )
    ...
    def test_create_oqhazardlib_complex_fault_source(self):
        ...
        complex_edges = [
            line.Line(
                [point.Point(11.0, 10.0, 0.0), point.Point(10.0, 10.0, 0.0)]
            ),
            line.Line(
                [point.Point(11.5, 10.0, 21.0), point.Point(10.0, 10.0, 21.0)]
            ),
        ]
