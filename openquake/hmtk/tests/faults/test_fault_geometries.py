...
from openquake.hmtk.faults.fault_models import (
    SimpleFaultGeometry,
...
class TestSimpleGeometry(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dip = 90.0  # Simple Vertical Strike-Slip fault
        # Total downdip width = 20. km
        self.upper_depth = 0.0
        self.lower_depth = 20.0
        self.fault = None
    ...
    def test_simple_fault_instantiation(self):
        ...
        self.fault = SimpleFaultGeometry(
            self.trace, self.dip, self.upper_depth, self.lower_depth
        )
        self.assertListEqual(sorted(self.fault.__dict__), expected_keys)
        self.assertAlmostEqual(self.fault.length, 60.0, 5)
    ...
    def test_simple_get_area_vertical(self):
        ...
        self.assertAlmostEqual(1200.0, self.fault.get_area(), 5)
        self.assertAlmostEqual(20.0, self.fault.downdip_width, 5)
        self.assertAlmostEqual(0.0, self.fault.surface_width, 5)
    ...
    def test_simple_get_area_dipping(self):
        ...
        self.assertAlmostEqual(2400.0, self.fault.get_area(), 5)
        self.assertAlmostEqual(40.0, self.fault.downdip_width, 5)
