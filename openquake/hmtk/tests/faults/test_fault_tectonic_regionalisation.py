...
class TestCheckUtil(unittest.TestCase):
    ...
    def test_error_weights_not_1(self):
        ...
        self.assertEqual(
            str(ae.exception), "Bad Test 1 weights do not sum to 1.0!"
        )
...
class TestTectonicRegion(unittest.TestCase):
    ...
    def test_input_values(self):
        ...
        expected_dict = {
            "id": "001",
            "region_name": "Test 0",
            "shear_modulus": [(28.0, 0.5), (32.0, 0.5)],
            "disp_length_ratio": [(1.0e-4, 1.0)],
            "scaling_rel": [(WC1994, 1.0)],
        }

        shear_mod = [(28.0, 0.5), (32.0, 0.5)]
        dlr = [(1.0e-4, 1.0)]
        msr = [(WC1994, 1.0)]
        self.tect_reg = TectonicRegion(
            "001",
            "Test 0",
...
class TestTectonicRegionalisation(unittest.TestCase):
    ...
    def test_basic_instantiation(self):
        ...
        self.assertDictEqual(
            {"regionalisation": [], "key_list": []}, self.tect_reg.__dict__
        )
        ...
        region_dict = [
            {
                "Code": "001",
                "Name": "Active Shallow",
                "Shear_Modulus": [(20.0, 0.3), (30.0, 0.7)],
