...
RADIAN_CONV = np.pi / 180.0
SECS_PER_YEAR = 365.25 * 24.0 * 60.0 * 60.0
...
CRB_PARAMS = {
    ...
    "beta": 0.65,
    "corner_mag": 7.64,
    "tGR_moment_rate": 1.67e12,
    "length": 18126.0,
    "velocity": 18.95,
    "assumed_dip": 55.0,
    "assumed_mu": 27.7,
    "line_integral": 5.5e8,
    "coupled_thickness": 3.0,
    "lithosphere": 6.0,
    "coupling": 0.50,
    "adjustment_factor": 1.001,
    "area": None,
}
...
CTF_PARAMS = {
    ...
    "beta": 0.65,
    "corner_mag": 8.01,
    "tGR_moment_rate": 3.8e12,
    "length": 19375.0,
    "velocity": 21.54,
    "assumed_dip": 73.0,
    "assumed_mu": 27.7,
    "line_integral": 4.4e8,
    "coupled_thickness": 8.6,
    "lithosphere": 12.0,
    "coupling": 0.72,
    "adjustment_factor": 1.001,
    "area": None,
...
CCB_PARAMS = {
    ...
    "beta": 0.62,
    "corner_mag": 8.46,
    "tGR_moment_rate": 1.06e13,
    "length": 12516.0,
    "velocity": 18.16,
    "assumed_dip": 20.0,
    "assumed_mu": 27.7,
    "line_integral": 6.0e8,
    "coupled_thickness": 18.0,
    "lithosphere": 13.0,
    "coupling": 1.0,
    "adjustment_factor": 1.001,
    "area": None,
...
OSRnor_PARAMS = {
    ...
    "beta": 0.92,
    "corner_mag": 5.86,
    "tGR_moment_rate": 6.7e11,
    "length": 61807.0,
    "velocity": 46.40,
    "assumed_dip": 55.0,
    "assumed_mu": 25.7,
    "line_integral": 5.0e9,
    "coupled_thickness": 0.13,
    "lithosphere": 8.0,
    "coupling": 0.01,
...
OSRoth_PARAMS = {
    ...
    "beta": 0.82,
    "corner_mag": 7.39,
    "tGR_moment_rate": 1.9e11,
    "length": 61807.0,
    "velocity": 7.58,
    "assumed_dip": 55.0,
    "assumed_mu": 25.7,
    "line_integral": 4.7e8,
    "coupled_thickness": 0.40,
    "lithosphere": 8.0,
    "coupling": 0.05,
    "adjustment_factor": 1.619,
    "area": None,
...
OTFslo_PARAMS = {
    ...
    "beta": 0.64,
    "corner_mag": 8.14,
    "tGR_moment_rate": 6.7e12,
    "length": 27220.0,
    "velocity": 20.68,
    "assumed_dip": 73.0,
    "assumed_mu": 25.7,
    "line_integral": 5.2e8,
    "coupled_thickness": 13.0,
    "lithosphere": 14.0,
    "coupling": 0.93,
    "adjustment_factor": 1.619,
    "area": None,
...
OTFmed_PARAMS = {
    ...
    "beta": 0.65,
    "corner_mag": 6.55,
    "tGR_moment_rate": 9.4e11,
    "length": 10351.0,
    "velocity": 57.53,
    "assumed_dip": 73.0,
    "assumed_mu": 25.7,
    "line_integral": 5.3e8,
    "coupled_thickness": 1.8,
    "lithosphere": 14.0,
    "coupling": 0.13,
    "adjustment_factor": 1.619,
    "area": None,
...
OTFfas_PARAMS = {
    ...
    "beta": 0.73,
    "corner_mag": 6.63,
    "tGR_moment_rate": 9.0e11,
    "length": 6331.0,
    "velocity": 97.11,
    "assumed_dip": 73.0,
    "assumed_mu": 25.7,
    "line_integral": 5.5e8,
    "coupled_thickness": 1.6,
    "lithosphere": 14.0,
    "coupling": 0.11,
    "adjustment_factor": 1.619,
    "area": None,
...
OCB_PARAMS = {
    ...
    "beta": 0.53,
    "corner_mag": 8.04,
    "tGR_moment_rate": 4.6e12,
    "length": 13236.0,
    "velocity": 19.22,
    "assumed_dip": 20.0,
    "assumed_mu": 49.0,
    "line_integral": 1.2e9,
    "coupled_thickness": 3.8,
    "lithosphere": 14.0,
    "coupling": 0.27,
    "adjustment_factor": 2.000,
    "area": None,
}
...
SUB_PARAMS = {
    ...
    "beta": 0.64,
    "corner_mag": 9.58,
    "tGR_moment_rate": 2.85e14,
    "length": 38990.0,
    "velocity": 61.48,
    "assumed_dip": 14.0,
    "assumed_mu": 49.0,
    "line_integral": 1.58e10,
    "coupled_thickness": 18.0,
    "lithosphere": 26.0,
    "coupling": 0.69,
    "adjustment_factor": 3.434,
    "area": None,
}
...
for reg_type in BIRD_GLOBAL_PARAMETERS:
    ...
    if reg_type != "IPL":
        ...
        reg["coupled_thickness"] = reg["coupled_thickness"] * 1000.0
        reg["lithosphere"] = reg["lithosphere"] * 1000.0
    else:
...
class Shift(object):
    ...
    def __init__(
        self, minimum_magnitude, base_params=None, region_parameter_file=None
    ):
        """
    ...
    def calculate_activity_rate(
        self, strain_data, cumulative=False, in_seconds=False
    ):
        """
        ...
        self.strain.seismicity_rate = np.tile(
            self.base_rate, [self.strain.get_number_observations(), 1]
        )

        regionalisation_zones = (
            np.unique(self.strain.data["region"])
        ).tolist()
        ...
        for region in regionalisation_zones:
            ...
            if b"IPL" in region:
                ...
                calculated_rate = self.regionalisation[region][
                    "adjustment_factor"
                ] * self.continuum_seismicity(
            ...
            for jloc, iloc in enumerate(np.where(id0)[0]):
                ...
                self.strain.seismicity_rate[iloc, id1] = calculated_rate[
                    jloc, id1
                ]
        ...
        if not in_seconds:
            self.strain.seismicity_rate = (
                self.strain.seismicity_rate * SECS_PER_YEAR
            )
    ...
    def continuum_seismicity(
        self, threshold_moment, e1h, e2h, err, region_params
    ):
        """
        ...
        e2_rate = 0.0 - e1_rate - e3_rate
        # Pre-allocate seismicity rate with zeros
        seismicity_rate = np.zeros(
            [np.shape(strain_values)[0], len(threshold_moment)], dtype=float
        )
    ...
    def _reclassify_Bird_regions_with_data(self):
        ...
        self.strain.data["region"][self.strain.data["region"] == b"IPL"] = [
            "IPL"
        ]
        self.strain.data["region"][self.strain.data["region"] == b"S"] = [
            "SUB"
        ]
        self.strain.data["region"][self.strain.data["region"] == b"O"] = [
            "OCB"
        ]
        ...
        for iloc in np.where(id0)[0]:
            cond = (
                self.strain.data["e1h"][iloc] > 0.0
                and self.strain.data["e2h"][iloc] > 0.0
            )
            if cond:
            ...
            # Effective == 0.0
                ...
                (self.strain.data["e1h"][iloc] * self.strain.data["e2h"][iloc])
                < 0.0
            ) and (
                (self.strain.data["e1h"][iloc] + self.strain.data["e2h"][iloc])
                >= 0.0
