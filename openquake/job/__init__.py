...
define_param('DAMPING', 'damping', default=0.0, modes=('event_based', 'deterministic'))

define_param('INTENSITY_MEASURE_LEVELS', 'imls', modes='classical')
define_param('POES_HAZARD_MAPS', 'poes', modes='classical')

define_param('GROUND_MOTION_CORRELATION', 'gm_correlated', modes=('deterministic', 'event_based'))

define_param('INVESTIGATION_TIME', 'investigation_time', default=0.0, modes=('classical', 'event_based'))
define_param('MINIMUM_MAGNITUDE', 'min_magnitude', default=0.0, modes=('classical', 'event_based'))
define_param('NUMBER_OF_LOGIC_TREE_SAMPLES', 'realizations', modes=('classical', 'event_based'))

define_param('NUMBER_OF_GROUND_MOTION_FIELDS_CALCULATIONS', 'gmf_calculation_number', modes='deterministic')
define_param('RUPTURE_SURFACE_DISCRETIZATION', 'rupture_surface_discretization', modes='deterministic')
...
define_param('INCLUDE_SUBDUCTION_FAULT_SOURCE', 'include_subduction_fault_source', modes=('classical', 'event_based'))
#define_param('GMPE_LOGIC_TREE_FILE', 'gmpe_logic_tree_file')
define_param('GRID_SOURCE_MAGNITUDE_SCALING_RELATIONSHIP', 'grid_source_magnitude_scaling_relationship')
define_param('STANDARD_DEVIATION_TYPE', 'standard_deviation_type', modes=('classical', 'event_based'))
define_param('SUBDUCTION_FAULT_RUPTURE_OFFSET', 'subduction_fault_rupture_offset', modes=('classical', 'event_based'))
define_param('AREA_SOURCE_DISCRETIZATION', 'area_source_discretization', modes=('classical', 'event_based'))
define_param('FAULT_MAGNITUDE_SCALING_SIGMA', 'fault_magnitude_scaling_sigma', modes=('classical', 'event_based'))
define_param('RISK_CELL_SIZE', 'risk_cell_size')
#define_param('SOURCE_MODEL_LOGIC_TREE_FILE', 'source_model_logic_tree_file')
define_param('WIDTH_OF_MFD_BIN', 'width_of_mfd_bin', modes=('classical', 'event_based'))
define_param('AREA_SOURCE_MAGNITUDE_SCALING_RELATIONSHIP', 'area_source_magnitude_scaling_relationship', modes=('classical', 'event_based'))
define_param('SOURCE_MODEL_LT_RANDOM_SEED', 'source_model_lt_random_seed', modes=('classical', 'event_based'))
define_param('INCLUDE_FAULT_SOURCE', 'include_fault_source', modes=('classical', 'event_based'))
...
define_param('RUPTURE_ASPECT_RATIO', 'rupture_aspect_ratio', modes=('classical', 'event_based'))
define_param('COMPUTE_MEAN_HAZARD_CURVE', 'compute_mean_hazard_curve', modes='classical')
define_param('SUBDUCTION_FAULT_MAGNITUDE_SCALING_RELATIONSHIP', 'subduction_fault_magnitude_scaling_relationship', modes=('classical', 'event_based'))
define_param('FAULT_RUPTURE_OFFSET', 'fault_rupture_offset', modes=('classical', 'event_based'))
define_param('RUPTURE_FLOATING_TYPE', 'rupture_floating_type', modes=('classical', 'event_based'))
