...
class Starmap(object):
    ...
    def submit_all(self):
        ...
        if dist == 'slurm':
            ...
            # read the file with the hostnames generated by the worker nodes
            with open(os.path.join(self.monitor.calc_dir, 'hostnames')) as f:
                hosts = f.readlines()
            host_cores[:] = [f'{host} -1' for host in hosts]
