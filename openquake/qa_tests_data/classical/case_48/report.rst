...
+--------------------+--------+---------+--------+---------+---------+
| preclassical       | 1      | 0.00141 | nan    | 0.00141 | 0.00141 |
+--------------------+--------+---------+--------+---------+---------+
...
------------------
+-------------------------+-----------+-----------+--------+
| calc_164, maxmem=0.5 GB | time_sec  | memory_mb | counts |
+-------------------------+-----------+-----------+--------+
| importing inputs        | 0.10917   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| composite source model  | 0.10635   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| total read_source_model | 0.00153   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| total preclassical      | 0.00141   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| weighting sources       | 4.849E-04 | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| splitting sources       | 4.778E-04 | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+