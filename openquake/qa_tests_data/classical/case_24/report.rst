...
+--------------------+--------+---------+--------+---------+---------+
| preclassical       | 1      | 0.05009 | nan    | 0.05009 | 0.05009 |
+--------------------+--------+---------+--------+---------+---------+
...
------------------
+-------------------------+----------+-----------+--------+
| calc_191, maxmem=0.6 GB | time_sec | memory_mb | counts |
+-------------------------+----------+-----------+--------+
| importing inputs        | 0.12624  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| composite source model  | 0.12318  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| total preclassical      | 0.05009  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| splitting sources       | 0.02906  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| weighting sources       | 0.02052  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
