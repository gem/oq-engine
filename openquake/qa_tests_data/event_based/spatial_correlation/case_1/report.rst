...
+--------------------+--------+---------+--------+---------+---------+
| preclassical       | 1      | 0.00120 | nan    | 0.00120 | 0.00120 |
+--------------------+--------+---------+--------+---------+---------+
...
------------------
+-------------------------+-----------+-----------+--------+
| calc_105, maxmem=0.4 GB | time_sec  | memory_mb | counts |
+-------------------------+-----------+-----------+--------+
| importing inputs        | 0.10257   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| composite source model  | 0.09988   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| total read_source_model | 0.00139   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| total preclassical      | 0.00120   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| weighting sources       | 4.237E-04 | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| splitting sources       | 3.786E-04 | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+