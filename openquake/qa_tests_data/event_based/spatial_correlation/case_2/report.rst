...
------------------
+-------------------------+-----------+-----------+--------+
| calc_107, maxmem=0.4 GB | time_sec  | memory_mb | counts |
+-------------------------+-----------+-----------+--------+
| importing inputs        | 0.09749   | 0.02344   | 1      |
+-------------------------+-----------+-----------+--------+
| composite source model  | 0.07843   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| total read_source_model | 0.00136   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| total preclassical      | 0.00116   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| weighting sources       | 4.084E-04 | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| splitting sources       | 3.643E-04 | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+