...
+-------------------+------+-------+------+-------+--------+
| preclassical      |1     |0.00159|nan   |0.00159|0.00159 |
+-------------------+------+-------+------+-------+--------+
...
------------------
+-------------------------+---------+---------+-------+
| calc_3412, maxmem=0.2 GB|time_sec |memory_mb|counts |
+-------------------------+---------+---------+-------+
| composite source model  |0.07500  |0.0      |1      |
+-------------------------+---------+---------+-------+
| total read_source_model |0.00172  |0.0      |1      |
+-------------------------+---------+---------+-------+
| total preclassical      |0.00159  |0.0      |1      |
+-------------------------+---------+---------+-------+
| weighting sources       |5.476E-04|0.0      |1      |
+-------------------------+---------+---------+-------+
| splitting sources       |5.052E-04|0.0      |1      |
+-------------------------+---------+---------+-------+