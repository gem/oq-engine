...
+--------------------+--------+---------+--------+---------+---------+
| preclassical       | 1      | 0.00118 | nan    | 0.00118 | 0.00118 |
+--------------------+--------+---------+--------+---------+---------+
...
------------------
+-------------------------+-----------+-----------+--------+
| calc_106, maxmem=0.4 GB | time_sec  | memory_mb | counts |
+-------------------------+-----------+-----------+--------+
| importing inputs        | 0.08689   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| composite source model  | 0.08434   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| total read_source_model | 0.00188   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| total preclassical      | 0.00118   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| weighting sources       | 4.163E-04 | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| splitting sources       | 3.757E-04 | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+