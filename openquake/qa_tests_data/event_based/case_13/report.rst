...
------------------
+-------------------------+-----------+-----------+--------+
| calc_117, maxmem=0.5 GB | time_sec  | memory_mb | counts |
+-------------------------+-----------+-----------+--------+
| importing inputs        | 0.11005   | 0.13672   | 1      |
+-------------------------+-----------+-----------+--------+
| composite source model  | 0.10736   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| total read_source_model | 0.00148   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| total preclassical      | 0.00125   | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| weighting sources       | 4.437E-04 | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+
| splitting sources       | 3.879E-04 | 0.0       | 1      |
+-------------------------+-----------+-----------+--------+