...
+-----------+------+-----------+-----------+--------------+
| 1;1       | A    | 0.20501   | 3         | 2_456        |
+-----------+------+-----------+-----------+--------------+
| 1;0       | A    | 0.19509   | 3         | 2_456        |
+-----------+------+-----------+-----------+--------------+
...
+--------------------+--------+---------+--------+---------+---------+
| preclassical       | 2      | 0.12485 | 2%     | 0.12158 | 0.12812 |
+--------------------+--------+---------+--------+---------+---------+
| read_source_model  | 2      | 0.00350 | 0%     | 0.00348 | 0.00352 |
+--------------------+--------+---------+--------+---------+---------+
...
------------------
+-------------------------+----------+-----------+--------+
| calc_116, maxmem=1.1 GB | time_sec | memory_mb | counts |
+-------------------------+----------+-----------+--------+
| importing inputs        | 1.12903  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| composite source model  | 1.10921  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| total preclassical      | 0.24970  | 0.65625   | 2      |
+-------------------------+----------+-----------+--------+
| splitting sources       | 0.20048  | 0.65625   | 2      |
+-------------------------+----------+-----------+--------+
| weighting sources       | 0.04834  | 0.0       | 2      |
+-------------------------+----------+-----------+--------+
| total read_source_model | 0.00700  | 0.31641   | 2      |
+-------------------------+----------+-----------+--------+