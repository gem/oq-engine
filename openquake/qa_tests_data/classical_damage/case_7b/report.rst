...
+--------------------+--------+---------+--------+---------+---------+
| preclassical       | 1      | 0.08436 | nan    | 0.08436 | 0.08436 |
+--------------------+--------+---------+--------+---------+---------+
...
------------------
+-------------------------+----------+-----------+--------+
| calc_90, maxmem=0.7 GB  | time_sec | memory_mb | counts |
+-------------------------+----------+-----------+--------+
| importing inputs        | 0.13948  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| composite source model  | 0.10840  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| total preclassical      | 0.08436  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| weighting sources       | 0.07559  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| splitting sources       | 0.00835  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
