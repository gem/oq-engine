...
+-------------------+------+-------+------+-------+--------+
| preclassical      |1     |0.18061|nan   |0.18061|0.18061 |
+-------------------+------+-------+------+-------+--------+
...
------------------
+-------------------------+--------+---------+-------+
| calc_3508, maxmem=0.3 GB|time_sec|memory_mb|counts |
+-------------------------+--------+---------+-------+
| total preclassical      |0.18061 |0.0      |1      |
+-------------------------+--------+---------+-------+
| weighting sources       |0.15153 |0.0      |1      |
+-------------------------+--------+---------+-------+
| composite source model  |0.08945 |0.0      |1      |
+-------------------------+--------+---------+-------+
| splitting sources       |0.02852 |0.0      |1      |
+-------------------------+--------+---------+-------+
