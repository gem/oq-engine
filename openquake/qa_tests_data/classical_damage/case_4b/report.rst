...
+--------------------+--------+---------+--------+---------+---------+
| preclassical       | 1      | 0.09597 | nan    | 0.09597 | 0.09597 |
+--------------------+--------+---------+--------+---------+---------+
...
------------------
+-------------------------+----------+-----------+--------+
| calc_87, maxmem=0.7 GB  | time_sec | memory_mb | counts |
+-------------------------+----------+-----------+--------+
| importing inputs        | 0.16311  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| composite source model  | 0.11556  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| total preclassical      | 0.09597  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| weighting sources       | 0.08622  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
| splitting sources       | 0.00933  | 0.0       | 1      |
+-------------------------+----------+-----------+--------+
