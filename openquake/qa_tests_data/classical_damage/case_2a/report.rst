...
+-------------------+------+-------+------+-------+--------+
| preclassical      |1     |0.17246|nan   |0.17246|0.17246 |
+-------------------+------+-------+------+-------+--------+
...
------------------
+-------------------------+--------+---------+-------+
| calc_3509, maxmem=0.3 GB|time_sec|memory_mb|counts |
+-------------------------+--------+---------+-------+
| total preclassical      |0.17246 |0.0      |1      |
+-------------------------+--------+---------+-------+
| weighting sources       |0.14649 |0.0      |1      |
+-------------------------+--------+---------+-------+
| composite source model  |0.11757 |0.0      |1      |
+-------------------------+--------+---------+-------+
| splitting sources       |0.02537 |0.0      |1      |
+-------------------------+--------+---------+-------+
