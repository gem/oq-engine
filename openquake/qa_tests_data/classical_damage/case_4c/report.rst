...
+-------------------+------+-------+------+-------+--------+
| preclassical      |1     |0.15398|nan   |0.15398|0.15398 |
+-------------------+------+-------+------+-------+--------+
...
------------------
+-------------------------+--------+---------+-------+
| calc_3517, maxmem=0.3 GB|time_sec|memory_mb|counts |
+-------------------------+--------+---------+-------+
| total preclassical      |0.15398 |0.0      |1      |
+-------------------------+--------+---------+-------+
| weighting sources       |0.12785 |0.0      |1      |
+-------------------------+--------+---------+-------+
| composite source model  |0.11141 |0.0      |1      |
+-------------------------+--------+---------+-------+
| splitting sources       |0.02556 |0.0      |1      |
+-------------------------+--------+---------+-------+
