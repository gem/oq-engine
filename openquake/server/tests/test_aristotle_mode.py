...
class EngineServerAristotleModeTestCase(EngineServerTestCase):
    ...
    def aristotle_run_then_remove(self, params, failure_reason=None):
    ...
    @unittest.skip("FIXME: to be implemented")
    def test_aristotle_successful_run_FIXME_then_remove_calc(self):
        pass
    ...
    @unittest.skip("FIXME: to be implemented")
    def test_aelo_failing_site_association_error(self):
        pass
        # params = dict(
    ...
    @unittest.skip("FIXME: to be implemented")
    def aristotle_invalid_input(self, params, expected_error):
    ...
    @unittest.skip("FIXME: to be implemented")
    def test_aristotle_invalid_latitude(self):
        pass
        # FIXME
