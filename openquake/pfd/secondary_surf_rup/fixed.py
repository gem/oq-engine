...
"""
Module :mod:`openquake.pfd.secondary_surf_rup.fixed` implements
a fixed probability model for Secondary Surface Rupture.
"""
...
class FixedSecondarySR(BaseSecondarySurfRup):
    ...
    def get_prob(self, mag=None, rx=None, r=None, **kwargs):
        ...
        rx : float, optional
            Horizontal distance perpendicular to fault strike (ignored).
        r : float, optional
