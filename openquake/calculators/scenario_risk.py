...
def scenario_risk(riskinputs, criskmodel, param, monitor):
    """
    ...
    for ri in riskinputs:
        for out in criskmodel.gen_outputs(ri, monitor, param['epspath']):
            r = out.rlzi
...
class ScenarioRiskCalculator(base.RiskCalculator):
    ...
    def pre_execute(self):
        ...
        self.param['epspath'] = riskinput.cache_epsilons(
            self.datastore, oq, self.assetcol, self.criskmodel, E)
        self.param['E'] = E
