...
class GmfEbRiskTestCase(CalculatorTestCase):
    def test_case_1(self):
        ...
        num_events = len(self.calc.datastore['event_loss_table/,'])
        self.assertEqual(num_events, 10)

    def test_case_2(self):
        # case with 3 sites but gmvs only on 2 sites
        self.run_calc(case_2.__file__, 'job.ini')
        alt = self.calc.datastore['event_loss_table/,']
    ...
    def test_case_master(self):
        ...
        # case_master calculation from ruptures; the tolerance has to
        # large because of https://github.com/gem/oq-engine/issues/5825
        f0 = gettemp(view('elt', calc0))
        self.assertEqualFiles('expected/elt.txt', f0, delta=5E-4)
        f2 = gettemp(view('elt', calc2))
        self.assertEqualFiles('expected/elt.txt', f2, delta=5E-4)
