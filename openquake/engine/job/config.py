...
from openquake.engine.job.params import PARAMS, PATH_PARAMS, ARRAY_RE, str2bool
...
def validate_single_param(param, name, value, errors):
    ...
    :type param: a `namedtuple` with parameter data. See
        py:class:`openquake.engine.job.params.Param`
...
def default_validators(sections, params):
    ...
    :rtype: an instance of
        :py:class:`openquake.engine.config.ValidatorSet`
    """
