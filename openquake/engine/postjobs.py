...
def build_ses(dstore, calcs, out_file, may_fails=()):
    """
    ...
    with hdf5.File(out_file, 'w') as h5:
        ...
        for name, ds in zip(names, dstores):
            ...
            df = views.view('occ_by_trt_smr', ds).reset_index()
            h5.import_df('occ_by_trt_smr', df, ds.calc_id)
...
def import_outputs(dstore, calcs, out_types, may_fails=()):
    """
