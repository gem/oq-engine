...
def get_num_ruptures_weight(src):
    """
    Compute the weight of a source as the number of ruptures generated by
    the source multiplied by a correction factor of 10 for SimpleFaultSources
    ...
    weight = 10 if isinstance(src, source.SimpleFaultSource) else 1
    return num_ruptures, num_ruptures * weight
