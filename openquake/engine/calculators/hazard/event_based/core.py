...
class GmfCalculator(object):
    ...
    def calc_gmf(self, r_sites, rupture, rupid_seed_pairs):
        """
...
class EventBasedHazardCalculator(general.BaseHazardCalculator):
    ...
    def post_execute(self):
        ...
        for (trt_model_id, task_no), rupture_data in \
                self.rupt_collector.iteritems():
            otm.submit(self.job.id, trt_model_id, rupture_data, task_no)
