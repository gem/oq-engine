...
from openquake.calculators import disaggregation
...
class DisaggregationCalculator(disaggregation.DisaggregationCalculator):
    """
    ...
    def __init__(self, job):
        ...
        super(DisaggregationCalculator, self).__init__(oq, monitor, calc_id)
