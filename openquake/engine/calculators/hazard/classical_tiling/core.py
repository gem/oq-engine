...
"""
import math
from openquake.baselib import split_in_blocks
...
class ClassicalTilingHazardCalculator(base.Calculator):
    """
    ...
    def run_tile(self, tile):
        ...
        classical.post_processing()

    def pre_execute(self):
        self.oqparam = self.job.get_params()
        ...
        weight = len(self.site_collection) * num_levels
        self.tiles = split_in_blocks(self.site_collection,
                                     math.ceil(weight, MAX_TILE_WEIGHT))
