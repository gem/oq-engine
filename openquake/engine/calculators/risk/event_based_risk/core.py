...
@tasks.oqtask
def event_based(job_id, workflow, risk_input, outputdict, params):
    """
    ...
    with db.transaction.commit_on_success(using='job_init'):
        return do_event_based(
            workflow, risk_input, outputdict, params, monitor)


def do_event_based(workflow, risk_input, outputdict, params, monitor):
    """
    See `event_based` for a description of the params

    :returns: the event loss table generated by workflow
    """
