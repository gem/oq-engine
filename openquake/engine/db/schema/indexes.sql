...
-- hzrdi.site_data
CREATE INDEX hzrdi_site_data_id_hazard_job_idx
ON hzrdi.site_data(id, hazard_job_id);
CREATE UNIQUE INDEX hzrdi_site_data_location_hazard_job_uniq_idx
ON hzrdi.site_data(location, hazard_job_id);
