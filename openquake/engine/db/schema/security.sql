...
GRANT SELECT,INSERT,DELETE ON hzrdr.gmf               TO oq_job_init;
...
GRANT SELECT,INSERT,UPDATE,DELETE ON hzrdr.lt_realization TO oq_job_init;
...
GRANT SELECT,INSERT,DELETE ON hzrdr.assoc_lt_rlz_trt_model TO oq_job_init;
