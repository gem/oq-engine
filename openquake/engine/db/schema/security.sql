...
GRANT ALL ON SEQUENCE riskr.aggregate_loss_data_id_seq to GROUP openquake;
...
-- riskr.aggregate_loss_data
GRANT SELECT ON riskr.aggregate_loss_data TO GROUP openquake;
GRANT SELECT,INSERT,UPDATE,DELETE ON riskr.aggregate_loss_data TO oq_reslt_writer;
