...
GRANT SELECT,INSERT,UPDATE ON hzrdr.uh_spectra        TO oq_reslt_writer;
GRANT SELECT,INSERT,UPDATE ON hzrdr.uh_spectrum       TO oq_reslt_writer;
GRANT SELECT,INSERT,UPDATE ON hzrdr.uh_spectrum_data  TO oq_reslt_writer;
