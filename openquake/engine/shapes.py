...
(-118.25, 34.04)]
    ...
    def from_simple(cls, top_left, bottom_right):
        ...
        :returns: :py:class:`openquake.engine.shapes.Region` instance
        """
    ...
    def lower_left_corner(self):
        ...
        :returns: :py:class:`openquake.engine.shapes.Site` instance
            representing the lower left corner of this region.
        """
    ...
    def lower_right_corner(self):
        ...
        :returns: :py:class:`openquake.engine.shapes.Site` instance
        representing the lower right corner of this region.
        """
    ...
    def upper_left_corner(self):
        ...
        :returns: :py:class:`openquake.engine.shapes.Site` instance
        representing the upper left corner of this region.
        """
    ...
    def upper_right_corner(self):
        ...
        :returns: :py:class:`openquake.engine.shapes.Site` instance
        representing the upper right corner of this region.
        """
...
class Site(hazardlib_geo.Point):
    ...
    def __eq__(self, other):
        ...
        :type other: :py:class:`openquake.engine.shapes.Site`
        """
