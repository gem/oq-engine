...
public class RuptureReaderTest
{
    ...
    private static final String POINT_RUPTURE_FILE = "openquake/nrml/schema/0.2/examples/point-rupture.xml";
    private static final String SIMPLE_FAULT_RUPTURE_FILE = "openquake/nrml/schema/0.2/examples/simple-fault-rupture.xml";
    private static final String COMPLEX_FAULT_RUPTURE_FILE = "openquake/nrml/schema/0.2/examples/complex-fault-rupture.xml";

    private static final String SIMPLE_FAULT_RUPTURE_FILE_NO_DEPTH = "openquake/nrml/schema/0.2/examples/failures/simple-fault-rupture-no-depth.xml";
    private static final String COMPLEX_FAULT_RUPTURE_FILE_NO_DEPTH = "openquake/nrml/schema/0.2/examples/failures/complex-fault-rupture-no-depth.xml";
