...
public class AttenRelResultsChecker {
        ...
        while (str != null) {
            ...
            if (str.equalsIgnoreCase("")) {
                ...
                if (str.trim().startsWith(intensitySetString)) {
                    ...
                    ListIterator supportedIntensityMeasureIterator =
                            imr.getSupportedIntensityMeasuresIterator();
                    ...
                    while (supportedIntensityMeasureIterator.hasNext()) {
                        DependentParameterAPI param =
                                (DependentParameterAPI) supportedIntensityMeasureIterator
                                        .next();
                        ...
                        if (param.getName().equalsIgnoreCase(
                            ...
                            if (!list.containsParameter(param))
                                list.addParameter(param);
                            Iterator it =
                                    param.getIndependentParametersIterator();
                            // adding the independent Params for the intensity
                            // Measure Param
                            while (it.hasNext()) {
                                ParameterAPI tempParam =
                                        (ParameterAPI) it.next();
                    ...
                    failedParamsSetting +=
                            "Intensity Measure Type: " + intensityMeasureName
                                    + "\n";
                }
                ...
                // file
                    ...
                    // Param
                    double yAxisParamVal =
                            new Double(str.substring(str.indexOf("=") + 1)
                                    .trim()).doubleValue();
                    decimalFormat.setMaximumFractionDigits(6);
                    failedParamsSetting +=
                            "GetValue For Param: " + "\"" + yControlName
                                    + "\": " + "\n";
                    double yAxisParamValFromSHA =
                            this.getCalculation(yAxisValue);
                    double orignNoRoundSHAVal = yAxisParamValFromSHA;
                    yAxisParamValFromSHA =
                            Double.parseDouble(decimalFormat
                                    .format(yAxisParamValFromSHA));
                    failedParamsSetting +=
                            "\tOpenSHA value for: " + "\"" + yControlName
                                    + "\" = " + yAxisParamValFromSHA;
                    failedParamsSetting +=
                            ",\tbut it should be : " + yAxisParamVal + "\n";
                    ...
                    boolean tempRsult =
                            compareResults(yAxisParamValFromSHA, yAxisParamVal);
    ...
    private String getIndependentParametersValueForTest() {
        ...
        while (it.hasNext()) {
            ...
            independentParamValue +=
                    tempParam.getName() + " = " + tempParam.getValue() + "\n\t";
        }
