 ...
 * 
 * <p>
 * Title:Field_2000_test
 * </p>
 * <p>
 * Description: Checks for the proper implementation of the Field_2000_AttenRel
 * class.
 * </p>
 * <p>
...
public class Field_2000_test implements ParameterChangeWarningListener {
	...
	private static final String FIELD_2000_RESULTS = RESULT_SET_PATH
			+ "FIELD.txt";
	...
	public void setUp() {
		...
		attenRelChecker = new AttenRelResultsChecker(field_2000,
				FIELD_2000_RESULTS, tolerence);
	}
	...
	public void testField2000_Creation() throws IOException {
		...
		// if the all the succeeds and their is no fail for any test
			...
			assertTrue("Field-2000 Test succeeded for all the test cases",
					result);
		}
	}
