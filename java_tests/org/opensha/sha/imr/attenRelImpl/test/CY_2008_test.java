...
public class CY_2008_test extends NGATest {
    ...
    public double doSingleFileTest(File file) {
        ...
        AftershockParam aftershockParam =
                (AftershockParam) cy_08.getParameter(AftershockParam.NAME);
        ...
        try {
            ArrayList<String> testDataLines =
                    FileUtils.loadFile(file.getAbsolutePath());
            ...
            for (int j = 1; j < numLines; ++j) {
                ...
                try {
                    ...
                    DistRupMinusJB_OverRupParameter distRupMinusJB_OverRupParam =
                            (DistRupMinusJB_OverRupParameter) cy_08
