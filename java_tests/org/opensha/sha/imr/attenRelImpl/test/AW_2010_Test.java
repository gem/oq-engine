...
public class AW_2010_test extends NGATest implements ParameterChangeWarningListener{

	private AW_2010_AttenRel aw_2010 = null;

	private static final String RESULT_SET_PATH = "org/opensha/sha/imr/attenRelImpl/test/AttenRelResultSetFiles/NGA_ModelsTestFiles/AW10/";
	...
	public static void main(String[] args) {
		org.junit.runner.JUnitCore.runClasses(AW_2010_test.class);
	}
	...
	public void setUp() {
		...
		aw_2010 = new AW_2010_AttenRel(this);
		aw_2010.setParamDefaults();
	...
	public double doSingleFileTest(File file) {
		...
		if(fileName.contains("MEDIAN"))  { // test mean
			...
			if(fileName.contains("SIGARB")) {
				...
				aw_2010.getParameter(ComponentParam.NAME).setValue(ComponentParam.COMPONENT_RANDOM_HORZ);
				testValString = "Std Dev of Arb Horz Comp";
			} else {
				//Std dev of geomteric mean 
				aw_2010.getParameter(ComponentParam.NAME).setValue(ComponentParam.COMPONENT_GMRotI50);
