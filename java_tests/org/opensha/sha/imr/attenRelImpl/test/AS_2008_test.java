...
public class AS_2008_test extends NGATest {
    ...
    public double doSingleFileTest(File file) {
        ...
        BooleanParameter hangingWallFlagParam =
                (BooleanParameter) as_2008
        ...
        AftershockParam aftershockParam =
                (AftershockParam) as_2008.getParameter(AftershockParam.NAME);
            ...
            for (int j = 1; j < numLines; ++j) {
                ...
                try {
                    ...
                    as_2008.getParameter(DistanceRupParameter.NAME).setValue(
                            rRup);
                    DistRupMinusJB_OverRupParameter distRupMinusJB_OverRupParam =
                            (DistRupMinusJB_OverRupParameter) as_2008
                    ...
                    double rx = Double.parseDouble(st.nextToken()); // R(x) (
                                                                    ...
                                                                    // to fault
                                                                    // strike)
                    DoubleParameter distRupMinusDistX_OverRupParam =
                            (DoubleParameter) as_2008
                    ...
                    for (int k = 0; k < num; ++k) {
                        ...
                        double result =
                                DataUtils.getPercentDiff(openSHA_Val,
                                        tested_Val);
                        if (result > discrep)
                            discrep = result;
                        if (result > tolerance) {
