...
public class Campbell_1997_test implements ParameterChangeWarningListener {
	...
	private static final String Campbell_2003_RESULTS = RESULT_SET_PATH
			+ "CB1997.txt";
	...
	public void setUp() {
		...
		attenRelChecker = new AttenRelResultsChecker(campbell_1997,
				Campbell_2003_RESULTS, tolerence);
	}
	...
	public void testCampbell1997_Creation() throws IOException {
		...
		// if the all the succeeds and their is no fail for any test
			...
			assertTrue("Campbell-1997 Test succeeded for all the test cases",
					result);
		}
	}
