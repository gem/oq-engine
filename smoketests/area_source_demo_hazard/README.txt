The demo provides an example of Classical PSHA, using a source model based on area sources.
The source model is derived from the GSHAP hazard model for South East Asia.
...
(2 by 2 degrees) located in India. Three files are generated: hazard curves, mean hazard curves -
