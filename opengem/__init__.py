...
This software may be downloaded at http://github.com/gem/opengem

The continuous integration server is at http://opengem.globalquakemodel.org
Up-to-date sphinx documentation is at http://opengem.globalquakemodel.org/docs/
