...
install_requires = [
    ...
    'pyzmq <20.0',
#   'psutil >=2.0, <5.7',
    "psutil @ https://wheelhouse.openquake.org/v2/macos/py36/psutil-5.4.3-cp36-cp36m-macosx_10_6_intel.whl ; platform_system=='MacOS'",
    "psutil @ https://wheelhouse.openquake.org/v2/linux/py36/psutil-5.4.3-cp36-cp36m-manylinux1_x86_64.whl ; platform_system=='Linux'",
    'shapely >=1.3, <1.8',
    'docutils >=0.11, <0.15',
    'decorator >=4.3',
    'django >=1.11, <2.3',
    ...
    'requests >=2.20, <2.24',
#   'pyshp ==1.2.3',
    'pyshp @ https://wheelhouse.openquake.org/v3/py/pyshp-1.2.3-py3-none-any.whl',
    'toml',
]
