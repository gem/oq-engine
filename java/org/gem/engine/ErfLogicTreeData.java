...
public class ErfLogicTreeData {
    ...
    // ERF logic tree
    private final LogicTree<ArrayList<GEMSourceData>> erfLogicTree;
    ...
    public ErfLogicTreeData(String erfInputFile) throws IOException {
        ...
        erfLogicTree = new LogicTree<ArrayList<GEMSourceData>>();
    ...
    public ErfLogicTreeData(Cache cache, String key) throws IOException {
        D = logger.isDebugEnabled();
        // instantiate logic tree
        erfLogicTree = new LogicTree<ArrayList<GEMSourceData>>();
    ...
    private void parse_tree(BufferedReader oReader) throws IOException {
        // define branching level
        LogicTreeBranchingLevel branchingLevel = null;
        // define branch
        ...
        while (sRecord != null) {
            ...
            if (sRecord.trim().equalsIgnoreCase("BranchingLevel")) {
                ...
                if (D) {
                    logger.debug("\n\n"
                            ...
                            + ", label: " + branchingLabel + ", applies to: "
                            + appliesTo + "\n");
                }
                ...
                if (appliesTo.equalsIgnoreCase("ALL")) {
                    ...
                    branchingLevel =
                            new LogicTreeBranchingLevel(branchingLevelNumber,
                                    branchingLabel, 0);
            ...
            if (sRecord.trim().equalsIgnoreCase("BranchSet")) {
                ...
                if (branchModel.equalsIgnoreCase("inputfile")) {
                    ...
                    if (D) {
                        System.out.println("BranchSet. Definition through: "
                                + branchModel + "\n" + "Rule: " + ruleName
                                + "\n" + "Uncertainty values: "
                                + uncertaintyValues + "\n"
