 ...
 * representing the area sources for calculation the seismic hazard in SE ASIA -GSHAP 
...
public class SeAsiaData extends GemFileParser{
	...
	public SeAsiaData() throws IOException{
		...
		// Area Source Model
		GshapSEAsia2GemSourceData model1 = new GshapSEAsia2GemSourceData("gshap/south_east_asia/seAsiaCorr.dat");
		// Background Area Sources Model
		GshapSEAsia2GemSourceData model2 = new GshapSEAsia2GemSourceData("gshap/south_east_asia/gshapeaBackgrd.dat");
	...
	public static void main(String[]  args) throws IOException{
		...
		model.writeAreaSources2KMLfile(new FileWriter("/Users/damianomonelli/Desktop/SEAsources.kml"));
