...
public class JapanSourceData extends GemFileParser {
	...
	public JapanSourceData(BufferedReader inputRectangularFaults, BufferedReader inputComplexFault) 
		throws IOException {
