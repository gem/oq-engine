...
public class RectangularFaultData {
	...
	public RectangularFaultData(String line){
		...
		if (aa[9].matches("\\d")) this.slip = Double.valueOf(aa[9]).doubleValue();
		this.idSecondary = 0;
		...
		if (INFO){
			System.out.printf("\nFault id ..............: %d-%d\n",this.id,this.idSecondary);
			System.out.printf("Fault name ............: %s\n",this.name);
			System.out.printf("Fault magnitude .......: %.2f\n",this.magnitude);
...
//		Location loctmp = RelativeLocation.location(loc1,strike/180.0*Math.PI,this.rectangleLenght);
		...
		GEMFaultSourceData srcData = new GEMFaultSourceData(
