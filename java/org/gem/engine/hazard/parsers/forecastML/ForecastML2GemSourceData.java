...
public class ForecastML2GemSourceData extends GemFileParser{
		...
		try{
		    ...
		    for (int i = 0; i < cellLst.getLength(); i++) {
	        	...
	        	if(mfd.getY(0)!=0.0){
				    ...
				    HypoMagFreqDistAtLoc hmfd = new HypoMagFreqDistAtLoc(mfd,new Location(lat,lon),fm);
	
				    srcDataList.add(new GEMPointSourceData(id,name,trt,hmfd,aveRupTopVsMag,defaultDepth));
	...
	public static void main(String[] args){
		...
		String inputFile = "global_smooth_seismicity/zechar.triple_s.global.rate_forecast.xml";
