...
public class NshmpIndia {
	...
	public static void main(String[] args) throws IOException {
		...
		NshmpIndiaGridData model = new NshmpIndiaGridData(latmin,latmax,lonmin,lonmax);
		
		// calculation settings
		CalculationSettings calcSet = new CalculationSettings();
		
		// set point to line source
		calcSet.getErf().get(SourceType.GRID_SOURCE).put(GEM1ERF.GRIDDED_SEIS_RUP_TYPE_NAME,GEM1ERF.GRIDDED_SEIS_RUP_TYPE_LINE);
