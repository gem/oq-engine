...
/**
 * This class combines the information obtained for three parsers
 * (to read the input models IberoMagreb, Eastern and Western Africa)  and returns a list
 * of GEMAreaSourceData. This info is used to compute the hazard for Africa
 *  @author l.danciu
 */
...
public class runAfrica {
	...
	public static void main(String[] args) throws IOException {
		...
		africaModel.writeAreaSources2KMLfile(new FileWriter("/Users/damianomonelli/Desktop/AfricaSources.kml"));
...
//		calcSet.getOut().put(IntensityMeasureParams.INTENSITY_MEAS_TYPE.toString(),PSA_Params) 
		...
		System.out.println("Number of sources considered: "+africaModel.getList().size());
		
		new GemComputeModel(africaModel.getList(), 
				modelName,
