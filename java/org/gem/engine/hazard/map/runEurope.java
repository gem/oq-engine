...
public class runEurope {
	...
	public static void main(String[] args) throws IOException {
		...
		europeModel.writeAreaSources2KMLfile(new FileWriter("/Users/damianomonelli/Desktop/EuropaSources.kml"));
		...
		//calcSet.getErf().get(SourceType.AREA_SOURCE).put(GEM1ERF.AREA_DISCR_PARAM_NAME, 0.2);
		...
		new GemComputeModel(europeModel.getList(), 
				modelName,
