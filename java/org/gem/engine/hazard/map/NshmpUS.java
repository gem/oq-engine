...
public class NshmpUS {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		// Ceus grid model
		//NshmpCeusGridData model = new NshmpCeusGridData(latmin,latmax,lonmin,lonmax);
		
		//WUS fault model
		//NshmpWusFaultData model = new NshmpWusFaultData(latmin,latmax,lonmin,lonmax);
		
		//WUS grid model
		//NshmpWusGridData model = new NshmpWusGridData(latmin,latmax,lonmin,lonmax);
