...
/**
 * The present class reads a general input file format provided by Sesame Project and used in GSHAP; 
 * returns a list of GEMAreaSourceData.
 * The following models can be read with this parser: EastMagreb, Egypt, Israel, WestAfrica
 * A slight modification of this parser would read the IberoMagreb   
 * (In the near future, these two versions will be merged in one parser)
 * @author l.danciu
 *
 */
...
//	private static boolean NorthEastAfrica = false;
	...
	//constructor
	public GshapAfrica2GemSourceData(String inputfile) throws FileNotFoundException{
...
//
//	gshapAfrica2GemSourceData eastMagrebModel = new gshapAfrica2GemSourceData("../../data/gshap/africa/eastMagreb/EastIberoMagreb.dat");
//	gshapAfrica2GemSourceData waModel = new gshapAfrica2GemSourceData("../../data/gshap/africa/westAfrica/WestAfricaInput.dat");
