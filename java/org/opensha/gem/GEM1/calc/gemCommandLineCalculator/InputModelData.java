...
public class InputModelData {
	...
	private void readAreaSourceData(BufferedReader oReader, double deltaMFD, String sourceID, String sourceName, TectonicRegionType trt) throws IOException{
        ...
        for(int i=0;i<numMfdFm;i++){
            ...
            if(mfdType.equalsIgnoreCase(GUTENBERG_RICHTER))
            {
                ...
                if(D) System.out.println("a value: "+aVal+", b value: "+bVal+", minimum magnitude: "+mMin+", maximum magnitude: "+mMax);
                
                mfd[i] = createGrMfd(aVal, bVal, mMin, mMax, deltaMFD, sourceName);
        ...
        MagFreqDistsForFocalMechs magFreqDistForFocalMech = new MagFreqDistsForFocalMechs(mfd,fm);
	...
	private void readPointSourceData(BufferedReader oReader, double deltaMFD, String sourceID, String sourceName, TectonicRegionType trt) throws IOException{
        ...
        if(D) System.out.println("Location coordinates: "+loc.getLatitude()+", "+loc.getLongitude());
	...
	private void readFaultSourceData(BufferedReader oReader, double deltaMFD, String sourceID, String sourceName, TectonicRegionType trt) throws IOException{
        ...
        if(D) System.out.println("Number of fault trace points: "+numPoint);
        ...
        if(D) System.out.println("Dip: "+dip);
        ...
        if(D) System.out.println("Rake: "+rake);
        ...
        if(D) System.out.println("Top depth: "+topDepth);
        ...
        if(D) System.out.println("Bottom depth: "+bottomDepth);
        ...
        // add to source list
        sourceList.add(new GEMFaultSourceData(sourceID, sourceName, trt, 
        		mfd,trace,dip,rake,bottomDepth,topDepth,floatRuptureFlag));
	
	}
	private void readSubductionFaultSourceData(BufferedReader oReader, double deltaMFD, String sourceID, String sourceName, TectonicRegionType trt) throws IOException{
        ...
        if(D) System.out.println("Number of top trace points: "+numPointTop);
        ...
        for(int i=0;i<numPointTop;i++){
            ...
            if(D) System.out.println("Lat: "+lat+", Lon: "+lon+", depth: "+depth);
        }
        ...
        if(D) System.out.println("Number of bottom trace points: "+numPointBottom);
        ...
        // add to source list
        sourceList.add(new GEMSubductionFaultSourceData(sourceID, sourceName, trt, 
        		topTrace,bottomTrace,rake,mfd,floatRuptureFlag));
		
	}
	
	private GutenbergRichterMagFreqDist createGrMfd(double aVal, double bVal, double mMin, double mMax, double deltaMFD, String sourceName){
        ...
        double totCumRate = Math.pow(10, aVal-bVal*mMin) - Math.pow(10, aVal-bVal*mMax);
        ...
        mfd = new GutenbergRichterMagFreqDist(bVal, totCumRate, mMin, mMax, numVal);
	...
	public static void main(String[] args) throws IOException{
		...
		InputModelData data = new InputModelData("/Users/damianomonelli/Projects/opengem/data/src_model1.dat",0.1);
