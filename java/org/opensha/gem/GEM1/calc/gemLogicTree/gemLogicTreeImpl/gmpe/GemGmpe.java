...
public class GemGmpe {
    ...
    public GemGmpe() {
        ...
        GemLogicTreeBranchingLevel braLev1gmpe =
                new GemLogicTreeBranchingLevel(1, "gmpe", 0);
        // create branch(s)
        GemLogicTreeBranch bra1gmpe =
                new GemLogicTreeBranch(1, "B&A2008_ZHAO2006", 0.5);
        GemLogicTreeBranch bra2gmpe =
                new GemLogicTreeBranch(2, "C&Y2008_ZHAO2006", 0.5);
        // add to branching level
        braLev1gmpe.addBranch(bra1gmpe);
        braLev1gmpe.addBranch(bra2gmpe);
    ...
    public
            GemLogicTree<HashMap<TectonicRegionType, ScalarIntensityMeasureRelationshipAPI>>
            getGemLogicTree() {
        return gmpeLT;
    }
