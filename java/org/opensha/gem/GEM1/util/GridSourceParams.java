...
public enum GridSourceParams {
    ...
    /**
     * Magnitude area scaling relationship. It is used for non-vertical faults.
     * Non-vertical faults are treated as 3D faults to take into account the
     * hanging wall effect.
     */
    MAG_AREA_REL("Magnitude area scaling relationship"),

    /**
     * Magnitude length scaling relationship. It is used for vertical faults,
     * because they are treated as 2D faults.
     */
    MAG_LENGTH_REL("Magnitude length scaling relationship"),

    /**
     * Cut off magnitude. Below this value the source is treated as a point
     * source.
     */
    ...
    /**
     * Top of rupture depth for events with magnitude less than the cut-off
     * magnitude.
     */
    ...
    /**
     * Top of rupture depth for events with magnitude greater than the cut-off
     * magnitude.
     */
