...
/**
 * <p>Title: RegionNotSupportedException</p>
 *
 ...
 * @version 1.0
 */
public class RegionNotSupportedException
    extends Exception {

  /**
   * Constructs a new RegionNotSupportedException with null as its detail message.
   ...
   * Constructs a new RegionNotSupportedException with the specified detail message.
   ...
   */
  public RegionNotSupportedException(String errMsg) {
    super(errMsg);
  }
}
