...
/**
 * Aftershock parameter, indicates whether or not an event is an aftershock. See
...
public class AftershockParam extends BooleanParameter {
    ...
    public final static String INFO =
            "Indicates whether earthquake is an aftershock";

    /**
     * This constructor sets the default value as "false". This also makes the
