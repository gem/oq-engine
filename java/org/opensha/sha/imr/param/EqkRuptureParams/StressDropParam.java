...
public class StressDropParam extends WarningDoubleParameter {
     ...
     */
    public StressDropParam(double minWarning, double maxWarning,
            double defaultWidth) {
     ...
     * constraint limits. The parameter is left as non editable. TODO check the
     * default value
     */
    public StressDropParam(double minWarning, double maxWarning) {
        this(minWarning, maxWarning, defaultValue);
    }
