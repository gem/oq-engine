...
/**
 * Magnitude parameter, reserved for representing moment magnitude. The warning
 * constraint must be created and added after instantiation. See constructors
 * for info on editability and default values.
 */
public class MagParam extends WarningDoubleParameter {
     ...
     */
    public MagParam(double minWarning, double maxWarning) {
        this(minWarning, maxWarning, 5.5);
    }

    /**
     * This sets the default value as given. No warning limits are set, so this
     * is left editable so warning constraints can be added.
     */
    ...
    /**
     * This sets the default value as 5.5. No warning limits are set, so this is
     * left editable so warning constraints can be added.
     */
    public MagParam() {
        this(5.5);
    }
