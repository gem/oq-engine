...
public class DipParam extends WarningDoubleParameter {
     ...
     */
    public DipParam(double minWarning, double maxWarning) {
        this(minWarning, maxWarning, 90);
    }

    /**
     * This sets the default dip as given and and leaves it editable so one can
    ...
    /**
     * This sets the default dip as 90 degrees, and and leaves it editable so
     * one can set the warning constraint.
     */
    public DipParam() {
        this(90.0);
    }
