...
/**
 * <b>Title:</b> DistanceRupParameter
 * <p>
 * 
 * <b>Description:</b> Special subclass of PropagationEffectParameter. This
 * finds the shortest distance to the fault surface.
 * <p>
 * 
 ...
 * @version 1.0
 */
public class DistRupMinusJB_OverRupParameter extends
    ...
    public DistRupMinusJB_OverRupParameter(
            ParameterConstraintAPI warningConstraint)
    ...
    public Object clone() {
        ...
        DistRupMinusJB_OverRupParameter param =
                new DistRupMinusJB_OverRupParameter();
        param.value = val2;
        param.constraint = c1;
