...
/**
 * <b>Title:</b> DistanceHypoParameter<p>
 *
 * <b>Description:</b> Special subclass of PropagationEffectParameter.
 * This finds the hypocentral distance assuming hypocenter to be
 * in the middle of the rupture. <p>
 *
 ...
 * @version     1.0
 */
public class DistanceHypoParameter
...
implements WarningParameterAPI
{
	...
	public final static String INFO = "Hypocentral Distance (assuming hypocenter in the middle of rupture)";
	...
	public DistanceHypoParameter() { init(); }
    ...
    public DistanceHypoParameter(ParameterConstraintAPI warningConstraint, double defaultValue)
        throws ConstraintException
    {
        if( ( warningConstraint != null ) && !( warningConstraint instanceof DoubleConstraint) ){
            throw new ConstraintException(
