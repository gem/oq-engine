...
/**
 * DistRupMinusDistX_OverRupParam - this represents distance X (relative to dist
 * rup, or specifically: (DistRup-DistX)/DistRup), where distance X is the
 * horizontal distance to surface projection of the top edge of the rupture,
 * extended to infinity off the ends. This is not a formal propagation parameter
 * because it's not used that way (due to inefficiencies) See constructors for
...
public class DistRupMinusDistX_OverRupParam extends DoubleParameter {
    ...
    /**
     * This sets the default value as given, and sets the parameter as non
     * editable.
     */
    ...
    /**
     * This sets the default value as 0.0, and sets the parameter as non
     * editable.
     */
