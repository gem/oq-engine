...
/**
 * Vs30 Parameter, reserved for representing the average shear-wave velocity in
 * the upper 30 meters of a site (a commonly used parameter). The warning
 * constraint must be created and added when instantiated. See constructors for
...
public class Vs30_Param extends WarningDoubleParameter {
    ...
    /**
     * This constructor sets the default value as given and leaves the param
     * editable so the warning constraint can be added.
     */
    ...
    /**
     * This constructor sets the default value as 760 m/sec and leaves the param
     * editable so the warning constraint can be added.
     */
    public Vs30_Param() {
        this(760);
    ...
    /**
     * This constructor sets the default and warning constraint as given, and
     * sets everything as non-editable.
     * 
     * @param warnMin
     * @param warnMax
     */
    ...
    /**
     * This constructor sets the default as 760 m/sec, the warning constraint as
     * given, and sets everything as non-editable.
     * 
     * @param warnMin
     * @param warnMax
     */
    public Vs30_Param(double warnMin, double warnMax) {
        this(760.0, warnMin, warnMax);
    }
