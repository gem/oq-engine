 ...
 * shear-wave velocity = 2.5 km/sec. See constructors for info on editability
 * and default values.
 */
public class DepthTo2pt5kmPerSecParam extends WarningDoubleParameter {
     ...
     * @param warnMax
     */
    public DepthTo2pt5kmPerSecParam(double defaultDepth, double warnMin,
            double warnMax) {
        super(NAME, new DoubleConstraint(MIN, MAX), UNITS);
        getConstraint().setNonEditable();
        setInfo(INFO);
    ...
    /**
     * This sets default as 1.0, uses the given warning-constraint limits, and
