 ...
 * shear-wave velocity = 1.0 km/sec. See constructors for info on editability
 * and default values.
 */
public class DepthTo1pt0kmPerSecParam extends WarningDoubleParameter {
     ...
     * @param warnMax
     */
    public DepthTo1pt0kmPerSecParam(double defaultDepth, double warnMin,
            double warnMax) {
        super(NAME, new DoubleConstraint(MIN, MAX), UNITS);
        getConstraint().setNonEditable();
        setInfo(INFO);
    ...
    /**
     * This sets default as 100, uses the given warning-constraint limits, and
