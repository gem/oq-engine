...
/**
 * SigmaTruncTypeParam, a StringParameter that represents the type of truncation
 * to be applied to the probability distribution. The constraint/options are
 * hard-coded here because changes will require changes in the probability
 * calculations elsewhere in the code. The parameter is left non editable
 */
public class SigmaTruncTypeParam extends StringParameter {
    ...
    public final static String INFO =
            "Type of distribution truncation to apply when computing exceedance probabilities";
    // Options
    ...
    /**
     * This constructor invokes the standard options ("None", "1 Sided", or
     * "2 Sided"), and sets the default as "None". The parameter is left non
     * editable.
     */
