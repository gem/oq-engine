...
/**
 * Component Parameter, reserved for representing the component of shaking (in
 * 3D space). The constraint must be provided in the constructor, and the
 * "COMPONENT_*" strings here represent common options that can be used in
 * creating the constraint (although other unique options can be added as well).
...
public class ComponentParam extends StringParameter {
    ...
    public final static String COMPONENT_GMRotI50 =
