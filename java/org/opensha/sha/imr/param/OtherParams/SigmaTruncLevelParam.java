...
/**
 * SigmaTruncLevelParam, a DoubleParameter that represents where truncation
 * occurs on the Gaussian distribution (in units of standard deviation, relative
 * to the mean). See constructors for info on editability and default values.
 */
...
public class SigmaTruncLevelParam extends DoubleParameter {
    ...
    /**
     * This constructor sets the default as given, and leaves the parameter
     * non-editable
     */
    ...
    /**
     * This constructor sets the default as 2.0, and leaves the parameter
     * non-editable
     */
