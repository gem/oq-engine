 ...
 * SA_Param as an independent parameter. See constructors for info on
...
public class DampingParam extends DoubleDiscreteParameter {
     ...
     */
    public DampingParam(DoubleDiscreteConstraint dampingConstraint) {
        this(dampingConstraint, 5.0);
    }

    /**
     * This constructor assumes that only 5% damping is supported, and sets this
     * as the default. The parameter is left non editable.
     */
    public DampingParam() {
        super(NAME, UNITS);
        double damping = 5;
