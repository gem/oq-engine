...
/**
 * This represents continuous Period for the Spectral Acceleration parameter
 * (SA_InterpolatedParam).
 * 
 * @author field
 * 
 */
public class PeriodInterpolatedParam extends DoubleParameter {
    ...
    public final static String INFO =
            "Continous oscillator period for interpolated SA";
     ...
     * @param leaveEditable
     *            - whether or not to leave editable
     */
    public PeriodInterpolatedParam(double minPeriod, double maxPeriod,
            double defaultPeriod, boolean leaveEditable) {
