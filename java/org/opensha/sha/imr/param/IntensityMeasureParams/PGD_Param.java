...
/**
 * This constitutes is for the natural-log Peak Ground Displacement intensity
 * measure parameter. See constructors for info on editability and default
 * values.
 * 
 * @author field
 * 
...
public class PGD_Param extends WarningDoubleParameter {
     ...
     * log of 0.01). The parameter is left as non editable
     */
    public PGD_Param() {
        super(NAME, new DoubleConstraint(MIN, MAX), UNITS);
        getConstraint().setNonEditable();
