...
/**
 * <b>Title:</b> CB_2003_AttenRel
 * <p>
 * 
 * <b>Description:</b> This implements the Attenuation Relationship developed by
 * Campbell & Bozorgnia (2003), Bull. Seism. Soc. Am., vol 93, num 1, pp
 * 314-331)
 * <p>
 * 
 ...
 * <LI>siteTypeParam - "Firm Soil", "Very Firm Soil", "Soft Rock", "Firm Rock",
 * "Generic Soil", "Generic Rock", or "NEHRP BC"
 ...
 * <p>
 * 
 * NOTE: The mean calculation for the site class "BC Boundary" is only
 * approximate at 0.05- and 0.075-second periods (because "bv" is not available
 * from BJF_1997 at those periods, so values were linearly interpolated between
 * 0 and 0.1 seconds) and at 3- and 4-seconds ("bv" not available from BJF_1997
 * above 2 seconds, so value at 2-seconds was applied).
 * 
...
public class CB_2003_AttenRel extends AttenuationRelationship implements
    ...
    // the minimum warning will get overridden by seisDepth is less than
    // seisDepth

    /**
     * Hanging-Wall Parameter, defined as 1 above the surface projection,
     * tapering linearly to 0.0 at 5 km from surface projection.
     */
    protected DoubleParameter hangingWallParam = null;
    public final static String HANGING_WALL_NAME = "Hanging Wall Param.";
    // no units
    public final static String HANGING_WALL_INFO =
            "1.0 if site is within surface projection of rupture, tapering (linearly) to 0.0 at 5 km beyond";
    ...
    /**
     * Sets the style of faulting from the rake & dip angles (which come from
     * the eqkRupture object). It's "Thrust" if 22.5<rake<=67.5 & dip<45
     * degrees, "Reverse" if 22.5<rake<=67.5 & dip>=45 degrees, and "Other" if
     * the rake is any other value.
     * 
     * @param rake
    ...
    public void setEqkRupture(EqkRupture eqkRupture)
        ...
        setFaultTypeFromRake(eqkRupture.getAveRake(), eqkRupture
                .getRuptureSurface().getAveDip());
     ...
     * the Site object passed in (the Site object must have these parameters in
     * it). This also sets the internally held Site object as that passed in.
     * 
     * @param site
     *            The new site object which contains the site-related
     *            parameters.
     * @throws ParameterException
     *             Thrown if the Site object doesn't contain either of these
     *             parameters.
     */
     ...
     * @param propEffect
     * @throws ParameterException
     *             Thrown if the Site object doesn't contains the site-related
     *             parameters.
     * @throws InvalidRangeException
     *             thrown if rake is out of bounds
     */
    public void setPropagationEffect(PropagationEffect propEffect)
        ...
        if (dip <= 70.0 && (fltType != FLT_TYPE_OTHER) && numPts > 1) {
            // double jbDist = ( (Double) distanceJBParam.getValue( eqkRupture,
            // site ) ).doubleValue();
            double jbDist =
                    ((Double) propEffect.getParamValue(distanceJBParam.NAME))
                            .doubleValue();
            if (jbDist < 1.0) {
        ...
        } else { // turn it off for normal, strike-slip, or vertically dipping
                 // faults
            hangingWallParam.setValue(0.0);
        }
    }
     ...
     * hangingWallParam) based on the current site and eqkRupture. The hanging
     * wall term is nonzero only if the dip is less than 70 degrees AND the
     * fault is of type reverse or thrust. Point sources are give a zero value
     * regardless of the dip and fault type. These specifications were conveyed
     * to Ned Field by Ken Campbell in a series of emails.
     */
    protected void setPropagationEffectParams() {
        ...
        if ((this.site != null) && (this.eqkRupture != null)) {
            ...
            if (dip <= 70.0 && (fltType != FLT_TYPE_OTHER) && numPts > 1) {
                double jbDist =
                        ((Double) distanceJBParam.getValue(eqkRupture, site))
                                .doubleValue();
                if (jbDist < 1.0) {
                    hangingWallParam.setValue(1.0);
                } else if (jbDist < 5.0) {
            ...
            } else { // turn it off for normal, strike-slip, or vertically
                     // dipping faults
                hangingWallParam.setValue(0.0);
            }
    ...
    protected void updateCoefficients() throws ParameterException {
        ...
        if (componentParam.getValue().toString()
            ...
            if (horzCoefficients.containsKey(key.toString())) {
                coeff =
                        (CB_2003_AttenRelCoefficients) horzCoefficients.get(key
                                .toString());
            } else {
            ...
            if (vertCoefficients.containsKey(key.toString())) {
                coeff =
                        (CB_2003_AttenRelCoefficients) vertCoefficients.get(key
                                .toString());
            } else {
                throw new ParameterException(C
                        + ": setIntensityMeasureType(): "
    ...
    /**
     * This calulates the mean assuming the coefficients have already been
     * assigned (this way PGA can be computed in getStdDev() without having to
     * override the current im).
     * 
     * @return
     * @throws IMRException
     */
    protected double calcMean() throws IMRException {
        ...
        // throw exception if user has chosen vertical component and site type
        // SITE_TYPE_NEHRP_BC
        if (componentParam.getValue().toString()
                .equals(ComponentParam.COMPONENT_VERT)
        ...
        double temp =
                Math.exp(coeff.c8 * mag + coeff.c9 * (8.5 - mag) * (8.5 - mag));
    ...
    public double getStdDev() throws IMRException {
        ...
        if (componentParam.getValue().toString()
                .equals(ComponentParam.COMPONENT_VERT)
                && siteTypeParam.getValue().toString()
                        .equals(SITE_TYPE_NEHRP_BC)) {
            throw new RuntimeException(
                    SITE_TYPE_NEHRP_BC
                            + " site type is not supported "
                            + "for the vertical component. Please choose a different site type.");
        ...
        if (stdevType.equals(StdDevTypeParam.STD_DEV_TYPE_NONE)) {
            ...
            // get the PGA coeffs (Note diff between those for PGA vs SA at zero
            // period)
            StringBuffer key = new StringBuffer(im.getName());
    ...
    protected void initPropagationEffectParams() {
        ...
        DoubleConstraint warn =
                new DoubleConstraint(DISTANCE_SEIS_WARN_MIN,
        ...
        hangingWallParam =
                new DoubleParameter(HANGING_WALL_NAME, HANGING_WALL_MIN,
                        HANGING_WALL_MAX);
    ...
    protected void initSupportedIntensityMeasureParams() {
        ...
        while (keys.hasMoreElements()) {
            CB_2003_AttenRelCoefficients coeff =
                    (CB_2003_AttenRelCoefficients) horzCoefficients.get(keys
                            .nextElement());
            if (coeff.period >= 0) {
    ...
    protected void initOtherParams() {
        ...
        stdDevTypeConstraint
                .addString(StdDevTypeParam.STD_DEV_TYPE_TOTAL_MAG_DEP);
        stdDevTypeConstraint
                .addString(StdDevTypeParam.STD_DEV_TYPE_TOTAL_PGA_DEP);
        stdDevTypeConstraint.addString(StdDevTypeParam.STD_DEV_TYPE_NONE);
        stdDevTypeConstraint.setNonEditable();
        stdDevTypeParam =
                new StdDevTypeParam(stdDevTypeConstraint,
    ...
    /**
     * This initializes the horizontal-component coeffiecients. Note that the
     * "bv" values at 0.05- and 0.075-second period were obtained by linearly
     * interpolating those at 0 and 0.1 seconds (these come from BJF_1997, and
     * are used to compute the mean for the "BC Boundary")
     */
    ...
    protected void initHorzCoefficients() {
        ...
        // PGA - this is not "Unc. PGA" (which he recommends for PGA in his
        // Table 4). but rather "Cor. PGA"
        // which he said over the phone should actually be used
        CB_2003_AttenRelCoefficients coeffPGA =
                new CB_2003_AttenRelCoefficients(PGA_Param.NAME, -1, -4.033,
                        0.812, 0.036, -1.061, 0.041, -0.005, -0.018, 0.766,
                        0.034, 0.343, 0.351, -0.123, -0.138, -0.289, 0.370,
                        0.920, 0.219, -0.371);
        // -1, -2.896, 0.812, 0.000, -1.318, 0.187, -0.029, -0.064, 0.616, 0,
        // 0.179, 0.307, -0.062, -0.195, -0.320, 0.370, 0.964, 0.263, -0.371);

        // SA/0.0 - this is "Cor. PGA" (corrected, as he recommends for SA at
        // zero period) from his Table 4
        CB_2003_AttenRelCoefficients coeff0 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.0")).doubleValue(), 0.0, -4.033,
                        0.812, 0.036, -1.061, 0.041, -0.005, -0.018, 0.766,
                        0.034, 0.343, 0.351, -0.123, -0.138, -0.289, 0.370,
                        0.920, 0.219, -0.371);
        // SA/0.05
        CB_2003_AttenRelCoefficients coeff1 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.05")).doubleValue(), 0.05, -3.740,
                        0.812, 0.036, -1.121, 0.058, -0.004, -0.028, 0.724,
                        0.032, 0.302, 0.362, -0.140, -0.158, -0.205, 0.370,
                        0.940, 0.239, -0.304);
        // SA/0.075
        CB_2003_AttenRelCoefficients coeff2 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.075")).doubleValue(), 0.075, -3.076,
                        0.812, 0.050, -1.252, 0.121, -0.005, -0.051, 0.648,
                        0.040, 0.243, 0.333, -0.150, -0.196, -0.208, 0.370,
                        0.952, 0.251, -0.250);
        // SA/0.1
        CB_2003_AttenRelCoefficients coeff3 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.1")).doubleValue(), 0.10, -2.661,
                        0.812, 0.060, -1.308, 0.166, -0.009, -0.068, 0.621,
                        0.046, 0.224, 0.313, -0.146, -0.253, -0.258, 0.370,
                        0.958, 0.257, -0.212);
        // SA/0.15
        CB_2003_AttenRelCoefficients coeff4 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.15")).doubleValue(), 0.15, -2.270,
                        0.812, 0.041, -1.324, 0.212, -0.033, -0.081, 0.613,
                        0.031, 0.318, 0.344, -0.176, -0.267, -0.284, 0.370,
                        0.974, 0.273, -0.238);
        // SA/0.2
        CB_2003_AttenRelCoefficients coeff5 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.2")).doubleValue(), 0.20, -2.771,
                        0.812, 0.030, -1.153, 0.098, -0.014, -0.038, 0.704,
                        0.026, 0.296, 0.342, -0.148, -0.183, -0.359, 0.370,
                        0.981, 0.280, -0.292);
        // SA/0.3
        CB_2003_AttenRelCoefficients coeff6 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.3")).doubleValue(), 0.30, -2.999,
                        0.812, 0.007, -1.080, 0.059, -0.007, -0.022, 0.752,
                        0.007, 0.359, 0.385, -0.162, -0.157, -0.585, 0.370,
                        0.984, 0.283, -0.401);
        // SA/0.4
        CB_2003_AttenRelCoefficients coeff7 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.4")).doubleValue(), 0.40, -3.511,
                        0.812, -0.015, -0.964, 0.024, -0.002, -0.005, 0.842,
                        -0.016, 0.379, 0.438, -0.078, -0.129, -0.557, 0.370,
                        0.987, 0.286, -0.487);
        // SA/0.5
        CB_2003_AttenRelCoefficients coeff8 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.5")).doubleValue(), 0.50, -3.556,
                        0.812, -0.035, -0.964, 0.023, -0.002, -0.004, 0.842,
                        -0.036, 0.406, 0.479, -0.122, -0.130, -0.701, 0.370,
                        0.990, 0.289, -0.553);
        // SA/0.75
        CB_2003_AttenRelCoefficients coeff9 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.75")).doubleValue(), 0.75, -3.709,
                        0.812, -0.071, -0.964, 0.021, -0.002, -0.002, 0.842,
                        -0.074, 0.347, 0.419, -0.108, -0.124, -0.796, 0.331,
                        1.021, 0.320, -0.653);
        // SA/1.0
        CB_2003_AttenRelCoefficients coeff10 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("1.0")).doubleValue(), 1.0, -3.867,
                        0.812, -0.101, -0.964, 0.019, 0, 0, 0.842, -0.105,
                        0.329, 0.338, -0.073, -0.072, -0.858, 0.281, 1.021,
                        0.320, -0.698);
        // SA/1.5
        CB_2003_AttenRelCoefficients coeff11 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("1.5")).doubleValue(), 1.5, -4.093,
                        0.812, -0.150, -0.964, 0.019, 0, 0, 0.842, -0.155,
                        0.217, 0.188, -0.079, -0.056, -0.954, 0.210, 1.021,
                        0.320, -0.704);
        // SA/2.0
        CB_2003_AttenRelCoefficients coeff12 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("2.0")).doubleValue(), 2.0, -4.311,
                        0.812, -0.180, -0.964, 0.019, 0, 0, 0.842, -0.187,
                        0.060, 0.064, -0.124, -0.116, -0.916, 0.160, 1.021,
                        0.320, -0.655);
        // SA/3.0
        CB_2003_AttenRelCoefficients coeff13 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("3.0")).doubleValue(), 3.0, -4.817,
                        0.812, -0.193, -0.964, 0.019, 0, 0, 0.842, -0.200,
                        -0.079, 0.021, -0.154, -0.117, -0.873, 0.089, 1.021,
                        0.320, -0.655);
        // SA/4.0
        CB_2003_AttenRelCoefficients coeff14 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("4.0")).doubleValue(), 4.0, -5.211,
                        0.812, -0.202, -0.964, 0.019, 0, 0, 0.842, -0.209,
                        -0.061, 0.057, -0.054, -0.261, -0.889, 0.039, 1.021,
                        0.320, -0.655);
    ...
    /**
     * This initializes the Vertical component coeffiecients. Note that the "bv"
     * values at 0.05- and 0.075-second period were obtained by linearly
     * interpolating those at 0 and 0.1 seconds (these come from BJF_1997, and
     * are used to compute the mean for the "BC Boundary")
     */
    protected void initVertCoefficients() {
        ...
        // which he said over the phone should actually be used
        CB_2003_AttenRelCoefficients coeffPGA =
                new CB_2003_AttenRelCoefficients(PGA_Param.NAME, -1, -3.108,
                        0.756, 0, -1.287, 0.142, 0.046, -0.040, 0.587, 0,
                        0.253, 0.173, -0.135, -0.138, -0.256, 0.630, 0.975,
                        0.274, -0.371);
        // -1, -2.807, 0.756, 0, -1.391, 0.191, 0.044, -0.014, 0.544, 0, 0.091,
        // 0.223, -0.096, -0.212, -0.199, 0.630, 1.003, 0.302, -0.371);

        // SA/0.0 - this is "Cor. PGA" (corrected, as he recommends for SA at
        // zero period) from his Table 4
        CB_2003_AttenRelCoefficients coeff0 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.0")).doubleValue(), 0.0, -3.108,
                        0.756, 0, -1.287, 0.142, 0.046, -0.040, 0.587, 0,
                        0.253, 0.173, -0.135, -0.138, -0.256, 0.630, 0.975,
                        0.274, -0.371);
        // SA/0.05
        CB_2003_AttenRelCoefficients coeff1 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.05")).doubleValue(), 0.05, -1.918,
                        0.756, 0, -1.517, 0.309, 0.069, -0.023, 0.498, 0,
                        0.058, 0.100, -0.195, -0.274, -0.219, 0.630, 1.031,
                        0.330, -0.304);
        // SA/0.075
        CB_2003_AttenRelCoefficients coeff2 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.075")).doubleValue(), 0.075, -1.504,
                        0.756, 0, -1.551, 0.343, 0.083, 0.000, 0.487, 0, 0.135,
                        0.182, -0.224, -0.303, -0.263, 0.630, 1.031, 0.330,
                        -0.250);
        // SA/0.1
        CB_2003_AttenRelCoefficients coeff3 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.1")).doubleValue(), 0.10, -1.672,
                        0.756, 0, -1.473, 0.282, 0.062, 0.001, 0.513, 0, 0.168,
                        0.210, -0.198, -0.275, -0.252, 0.630, 1.031, 0.330,
                        -0.212);
        // SA/0.15
        CB_2003_AttenRelCoefficients coeff4 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.15")).doubleValue(), 0.15, -2.323,
                        0.756, 0, -1.280, 0.171, 0.045, 0.008, 0.591, 0, 0.223,
                        0.238, -0.170, -0.175, -0.270, 0.630, 1.031, 0.330,
                        -0.238);
        // SA/0.2
        CB_2003_AttenRelCoefficients coeff5 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.2")).doubleValue(), 0.20, -2.998,
                        0.756, 0, -1.131, 0.089, 0.028, 0.004, 0.668, 0, 0.234,
                        0.256, -0.098, -0.041, -0.311, 0.571, 1.031, 0.330,
                        -0.292);
        // SA/0.3
        CB_2003_AttenRelCoefficients coeff6 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.3")).doubleValue(), 0.30, -3.721,
                        0.756, 0.007, -1.028, 0.050, 0.010, 0.004, 0.736,
                        0.007, 0.249, 0.328, -0.026, 0.082, -0.265, 0.488,
                        1.031, 0.330, -0.401);
        // SA/0.4
        CB_2003_AttenRelCoefficients coeff7 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.4")).doubleValue(), 0.40, -4.536,
                        0.756, -0.015, -0.812, 0.012, 0, 0, 0.931, -0.018,
                        0.299, 0.317, -0.017, 0.022, -0.257, 0.428, 1.031,
                        0.330, -0.487);
        // SA/0.5
        CB_2003_AttenRelCoefficients coeff8 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.5")).doubleValue(), 0.50, -4.651,
                        0.756, -0.035, -0.812, 0.012, 0, 0, 0.931, -0.043,
                        0.243, 0.354, -0.020, 0.092, -0.293, 0.383, 1.031,
                        0.330, -0.553);
        // SA/0.75
        CB_2003_AttenRelCoefficients coeff9 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("0.75")).doubleValue(), 0.75, -4.903,
                        0.756, -0.071, -0.812, 0.012, 0, 0, 0.931, -0.087,
                        0.295, 0.418, 0.078, 0.091, -0.349, 0.299, 1.031,
                        0.330, -0.653);
        // SA/1.0
        CB_2003_AttenRelCoefficients coeff10 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("1.0")).doubleValue(), 1.0, -4.950,
                        0.756, -0.101, -0.812, 0.012, 0, 0, 0.931, -0.124,
                        0.266, 0.315, 0.043, 0.101, -0.481, 0.240, 1.031,
                        0.330, -0.698);
        // SA/1.5
        CB_2003_AttenRelCoefficients coeff11 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("1.5")).doubleValue(), 1.5, -5.073,
                        0.756, -0.150, -0.812, 0.012, 0, 0, 0.931, -0.184,
                        0.171, 0.211, -0.038, -0.018, -0.518, 0.240, 1.031,
                        0.330, -0.704);
        // SA/2.0
        CB_2003_AttenRelCoefficients coeff12 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("2.0")).doubleValue(), 2.0, -5.292,
                        0.756, -0.180, -0.812, 0.012, 0, 0, 0.931, -0.222,
                        0.114, 0.115, 0.033, -0.022, -0.503, 0.240, 1.031,
                        0.330, -0.655);
        // SA/3.0
        CB_2003_AttenRelCoefficients coeff13 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("3.0")).doubleValue(), 3.0, -5.748,
                        0.756, -0.193, -0.812, 0.012, 0, 0, 0.931, -0.238,
                        0.179, 0.159, -0.010, -0.047, -0.539, 0.240, 1.031,
                        0.330, -0.655);
        // SA/4.0
        CB_2003_AttenRelCoefficients coeff14 =
                new CB_2003_AttenRelCoefficients(SA_Param.NAME + '/'
                        + (new Double("4.0")).doubleValue(), 4.0, -6.042,
                        0.756, -0.202, -0.812, 0.012, 0, 0, 0.931, -0.248,
                        0.237, 0.134, -0.059, -0.267, -0.606, 0.240, 1.031,
                        0.330, -0.655);
     ...
     * to calculate the Mean and StdDev for the CB_2003_AttenRel. One instance
     * of this class holds the set of coefficients for each period. The "bv"
     * coefficient is that from BJF_1997 needed for the "BC Boundary" site
     * category.<br>
    ...
    class CB_2003_AttenRelCoefficients implements NamedObjectAPI {
        ...
        /**
         * Constructor for the CB_2003_AttenRelCoefficients object that sets all
         * values at once
         * 
         * @param name
         *            Description of the Parameter
    ...
    public URL getInfoURL() throws MalformedURLException {
        return new URL(
                "http://www.opensha.org/documentation/modelsImplemented/attenRel/CB_2003.html");
    }
