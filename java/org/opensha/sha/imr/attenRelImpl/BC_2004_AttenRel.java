...
/**
 * <b>Title:</b> SiteSpecific_2006_AttenRel
 * <p>
 * 
 * <b>Description:</b> This implements the site effect models developed by
 * Bazzuro and Cornell(2004) , applied to the Abrahamson & Silva (1997)
 * rock-site predictions.
 * <p>
 * 
...
public class BC_2004_AttenRel extends AttenuationRelationship implements
    ...
    protected void updateCoefficients() throws ParameterException {
        ...
        if (horzCoeffs.containsKey(key.toString())) {
            coeffs =
                    (BC_2004_AttenRelCoefficients) horzCoeffs.get(key
                            .toString());
        } else {
    ...
    /**
     * @return The stdDev value for Bazzurro and Cornell (2004) Site Correction
     *         Model
     */
    private double getStdDevForBC() {
        ...
        double stdDev =
                Math.pow(bVal + 1, 2) * Math.pow(asRockStdDev, 2)
                        + Math.pow(stdDevAF, 2);
    ...
    class BC_2004_AttenRelCoefficients implements NamedObjectAPI {
        ...
        /**
         * Constructor for the BC_2004_AttenRelCoefficients object that sets all
         * values at once
         * 
         * @param name
