 ...
 * 
 * <p>
 * Description: This stores a list magFreqDists with associated a list of focal
 * mechanisms (each must have the same number in the list unless the focal mech
 * list is null).
 * </p>
 * 
 * @author Ned Field
...
public class MagFreqDistsForFocalMechs implements java.io.Serializable {
     ...
     * 
     * @param magDist
     *            IncrementalMagFreqDist[] list of MagFreqDist.
     */
    ...
    /**
     * Class constructor. This constructor allows user to give a single
     * magFreqDist and focalMechanism.
     * 
     * @param magDist
    ...
    /**
     * This constructor allows a user to give a single magDist, a list of
     * focalMechanisms, and a list of weights. The list of focal mechanisms is
     * made by assigning the associated weight to the the given magDist.
     * 
     * @param magDist
     *            an IncrementalMagFreqDist.
     * @param focalMechanism
     *            FocalMechanism[] list of focal mechanism for a given location.
     * @param wts
     *            - a list os weights that must be in the same order as
     *            FocalMechanism[].
     * 
     */
    public MagFreqDistsForFocalMechs(IncrementalMagFreqDist magDist,
            FocalMechanism[] focalMechanism, double[] wt) {
    ...
    /**
     * Returns the first MagFreqDist from the list. This function can be used
     * when there are not multiple MagFreqDists and no Focal Mechanism,
     * 
     * @return IncrementalMagFreqDist
     */
