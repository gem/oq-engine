...
public interface EqkRupForecastAPI extends EqkRupForecastBaseAPI {
     ...
     * pointer to the source held internally, so that if any parameters are
     * changed, and this method is called again, the source obtained by any
     * previous call to this method will no longer be valid. This is done for
     * memory conservation.
     * 
     * @param iSource
     *            : index of the desired source (only "0" allowed here).
     * 
