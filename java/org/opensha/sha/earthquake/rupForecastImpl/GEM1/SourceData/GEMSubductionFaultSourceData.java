...
public class GEMSubductionFaultSourceData extends GEMSourceData implements
        Serializable {
    ...
    public GEMSubductionFaultSourceData(FaultTrace TopTrace,
            FaultTrace BottomTrace, double rake, IncrementalMagFreqDist mfd,
    ...
    // constructor. TectonicRegionType defaults to SUBDUCTION_INTERFACE here.
    public GEMSubductionFaultSourceData(String id, String name,
            TectonicRegionType tectReg, FaultTrace TopTrace,
            FaultTrace BottomTrace, double rake, IncrementalMagFreqDist mfd,
            boolean floatRuptureFlag) {
        this.id = id;
        this.name = name;
