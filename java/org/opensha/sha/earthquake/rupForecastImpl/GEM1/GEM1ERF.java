...
public class GEM1ERF extends EqkRupForecast {
    ...
    final static double MINMAG = 0; // this sets the minimum mag considered in
                                    // the forecast (overriding that implied in
                                    // the source data)
    ...
    public final static String INCLUDE_AREA_SRC_PARAM_NAME =
            "Include Area Sources?";
    public final static String INCLUDE_SRC_PARAM_INFO =
            "These sources will be excluded if this is unchecked";
    ...
    public final static String AREA_SRC_MAG_SCALING_REL_PARAM_NAME =
            "Area Source Mag-Scaling";
    private final static String AREA_SRC_MAG_SCALING_REL_PARAM_INFO =
    ...
    // Whether or not to include these sources
    public final static String INCLUDE_GRIDDED_SEIS_PARAM_NAME =
            "Include Gridded Seis Sources?";
    ...
    // Mag-scaling relationship for turning grip points into finite ruptures
    public final static String GRIDDED_SEIS_MAG_SCALING_REL_PARAM_NAME =
            "Gridded Seis Mag-Scaling";
    private final static String GRIDDED_SEIS_MAG_SCALING_REL_PARAM_INFO =
            " Mag-scaling relationship for computing size of background events";
    ...
    // Whether or not to include these sources
    public final static String INCLUDE_FAULT_SOURCES_PARAM_NAME =
            "Include Fault Sources?";
    ...
    public final static String FAULT_MAG_SCALING_REL_PARAM_NAME =
            "Fault Rupture Scaling";
    private final static String FAULT_MAG_SCALING_REL_PARAM_INFO =
            " Mag-scaling relationship for computing size of floaters";
    StringParameter faultMagScalingRelParam;

    // Mag-scaling sigma parameter stuff
    public final static String FAULT_SCALING_SIGMA_PARAM_NAME =
            "Fault Scaling Sigma";
    ...
    public final static String FAULT_RUP_ASPECT_RATIO_PARAM_NAME =
    ...
    public final static String FAULT_FLOATER_TYPE_PARAM_INFO =
            "Specifies how to float ruptures around the faults";
    public final static String FLOATER_TYPE_FULL_DDW =
            "Only along strike ( rupture full DDW)";
    public final static String FLOATER_TYPE_ALONG_STRIKE_AND_DOWNDIP =
            "Along strike and down dip";
    public final static String FLOATER_TYPE_CENTERED_DOWNDIP =
            "Along strike & centered down dip";
    public final static String FAULT_FLOATER_TYPE_PARAM_DEFAULT =
    ...
    // Whether or not to include these sources
    public final static String INCLUDE_SUBDUCTION_SOURCES_PARAM_NAME =
            "Include Subduction-Zone Sources?";
    ...
    // Mag-scaling relationship parameter stuff
    public final static String SUB_MAG_SCALING_REL_PARAM_NAME =
            "Subduction-Zone Rupture Scaling";
    private final static String SUB_MAG_SCALING_REL_PARAM_INFO =
            " Mag-scaling relationship for computing size of floaters";
    StringParameter subductionMagScalingRelParam;

    // Mag-scaling sigma parameter stuff
    public final static String SUB_SCALING_SIGMA_PARAM_NAME =
    ...
    // rupture aspect ratio parameter stuff
    public final static String SUB_RUP_ASPECT_RATIO_PARAM_NAME =
    ...
    // Floater Type
    public final static String SUB_FLOATER_TYPE_PARAM_NAME =
            "Subduction Fault Floater Type";
    public final static String SUB_FLOATER_TYPE_PARAM_INFO =
            "Specifies how to float ruptures around subduction zones";
    public final static String SUB_FLOATER_TYPE_FULL_DDW =
            "Only along strike ( rupture full DDW)";
    public final static String SUB_FLOATER_TYPE_ALONG_STRIKE_AND_DOWNDIP =
            "Along strike and down dip";
    public final static String SUB_FLOATER_TYPE_CENTERED_DOWNDIP =
            "Along strike & centered down dip";
    public final static String SUB_FLOATER_TYPE_PARAM_DEFAULT =
            FLOATER_TYPE_ALONG_STRIKE_AND_DOWNDIP;
    StringParameter subductionFloaterTypeParam;

    public final static String SOURCE_CACHE_PARAM_NAME = "Cache Sources";
    public final static String SOURCE_CACHE_PARAM_INFO =
            "Enables caching of sources for faster repeated computations"
     ...
     * CalculationSettings object. Set any list as null if there are no
    ...
    protected void parseSourceListIntoDifferentTypes(
        ...
        if (areaSourceDataList.size() == 0)
            areaSourceDataList = null;
        if (griddedSeisSourceDataList.size() == 0)
            griddedSeisSourceDataList = null;
        if (faultSourceDataList.size() == 0)
            faultSourceDataList = null;
        if (subductionSourceDataList.size() == 0)
            subductionSourceDataList = null;
    }
    ...
    private void initAdjParams() {
        ...
        // minimum magnitude
        minMagParam =
                new DoubleParameter(MIN_MAG_NAME, MIN_MAG_MIN, MIN_MAG_MAX,
                        MIN_MAG_UNITS, MIN_MAG_DEFAULT);
        minMagParam.setInfo(MIN_MAG_INFO);

        // ----------------------------------------------------------------------------
        // AREA SOURCES

        includeAreaSourceParam =
                new BooleanParameter(INCLUDE_AREA_SRC_PARAM_NAME,
                        INCLUDE_SRC_PARAM_DEFAULT);
        ...
        areaSrcRupTypeParam =
                new StringParameter(AREA_SRC_RUP_TYPE_NAME,
                        areaSeisRupOptionsStrings, AREA_SRC_RUP_TYPE_POINT);

        // Area lower seismogenic depth parameter
        areaSrcLowerSeisDepthParam =
                new DoubleParameter(AREA_SRC_LOWER_SEIS_DEPTH_PARAM_NAME,
        ...
        areaSrcLowerSeisDepthParam
                .setInfo(GRIDDED_SEIS_LOWER_SEIS_DEPTH_PARAM_INFO);

        // Area discretization parameter
        areaSrcDiscrParam =
                new DoubleParameter(AREA_SRC_DISCR_PARAM_NAME,
                        AREA_SRC_DISCR_PARAM_MIN, AREA_SRC_DISCR_PARAM_MAX,
                        AREA_SRC_DISCR_PARAM_UNITS,
        ...
        areaSrcMagScalingRelParam =
                new StringParameter(AREA_SRC_MAG_SCALING_REL_PARAM_NAME,
                        magScalingRelAreaOptions,
        ...
        includeGriddedSeisParam =
                new BooleanParameter(INCLUDE_GRIDDED_SEIS_PARAM_NAME,
                        INCLUDE_SRC_PARAM_DEFAULT);
        ...
        griddedSeisRupTypeParam =
                new StringParameter(GRIDDED_SEIS_RUP_TYPE_NAME,
                        backSeisRupOptionsStrings, GRIDDED_SEIS_RUP_TYPE_POINT);

        griddedSeisLowerSeisDepthParam =
                new DoubleParameter(GRIDDED_SEIS_LOWER_SEIS_DEPTH_PARAM_NAME,
                        GRIDDED_SEIS_LOWER_SEIS_DEPTH_PARAM_MIN,
                        GRIDDED_SEIS_LOWER_SEIS_DEPTH_PARAM_MAX,
                        GRIDDED_SEIS_LOWER_SEIS_DEPTH_PARAM_UNITS,
                        GRIDDED_SEIS_LOWER_SEIS_DEPTH_PARAM_DEFAULT);
        griddedSeisLowerSeisDepthParam
                .setInfo(GRIDDED_SEIS_LOWER_SEIS_DEPTH_PARAM_INFO);
        ...
        griddedSeisMagScalingRelParam =
                new StringParameter(GRIDDED_SEIS_MAG_SCALING_REL_PARAM_NAME,
                        magScalingRelBackgrOptions,
                        WC1994_MagLengthRelationship.NAME);
        griddedSeisMagScalingRelParam
                .setInfo(GRIDDED_SEIS_MAG_SCALING_REL_PARAM_INFO);

        // ---------------------------------------------------------------------------
        // FAULT SOURCES

        includeFaultSourcesParam =
                new BooleanParameter(INCLUDE_FAULT_SOURCES_PARAM_NAME,
                        INCLUDE_SRC_PARAM_DEFAULT);
        includeFaultSourcesParam.setInfo(INCLUDE_SRC_PARAM_INFO);

        // Rupture offset
        faultRupOffsetParam =
                new DoubleParameter(FAULT_RUP_OFFSET_PARAM_NAME,
                        FAULT_RUP_OFFSET_PARAM_MIN, FAULT_RUP_OFFSET_PARAM_MAX,
                        FAULT_RUP_OFFSET_PARAM_UNITS, RUP_OFFSET_DEFAULT);
        faultRupOffsetParam.setInfo(FAULT_RUP_OFFSET_PARAM_INFO);

        // Fault discretization parameter
        faultDiscrParam =
                new DoubleParameter(FAULT_DISCR_PARAM_NAME,
                        FAULT_DISCR_PARAM_MIN, FAULT_DISCR_PARAM_MAX,
                        FAULT_DISCR_PARAM_UNITS, FAULT_DISCR_PARAM_DEFAULT);
        ...
        faultMagScalingRelParam =
                new StringParameter(FAULT_MAG_SCALING_REL_PARAM_NAME,
                        magScalingRelOptions, WC1994_MagLengthRelationship.NAME);
        faultMagScalingRelParam.setInfo(FAULT_MAG_SCALING_REL_PARAM_INFO);

        // create the mag-scaling sigma param
        faultScalingSigmaParam =
                new DoubleParameter(FAULT_SCALING_SIGMA_PARAM_NAME,
                        FAULT_SCALING_SIGMA_PARAM_MIN,
                        FAULT_SCALING_SIGMA_PARAM_MAX,
                        FAULT_SCALING_SIGMA_PARAM_DEFAULT);
        faultScalingSigmaParam.setInfo(FAULT_SCALING_SIGMA_PARAM_INFO);

        // create the aspect ratio param
        faultRupAspectRatioParam =
                new DoubleParameter(FAULT_RUP_ASPECT_RATIO_PARAM_NAME,
                        FAULT_RUP_ASPECT_RATIO_PARAM_MIN,
                        FAULT_RUP_ASPECT_RATIO_PARAM_MAX,
                        FAULT_RUP_ASPECT_RATIO_PARAM_DEFAULT);
        ...
        faultFloaterTypeParam =
                new StringParameter(FAULT_FLOATER_TYPE_PARAM_NAME,
                        floaterTypeOptions, FAULT_FLOATER_TYPE_PARAM_DEFAULT);
        faultFloaterTypeParam.setInfo(FAULT_FLOATER_TYPE_PARAM_INFO);

        // ---------------------------------------------------------------------------
        // SUBDUCTION FAULT SOURCES

        includeSubductionSourcesParam =
                new BooleanParameter(INCLUDE_SUBDUCTION_SOURCES_PARAM_NAME,
                        INCLUDE_SRC_PARAM_DEFAULT);
        includeSubductionSourcesParam.setInfo(INCLUDE_SRC_PARAM_INFO);

        // Rupture offset
        subductionRupOffsetParam =
                new DoubleParameter(SUB_RUP_OFFSET_PARAM_NAME,
                        SUB_RUP_OFFSET_PARAM_MIN, SUB_RUP_OFFSET_PARAM_MAX,
                        SUB_RUP_OFFSET_PARAM_UNITS, SUB_RUP_OFFSET_DEFAULT);
        subductionRupOffsetParam.setInfo(SUB_RUP_OFFSET_PARAM_INFO);

        // Fault discretization parameter
        subductionDiscrParam =
                new DoubleParameter(SUB_DISCR_PARAM_NAME, SUB_DISCR_PARAM_MIN,
                        SUB_DISCR_PARAM_MAX, SUB_DISCR_PARAM_UNITS,
                        SUB_DISCR_PARAM_DEFAULT);
        ...
        subductionMagScalingRelParam =
                new StringParameter(SUB_MAG_SCALING_REL_PARAM_NAME,
                        sub_magScalingRelOptions,
                        WC1994_MagAreaRelationship.NAME);
        subductionMagScalingRelParam.setInfo(SUB_MAG_SCALING_REL_PARAM_INFO);

        // create the mag-scaling sigma param
        subductionScalingSigmaParam =
                new DoubleParameter(SUB_SCALING_SIGMA_PARAM_NAME,
                        SUB_SCALING_SIGMA_PARAM_MIN,
                        SUB_SCALING_SIGMA_PARAM_MAX,
                        SUB_SCALING_SIGMA_PARAM_DEFAULT);
        subductionScalingSigmaParam.setInfo(SUB_SCALING_SIGMA_PARAM_INFO);

        // create the aspect ratio param
        subductionRupAspectRatioParam =
                new DoubleParameter(SUB_RUP_ASPECT_RATIO_PARAM_NAME,
                        SUB_RUP_ASPECT_RATIO_PARAM_MIN,
                        SUB_RUP_ASPECT_RATIO_PARAM_MAX,
                        SUB_RUP_ASPECT_RATIO_PARAM_DEFAULT);
        ...
        subductionFloaterTypeParam =
                new StringParameter(SUB_FLOATER_TYPE_PARAM_NAME,
                        sub_floaterTypeOptions, SUB_FLOATER_TYPE_PARAM_DEFAULT);
        subductionFloaterTypeParam.setInfo(SUB_FLOATER_TYPE_PARAM_INFO);

        sourceCacheParam =
                new BooleanParameter(SOURCE_CACHE_PARAM_NAME,
    ...
    /**
     * This put parameters in the ParameterList (depending on settings). This
     * could be smarter in terms of not showing parameters if certain
    ...
    protected void createParamList() {
        ...
        if (areaSourceDataList != null) {
            ...
            if (includeAreaSourceParam.getValue()) {
                ...
                if (!areaSrcRupTypeParam.getValue().equals(
                        AREA_SRC_RUP_TYPE_POINT)) {
                    adjustableParams.addParameter(areaSrcMagScalingRelParam);
                    MagScalingRelationship magScRel =
                            getmagScalingRelationship(areaSrcMagScalingRelParam
                                    .getValue());
                    if (areaSrcRupTypeParam.getValue().equals(
                            AREA_SRC_RUP_TYPE_FINITE_SURF)
                            || (magScRel instanceof MagAreaRelationship)) {
                        adjustableParams
                                .addParameter(areaSrcLowerSeisDepthParam);
                    }
                }
            }
        }
        ...
        if (griddedSeisSourceDataList != null) {
            ...
            if (includeGriddedSeisParam.getValue()) {
                ...
                if (!griddedSeisRupTypeParam.getValue().equals(
                        GRIDDED_SEIS_RUP_TYPE_POINT)) {
                    adjustableParams
                            .addParameter(griddedSeisMagScalingRelParam);
                    MagScalingRelationship magScRel =
                            getmagScalingRelationship(griddedSeisMagScalingRelParam
                                    .getValue());
                    if (griddedSeisRupTypeParam.getValue().equals(
                            GRIDDED_SEIS_RUP_TYPE_FINITE_SURF)
                            || (magScRel instanceof MagAreaRelationship)) {
                        adjustableParams
                                .addParameter(griddedSeisLowerSeisDepthParam);
                    }
                }
            }
        }
    ...
    protected ProbEqkSource
            mkFaultSource(GEMFaultSourceData gemFaultSourceData) {

        StirlingGriddedSurface faultSurface =
                new StirlingGriddedSurface(gemFaultSourceData.getTrace(),
                        gemFaultSourceData.getDip(),
                        gemFaultSourceData.getSeismDepthUpp(),
                        gemFaultSourceData.getSeismDepthLow(), faultDiscrValue);
        ...
        if (gemFaultSourceData.getFloatRuptureFlag()) {
            ...
            src = new FloatingPoissonFaultSource(gemFaultSourceData.getMfd(), // IncrementalMagFreqDist
                    ...
                    this.faultScalingSigmaValue, // sigma of the mag-scaling
                                                 // relationship
                    this.faultRupAspectRatioValue, // floating rupture aspect
                                                   // ration (length/width)
                    this.faultRupOffsetValue, // floating rupture offset
                    gemFaultSourceData.getRake(), // average rake of the
                                                  // ruptures
                    duration, // duration of forecast
                    minMagValue, // minimum mag considered (probs of those lower
                                 // set to zero regardless of MFD)
                    faultFloaterTypeValue, // type of floater (0 for full DDW, 1
                                           // for floating both ways, and 2 for
                                           // floating down center)
                    12.0); // mags >= to this forced to be full fault ruptures
                           // (set as high value for now)
            ...
            src = new FloatingPoissonFaultSource(gemFaultSourceData.getMfd(), // IncrementalMagFreqDist
                    ...
                    faultFloaterTypeValue, // type of floater (0 for full DDW, 1
                                           // for floating both ways, and 2 for
                                           // floating down center)
                    0.0); // mags >= to this forced to be full fault ruptures
                          // (set as high value for now)
    ...
    protected ProbEqkSource mkSubductionSource(
            GEMSubductionFaultSourceData gemSubductFaultSourceData) {

        ApproxEvenlyGriddedSurface faultSurface =
                new ApproxEvenlyGriddedSurface(
        ...
        if (gemSubductFaultSourceData.getFloatRuptureFlag()) {
            ...
            src =
                    new FloatingPoissonFaultSource(
                            gemSubductFaultSourceData.getMfd(), // IncrementalMagFreqDist
                            faultSurface, // EvenlyGriddedSurface
                            subductionMagScalingRel, // MagScalingRelationship
                            this.subductionScalingSigmaValue, // sigma of the
                                                              // mag-scaling
                                                              // relationship
                            this.subductionRupAspectRatioValue, // floating
                                                                // rupture
                                                                // aspect ration
                                                                // (length/width)
                            this.subductionRupOffsetValue, // floating rupture
                                                           // offset
                            gemSubductFaultSourceData.getRake(), // average rake
                                                                 // of the
                                                                 // ruptures
                            timeSpan.getDuration(), // duration of forecast
                            minMagValue, // minimum mag considered (probs of
                                         // those lower set to zero regardless
                                         // of MFD)
                            subductionFloaterTypeValue, // type of floater (0
                                                        // for full DDW, 1 for
                                                        // floating both ways,
                                                        // and 2 for floating
                                                        // down center)
                            12.0); // mags >= to this forced to be full fault
                                   // ruptures (set as high value for now)
            ...
            src =
                    new FloatingPoissonFaultSource(
                            ...
                            subductionFloaterTypeValue, // type of floater (0
                                                        ...
                                                        // and 2 for floating
                                                        // down center)
                            0.0); // mags >= to this forced to be full fault
                                  // ruptures (set as high value for now)
        ...
        if (areaSrcRupTypeValue.equals(AREA_SRC_RUP_TYPE_POINT)) {
            ...
            PoissonAreaSource src =
                    new PoissonAreaSource(areaSourceData.getRegion(),
                            ...
                            areaSrcMagScalingRel, areaSrcLowerSeisDepthValue,
            ...
            throw new RuntimeException(NAME + " - "
                    + AREA_SRC_RUP_TYPE_FINITE_SURF + " is not yet implemented");
        } else
            throw new RuntimeException(NAME
                    + " - Unsupported area source rupture type");
    ...
    protected ProbEqkSource mkGridSource(GEMPointSourceData gridSourceData) {
        ...
        if (griddedSeisRupTypeValue.equals(GRIDDED_SEIS_RUP_TYPE_POINT)) {
            PointEqkSource src =
                    new PointEqkSource(
                            gridSourceData.getHypoMagFreqDistAtLoc(),
                            gridSourceData.getAveRupTopVsMag(),
                            gridSourceData.getAveHypoDepth(), duration,
                            minMagValue);
            src.setTectonicRegionType(gridSourceData.getTectReg());
            return src;
        } else if (griddedSeisRupTypeValue.equals(GRIDDED_SEIS_RUP_TYPE_LINE)) {
            PointToLineSource src =
                    new PointToLineSource(
                            gridSourceData.getHypoMagFreqDistAtLoc(),
                            gridSourceData.getAveRupTopVsMag(),
                            gridSourceData.getAveHypoDepth(),
                            griddedSeisMagScalingRel,
                            griddedSeisLowerSeisDepthValue, duration,
                            minMagValue);
            src.setTectonicRegionType(gridSourceData.getTectReg());
            return src;
        } else if (griddedSeisRupTypeValue
                .equals(GRIDDED_SEIS_RUP_TYPE_CROSS_HAIR)) {
            PointToLineSource src =
                    new PointToLineSource(
                            gridSourceData.getHypoMagFreqDistAtLoc(),
                            gridSourceData.getAveRupTopVsMag(),
            ...
            return src;
                ...
                .equals(GRIDDED_SEIS_RUP_TYPE_FINITE_SURF)) {
            throw new RuntimeException(NAME + " - "
                    + GRIDDED_SEIS_RUP_TYPE_FINITE_SURF
                    + " is not yet implemented");
        } else
            throw new RuntimeException(NAME
                    + " - Unsupported background rupture type");
    }
    ...
    public ProbEqkSource getSource(int iSource) {
        ...
        if (source == null) {
            ...
            if (srcData instanceof GEMFaultSourceData)
                ...
                source =
                        mkSubductionSource((GEMSubductionFaultSourceData) srcData);
            else if (srcData instanceof GEMPointSourceData)
    ...
    public void updateForecast() {
        ...
        if (parameterChangeFlag) {
            ...
            // set the primitive parameters here so it's not repeated many times
            // in the source-creation
            // methods (this could alternatively be done in the parameterChange
            // method)
            ...
            griddedSeisLowerSeisDepthValue =
                    griddedSeisLowerSeisDepthParam.getValue();
            griddedSeisMagScalingRel =
                    getmagScalingRelationship(griddedSeisMagScalingRelParam
                            .getValue());
            ...
            faultMagScalingRel =
                    getmagScalingRelationship(faultMagScalingRelParam
                            .getValue());
            ...
            else if (floaterTypeName
                    .equals(this.FLOATER_TYPE_ALONG_STRIKE_AND_DOWNDIP))
                faultFloaterTypeValue = 1;
            else
                // (floaterTypeName.equals(this.FLOATER_TYPE_CENTERED_DOWNDIP))
            ...
            subductionMagScalingRel =
                    getmagScalingRelationship(subductionMagScalingRelParam
                            .getValue());
            subductionScalingSigmaValue =
                    subductionScalingSigmaParam.getValue();
            subductionRupAspectRatioValue =
                    subductionRupAspectRatioParam.getValue();
            ...
            else if (sub_floaterTypeName
                    .equals(this.SUB_FLOATER_TYPE_ALONG_STRIKE_AND_DOWNDIP))
    ...
    public void parameterChange(ParameterChangeEvent event) {
        ...
        // for now create new parameter list on every change; make more
        // efficient later?
        createParamList();
