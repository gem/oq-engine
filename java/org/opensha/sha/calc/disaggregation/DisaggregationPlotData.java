...
public class DisaggregationPlotData implements Serializable {
    ...
    public DisaggregationPlotData(double[] mag_center, double[] mag_binEdges,
            double[] dist_center, double[] dist_binEdges,
            double maxContrEpsilonForGMT_Plot, int numE, double[][][] pdf3D) {
    ...
    public void
            setMaxContrEpsilonForGMT_Plot(double maxContrEpsilonForGMT_Plot) {
        this.maxContrEpsilonForGMT_Plot = maxContrEpsilonForGMT_Plot;
    }
