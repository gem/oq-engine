 ...
 * </p>
 * <p>
 * Description: This class defines interface for Disaggregation calculator.
 ...
 * (1999, Bull. Seism. Soc. Am., 89, pp. 501-520) for a complete discussion of
 * disaggregation. The Dbar computed here is for rupture distance.
 * </p>
 * 
 * @author : Nitin Gupta
 * @created Oct 01,2004
...
public interface DisaggregationCalculatorAPI extends Remote {
     ...
     *            : site parameter
     * @param imrMap
     *            : mapping of tectonic regions to IMR objects
     * @param eqkRupForecast
     *            : selected Earthquake rup forecast
     * @return boolean
     */
    ...
    /**
     * Enables/disables calculation and display of source distances in source
     * data list.
     * 
     * @param showDistances
     * @throws RemoteException
     ...
     */
    // public void setMaxSourceDistance(double distance) throws
    ...
    // /**
    // * Creates the disaggregation plot using the GMT and return Disaggregation
    // plot
