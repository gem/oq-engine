 ...
 * </p>
 * <p>
 * Description: This has only a single magnitude with a non-zero rate. Note that
 * this magnitude must equal one of the descrete x-axis points.
 * </p>
 * 
...
public class SingleMagFreqDist extends IncrementalMagFreqDist {
    ...
    public SingleMagFreqDist(double min, int num, double delta, double mag,
            double moRate) throws InvalidRangeException, DataPoint2DException {
        super(min, num, delta);
    ...
    /**
     * Sets the magnitude For this magnitude it calculates the non-zero rate
     * from a static function getMoment of the class MomentMagCalc and moRate
     * 
     * @param mag
     * @param moRate
     */
    ...
    /**
     * sets the non-zero rate For this rate the magnitude is calculated using
     * the static function getMag of the class MomentMagCalc and moRate. NOTE:
     * this does not give the exact magnitude, but rather the closest magnitude
    ...
    public void setRateAndMomentRate(double rate, double moRate,
            boolean relaxTotMoRate) throws DataPoint2DException {
    ...
    public String getDefaultInfo() {
        ...
        return "minMag=" + minX + "; maxMag=" + maxX + "; numMag=" + num
                + "; mag=" + (float) mag + "; rate=" + (float) rate
                + "; totMoRate=" + (float) totMoRate;
    }
