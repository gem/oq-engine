 ...
 * 
 * <p>
 * Description: This is the "characteristic" magnitude-frequency distribution
...
public class YC_1985_CharMagFreqDist extends IncrementalMagFreqDist {
    ...
    private String C = new String("YC_1985_CharMagFreqDist"); // for showing
                                                              // messages
    ...
    /**
     * Constructor: this is the full constructor /** Constructor: this
     * constructor assumes magLower is minX and magUpper to be maxX
     * 
     * @param min
     *            - minimum mag of distribution
     * @param num
     ...
     *            - discretization interval
     * @param magLower
     *            - the lowest non-zero-rate magnitude
     * @param magUpper
     *            - the highest non-zero-rate magnitude
     * @param deltaMagChar
     *            - the width of the characteristic part (below magUpper)
     * @param magPrime
     *            - the upper mag of the GR part
     * @param deltaMagPrime
     *            - the distance below magPrime where the rate equals that over
     *            the char-rate part
     * @param bValue
     *            - the b value
     * @param totMoRate
     ...
     */
    public YC_1985_CharMagFreqDist(double min, int num, double delta,
            double magLower, double magUpper, double deltaMagChar,
     ...
     */
    public YC_1985_CharMagFreqDist(double min, int num, double delta,
            double deltaMagChar, double magPrime, double deltaMagPrime,
            double bValue, double totMoRate) throws InvalidRangeException,
            DataPoint2DException {
        super(min, num, delta);
    ...
    /**
     * Update distribution (using total moment rate rather than the total rate
     * of char events)
     * 
     * @param magLower
     *            - the lowest non-zero-rate magnitude
    ...
    public void setAllButTotCharRate(double magLower, double magUpper,
            double deltaMagChar, double magPrime, double deltaMagPrime,
            double bValue, double totMoRate) throws DataPoint2DException,
     ...
     *            - the b value
     * @param totCharRate
     *            - the total rate of characteristic events (cum rate at
     *            magUpper-deltaMagChar).
     */

    public void setAllButTotMoRate(double magLower, double magUpper,
            double deltaMagChar, double magPrime, double deltaMagPrime,
            double bValue, double totCharRate) throws DataPoint2DException,
            InvalidRangeException {
     ...
     * the EvenlyDiscretizedFunc class by making a objects of this class and
     * calling the set functions of this from outside
     * 
     * @param point
    ...
    public void set(DataPoint2D point) throws MagFreqDistException {
        throw new MagFreqDistException(
                "Cannot Access the set function of the YC_1985_CharMagFreqDist from outside this class");
    }
    ...
    private void calculateRelativeRates() throws DataPoint2DException,
        ...
        if (magLower > magUpper)
            throw new InvalidRangeException(
                    "magLower cannot be less than magUpper");
        ...
        for (i = indexLower; i <= indexMagPrime; ++i)
            // assign correct values to rates between magLower and magPrime
            super.set(i, Math.pow(10, -bValue * getX(i)));

        for (i = indexCharStart; i <= indexUpper; ++i)
            // set rates over the characteristic-mag range
    ...
    public String getDefaultInfo() {
        return ("minMag=" + minX + "; maxMag=" + maxX + "; numMag=" + num
                + "; magLower=" + magLower + "; magUpper=" + magUpper
                + "; deltaMagChar=" + this.getDeltaMagChar() + "; magPrime="
                + this.getMagPrime() + "; deltaMagPrime=" + getDeltaMagPrime()
                + " bValue=" + bValue + "; totMoRate="
