 ...
 * </p>
 * <p>
 * Description: this Interface gives the rate of EarthQuakes(number per year)in
 * succession. This class has been made as a generalised API for others to
 * implement depending on their functionality
 * </p>
 * 
...
public interface IncrementalMagFreqDistAPI {
     ...
     * rate greater than and equal to that magnitude)
     * 
     * @param mag
     * @return
     */
     ...
     * all the points with Incr Rate Distribution (the rate greater than and
