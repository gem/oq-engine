...
/**
 * <b>Title:</b> DataPoint2D
 * <p>
 * 
 * <b>Description:</b> Represents a 2 dimensional point (x,y) in function space.
 * Each coordinate is represented by a double.
 * <p>
 * 
 * The x value is the independent value, and the y value is the dependent value.
 * Therefore this class is sorted on the x-value. Two DataPoint2D are equal if
 * there x-values are equal, whatever the y value is. This will be useful in
 * DiscretizedDFunctions.
 * <p>
 * 
...
public class DataPoint2D implements Comparable, java.io.Serializable {
    ...
    /**
     * Set both coordinates at once. No validation checks are done on new
     * values.
     * 
     * @param x
     *            The x coordinate
    ...
    /**
     * Set both coordinates at once from the passed in DataPoint2D. In other
     * words performs a copy. No validation checks are done on new values.
     * 
     * @param point
     *            Copies x and y value from this point
     */
     ...
     *            Point to compare x-value to
     * @param tolerance
     *            The distance that the two x-values can be and still considered
     *            equal
     ...
     * 
     * @param x
     *            The value to compare this object's x-value to
     * @param y
     *            The value to compare this object's y-value to
     ...
     * 
     * @param x
     *            The value to compare this x-value to
     ...
     * 
     * @param obj
     *            The DataPoint2D to test
     * @return -1 if the x-value of this is smalleer than the comparing object
     *         are the same, 0 if the x-values are equal, and +1 if this x-value
     *         is larger.
     * @exception ClassCastException
     *                Is thrown if the passed in object is not a DataPoint2D
     */
    public int compareTo(Object obj) throws ClassCastException {
        ...
        if (!(obj instanceof DataPoint2D)) {
            throw new ClassCastException(S
                    + "Object not a DataPoint2D, unable to compare");
        }
     ...
     * @param obj
     *            The DataPoint2D to test
     * @return True if this x-value is the same as the comparing object
     * @exception ClassCastException
     *                Is thrown if the passed in object is not a DataPoint2D
     */
    ...
    /**
     * Returns a copy of this DataPoint2D. If you change the copy, this original
     * is unaltered.
     * 
