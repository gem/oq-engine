 ...
 * delete(). numElements(), iterator(), etc.
 * <p>
 * 
 ...
 * VALUES. This may be useful to add in the future.
 * <p>
 * 
...
public interface DiscretizedFuncAPI extends java.io.Serializable,
     ...
     * just matches the first found starting at the x-min point along the
     * x-axis.
     */
    public double getFirstInterpolatedX(double y);

    /**
     * Given the input x value, finds the two sequential x values with the
     ...
     * accessed by index. This function returns the index of the specified x
     * value if found within tolerance, else returns -1.
     */
     ...
     * Since the x-axis is sorted and points stored in a list, they can be
     * accessed by index. This function returns the index of the specified x
     * value in the DataPoint2D if found withing tolerance, else returns -1.
     */
     ...
     * 
     * @param y
     *            : Y value in the linear space corresponding to which we are
