...
/**
 * This class is the exact dulplicate of the java.util.TreeMap class except some
 * of the internal elements have been changed from private to protected so that
 * subclasses in this package has access to these internal fields. This is
 * critical in the implementation of the DataPoint2DTreeMap. This allows a fully
 * sorted collection of DataPoint2D along the X-axis ( independent parameter ).
 * <P>
 * 
...
public class TreeMap extends AbstractMap implements SortedMap, Cloneable,
     ...
     * the key to <tt>null</tt> . The <tt>containsKey</tt> operation may be used
     ...
     * @throws NullPointerException
     *             this map does not permit <tt>null</tt> keys and a specified
     *             key is <tt>null</tt> .
     */
     ...
     * returned set is a <tt>Map.Entry</tt> . The set is backed by this map, so
     * changes to this map are reflected in the set, and vice-versa. The set
     * supports element removal, which removes the corresponding mapping from
     * the TreeMap, through the <tt>Iterator.remove</tt> , <tt>
     ...
     * The returned sorted map is backed by this map, so changes in the returned
     * sorted map are reflected in this map, and vice-versa. The returned sorted
     ...
     * than <tt>fromKey</tt> or greater than or equal to <tt>toKey</tt> .
     * <p>
     * 
     ...
     *         <tt>fromKey</tt> , inclusive, to <tt>toKey
     *      </tt>, exclusive.
     * @throws ClassCastException
     ...
     * @throws NullPointerException
     *             if <tt>toKey</tt> is <tt>null</tt> and this map uses natural
     ...
     * 
     * @param set
     *            The feature to be added to the AllForTreeSet attribute
     * @param defaultVal
     *            The feature to be added to the AllForTreeSet attribute
     */
    ...
    protected void buildFromSorted(int size, java.util.Iterator it,
            java.io.ObjectInputStream str, Object defaultVal)
            throws java.io.IOException, ClassNotFoundException {
        this.size = size;
        root =
                buildFromSorted(0, 0, size - 1, computeRedLevel(size), it, str,
                        defaultVal);
    }
    ...
    protected static Entry buildFromSorted(int level, int lo, int hi,
            int redLevel, java.util.Iterator it, java.io.ObjectInputStream str,
    ...
    protected class SubMap extends AbstractMap implements SortedMap,
        ...
        protected class EntrySetView extends AbstractSet {
             ...
             */
            public java.util.Iterator iterator() {
                return new Iterator((fromStart ? firstEntry()
