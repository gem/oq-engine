 ...
 * the ParameterAPI. Because of this they are passed around functions as
 * ParameterAPI. In some cases you need to know more specifically the class type
 * in order to access the special functions of these subclasses. This utility
 * class verifies the class type so you can cast to the right type without
 * throwing errors.
 * 
...
public class ParamUtils {
    ...
    /**
     * Returns true if the ParameterAPI is a DoubleParameter or
     * DoubleDiscreteParameter. This allows you to get and set the value as a
     * Double.
     * 
     * @param The
     *            parameter to verify
    ...
    public static boolean
            isDoubleOrDoubleDiscreteConstraint(ParameterAPI param) {
        if (isDoubleConstraint(param) || isDoubleDiscreteConstraint(param))
            return true;
        else
            return false;
    }
    ...
    /**
     * Returns true if the ParameterAPI contained constraint is a
     * DoubleConstraint.
     * 
     * @param The
     *            parameter to verify
