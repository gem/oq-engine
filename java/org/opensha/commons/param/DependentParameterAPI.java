...
/**
 * <b>Title:</b> DependentParameterAPI
 * <p>
 * 
 * <b>Description:</b> Implementation classes of this interface are known as
 * dependent parameters, i.e. it's values and/or constraints depend on other
 * independent parametes. The basic functionality is to just maintain the list
 * of parameters this depends on. There is no other logic between these
 * parameters. An implementation class will maintain a list of parameters that
 * it depends on.
 * <p>
 * 
 * This interface simply states the functions for list accessors to maintain
 * this list of independent parameters. Standard list functions are implemented
 * (paraphrasing) such as get() , set(), remove() iterator(), etc.
 * <p>
 * 
