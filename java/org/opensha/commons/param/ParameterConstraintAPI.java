...
/**
 * <b>Title:</b> ParameterConstraintAPI
 * <p>
 * 
 * <b>Description:</b> This is the interface that all constraints must
 * implement. Constraints store such information as if a value is allowed, if
 * the data is editable, i.e. functions that restrict or allow setting new
...
public interface ParameterConstraintAPI<E> extends NamedObjectAPI {
    ...
    /**
     * A parameter may or may not allow null values. That permission is set
     * here.
     */
    public void setNullAllowed(boolean nullAllowed) throws EditableException;

    /**
     * A parameter may or may not allow null values. That permission is checked
     * here.
     */
