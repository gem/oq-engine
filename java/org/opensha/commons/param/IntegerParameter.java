...
/**
 * <b>Title:</b> IntegerParameter
 * <p>
 * 
 * <b>Description:</b> A Parameter that accepts Integers as it's values. If
 * constraints are present, setting the value must pass the constraint check.
 * Since the parameter class in an ancestor, all the parameter's fields are
 * inherited.
 * <p>
 * 
 * The constraints are IntegerConstraint which means a min and max values are
 * stored in the constraint that setting the parameter's value cannnt exceed. If
 * no constraint object is present then all values are permitted.
 * <p>
 * 
 * This class also extends DependentParameter so it may have a list of
 * independent parameters that it depends upon.
 * <p>
 * 
 ...
 * @version 1.0
 */
public class IntegerParameter extends DependentParameter<Integer> implements
        DependentParameterAPI<Integer>, ParameterAPI<Integer> {
    ...
    /**
     * Constructor with no constraints specified, all values are allowed. Also
     ...
     */
    public IntegerParameter(String name, String units)
     ...
     * @param min
     *            defines min of allowed values
     * @param max
     *            defines max of allowed values
     * @exception ConstraintException
     *                thrown if the value is not allowed
     * @throws ConstraintException
     *             Is thrown if the value is not allowed
     */
     ...
     *             Is thrown if the value is not allowed
     */
    public IntegerParameter(String name, int min, int max, String units)
            throws ConstraintException {
        super(name, new IntegerConstraint(min, max), null, null);
        // this.constraint.setName( name );
    }
     ...
     *             Is thrown if the value is not allowed
     */
    public IntegerParameter(String name, Integer min, Integer max, String units)
            throws ConstraintException {
        super(name, new IntegerConstraint(min, max), null, null);
        // this.constraint.setName( name );
    }
     ...
     *             Is thrown if the value is not allowed
     */
    public IntegerParameter(String name, IntegerConstraint constraint)
            throws ConstraintException {
        super(name, constraint, null, null);
        // if( this.constraint.getName() == null ) this.constraint.setName(
        // this.name );
    }
     ...
     *            Name of the parameter
     * @param constraint
     *            defines min and max range of allowed values
     * @param units
     *            Units of this parameter
     * @exception ConstraintException
     *                thrown if the value is not allowed
     * @throws ConstraintException
     *             Is thrown if the value is not allowed one. Null values are
     *             always allowed in the constructors
     */
    public IntegerParameter(String name, IntegerConstraint constraint,
            String units) throws ConstraintException {
     ...
     *             Is thrown if the value is not allowed
     */
    public IntegerParameter(String name, String units, Integer value)
            throws ConstraintException {
     ...
     *             Is thrown if the value is not allowed
     */
    public IntegerParameter(String name, int min, int max, Integer value)
            throws ConstraintException {
     ...
     *             Is thrown if the value is not allowed
     */
    public IntegerParameter(String name, Integer min, Integer max, Integer value)
            throws ConstraintException {
        super(name, new IntegerConstraint(min, max), null, value);
        // if( this.constraint.getName() == null ) this.constraint.setName(
        // this.name );
    ...
    /**
     * Sets the name, value and constraint. The value is checked if it is within
     * constraints.
     * 
     * @param name
     *            Name of the parameter
     ...
     */
    public IntegerParameter(String name, IntegerConstraint constraint,
            Integer value) throws ConstraintException {
     ...
     */
    public IntegerParameter(String name, Integer min, Integer max,
            String units, Integer value) throws ConstraintException {
        super(name, new IntegerConstraint(min, max), units, value);
        // if( this.constraint.getName() == null ) this.constraint.setName(
        // this.name );
    }
    ...
    /**
     * Sets the constraint if it is a StringConstraint and the parameter is
     * currently editable. If this parameter is set non-editable an
     * EditableConstraint is thrown.
     */
    ...
    /**
     * Returns the min value of the constraint object. Null is returned if there
     * are no constraints set.
     */
    ...
    /**
     * Returns the type of this parameter. The type is just the classname if no
     * constraints are present, else "Constrained" is prepended to the
     * classname. The type is used to determine which parameter GUI editor to
     * use.
     */
    ...
    public int compareTo(Object obj) throws ClassCastException {
        ...
        if (!(obj instanceof IntegerParameter))
            throw new ClassCastException(S
                    + "Object not a IntegerParameter, unable to compare");
    ...
    public Object clone() {
        ...
        if (value == null)
            param = new IntegerParameter(name, c1, units);
        else
            param =
                    new IntegerParameter(name, c1, units, new Integer(
                            this.value.toString()));
        if (param == null)
            return null;
        param.editable = true;
