...
/**
 * <b>Title:</b> StringParameter
 * <p>
 * 
 * <b>Description:</b> String Parameter that accepts strings as it's values. If
 * constraints are present, setting the value must pass the constraint check.
 * Since the Parameter class in an ancestor, all Parameter's fields are
 * inherited.
 * <p>
 * 
 * The constraints are StringConstraint which implies a StringParameter value
 * can only be choosen from a list of strings.
 * <p>
 * 
 * Note: SWR: The constraint object could be "supercharged" by using Regular
 * Expressions introduced in java 1.4. Then we wouldn't need a list of allowed
 * values but rather a matcher pattern. For example "[A-Za-z]*" would allow all
 * values that start with a lowercase or upper case alphabet letter.
 * <p>
 * 
...
public class StringParameter extends DependentParameter<String> implements
        DependentParameterAPI<String>, ParameterAPI<String> {
     ...
     * no elements an exception is thrown. This constructor also sets the name
     * of this parameter.
     * 
     * @param name
     *            Name of the parametet
     * @param strings
     *            Converted to the Constraint object
     * @exception ConstraintException
     *                Thrown if vector of allowed values is empty
     * @throws ConstraintException
     *             Thrown if vector of allowed values is empty
     */
    public StringParameter(String name, ArrayList strings)
            throws ConstraintException {
     ...
     */
    public StringParameter(String name, StringConstraint constraint)
            throws ConstraintException {
        this(name, constraint, null, null);
    }

    /**
     * No constraints specified, all values allowed. This constructor set's the
     * name of this parameter as well as the value.
     * 
     * @param name
     *            Name of the parametet
     * @param value
     ...
     *                Description of the Exception
     */
    public StringParameter(String name, String units, String value)
            throws ConstraintException {
     ...
     *            Name of the parametet
     * @param strings
     *            vector of allowed values converted to a constraint
     * @param value
     *            value of this parameter
     * @exception ConstraintException
     *                Is thrown if the value is not allowed
     ...
     *             Is thrown if the value is not allowed
     */
    public StringParameter(String name, ArrayList strings, String value)
            throws ConstraintException {
     ...
     *            Name of the parametet
     * @param constraint
     *            Lsit of allowed values
     * @param value
     *            value object of this parameter
     * @param units
    ...
    /**
     * Sets the constraint reference if it is a StringConstraint and the
     * parameter is currently editable, else throws an exception.
     */
    ...
    /**
     * Gets the type attribute of the StringParameter object. Returns the class
     * name if unconstrained, else "Constrained" + classname. This is used to
     * determine which type of GUI editor applies to this parameter.
     * 
     ...
     * the comparing objects. Implementation of comparable interface. Helps with
     * sorting a list of parameters.
     * 
     * @param obj
     ...
     *                Is thrown if the comparing object is not a StringParameter
     *                *
     * @see Comparable
     */
    public int compareTo(Object obj) throws ClassCastException {
        ...
        if (!(obj instanceof StringParameter)) {
            throw new ClassCastException(S
                    + "Object not a StringParameter, unable to compare");
        }
    ...
    /**
     * Compares the passed in String parameter to see if it has the same name
     * and value. If the object is not a String parameter an exception is
     * thrown. If the values and names are equal true is returned, otherwise
     * false is returned.
     * 
     * @param obj
     *            The object to compare this to
     ...
     * object's value and all fields. The constraints are also cloned.
     * 
    ...
    public Object clone() {
        ...
        if (value == null) {
            ...
            param = new StringParameter(name, c1, units, this.value.toString());
        if (param == null)
            return null;
        param.editable = true;
        param.info = info;
    ...
    public boolean setIndividualParamValueFromXML(Element el) {
        ...
        if (val.length() == 0) {
            try {
                ...
                System.err
                        .println("Warning: could not set String Param to empty string from XML");
