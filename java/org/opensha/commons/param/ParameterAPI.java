...
public interface ParameterAPI<E> extends NamedObjectAPI, Comparable,
        XMLSaveable {
     ...
     * Defaults to the name of the parameter but in some cases may be different.
     */
    public String getConstraintName();

    /**
     * Returns the constraint of this parameter. Each subclass may store any
     * type of constraint it likes.
     */
    public ParameterConstraintAPI getConstraint();

    /**
     * Sets the constraints of this parameter. Each subclass may store any type
     * of constraint it likes.
     */
     ...
     *             Thrown if the object type of value to set is not the correct
     *             type.
     * @throws ConstraintException
     *             Thrown if the object value is not allowed
     */
     ...
     * 
     * @param parameter
     *            the parameter to compare this object to.
     * @return -1 if this value < obj value, 0 if equal, +1 if this value > obj
     *         value
     * @throws ClassCastException
     *             Thrown if the object type of the parameter argument are not
     *             the same.
     */
    ...
    /**
     * Proxy to constraint check when setting a value. If no constraint then
    ...
    /**
     * This returns an editor for this parameter. The parameter editor shouldn't
     * be instantiated until the first call to this method in order to save
     * memory.
     */
