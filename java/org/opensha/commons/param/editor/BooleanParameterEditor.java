...
public class BooleanParameterEditor extends ParameterEditor implements
    ...
    protected void addWidget() {
        ...
        ((JCheckBox) valueEditor).setSelected(((Boolean) model.getValue())
                .booleanValue());
    ...
    protected void setWidgetObject(String name, Object obj) {
        ...
        if ((obj != null) && (valueEditor != null))
            ((JCheckBox) valueEditor).setSelected(((Boolean) obj)
                    .booleanValue());
        else if (obj == null)
            ((JCheckBox) valueEditor).setSelected(((JCheckBox) valueEditor)
                    .isSelected());
    ...
    public void setParameter(ParameterAPI model) {
        ...
        if ((info != null) && !(info.equals("")))
            ...
            ((JCheckBox) valueEditor).setToolTipText(null);
    ...
    /**
     * Updates the JCheckBox with the parameter value. Used when the parameter
     * is set for the first time, or changed by a background process
    ...
    /**
     * This function is called when the user click for the
     * BooleanParameterEditor Button
     * 
     * @param ae
     */
