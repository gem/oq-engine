 ...
 * @author : Ned Field, Nitin Gupta, Vipin Gupta, Kevin Milner
 * @created : Jan 24,2005
 * @version 1.0
 */
...
public class RegionParameterEditor
  ...
  //hold the parameters for the Region parameter, show them in a seperate panel.
  ...
  // size of the Region parameter editor
  ...
  /**
   * Show the region parameter editor.
   * Editor is shown as a button which pops up window to fill min/max lat/lon.
   *
   * @param model
   */
