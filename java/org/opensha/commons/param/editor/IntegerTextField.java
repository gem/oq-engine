...
/**
 * <b>Title:</b> IntegerTextField
 * <p>
 * 
 * <b>Description:</b> Special JTextField that only allows integers to be typed
 * in. This text field allows for a negative sign as the first character, only
 * digits thereafter.
 * <p>
 * 
 * Note: This is a fairly complex GUI customization that relies upon an
 * IntegerDocument model to determine what types of characters are allowed for a
 * integer number ( digits, - sign in first location, etc. ) It is beyond the
 * scope of this javadoc to explain it's use fully. It is not necessary for
 ...
 * between JTextField and PlainDocument ( and our corresponding IntegerTextField
 * and IntegerDocument ).
 * <p>
 * 
 ...
 * @version 1.0
 */
public class IntegerTextField extends JTextField implements
        IntegerPlainDocument.InsertErrorListener {
    ...
    public void insertFailed(IntegerPlainDocument doc, int offset, String str,
