 ...
 * IntegerParameters. The widget is an IntegerTextField so that only integers
 * can be typed in.
 * <p>
 * 
...
public class IntegerParameterEditor extends ParameterEditor {
     ...
     * if the model is not an IntegerParameter. It it is then the
     * updateNameLabel is called which inderectly calls addWidget.
     * <p>
     * 
    ...
    public IntegerParameterEditor(ParameterAPI model) throws Exception {
        ...
        if ((model != null) && !(model instanceof IntegerParameter))
            throw new Exception(S
                    + "Input model parameter must be a IntegerParameter.");
