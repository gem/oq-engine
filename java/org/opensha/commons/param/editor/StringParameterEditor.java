 ...
 * parent's class JComponent valueEditor field becomes an IntegerTextField, a
 * subclass of a JTextField.
 * <p>
 * 
 * @author Steven W. Rock
 * @version 1.0
 */
public class StringParameterEditor extends ParameterEditor {
     ...
     * if the model is not an StringParameter.
     * 
     * Note: When calling the super() constuctor addWidget() is called which
     * configures the IntegerTextField as the editor widget.
     * <p>
     */
        ...
        if (e.getKeyChar() == '\n') {
            ...
            try {
                ...
                if (obj != null)
                    ...
                    ((JTextField) valueEditor).setText("");
    ...
    /**
     * Updates the JTextField string with the parameter value. Used when the
