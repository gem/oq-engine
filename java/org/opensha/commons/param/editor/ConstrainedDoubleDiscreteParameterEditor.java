...
/**
 * <b>Title:</b> ConstrainedDoubleDiscreteParameterEditor
 * <p>
 * 
 * <b>Description:</b> This editor is for editing DoubleDiscreteParameters. The
 * widget is simply a picklist of all possible constrained values you can choose
 * from.
 * <p>
 * 
...
public class ConstrainedDoubleDiscreteParameterEditor extends ParameterEditor
     ...
     * DoubleDiscreteConstraint. Then the constraints are checked that there is
     * at least one. If any of these fails an error is thrown.
     * <P>
     * 
    ...
    private void verifyModel(ParameterAPI model) throws ConstraintException {
        ...
        if (!(model instanceof DoubleDiscreteParameter))
            throw new ConstraintException(
                    S
                            + "Input model parameter must be a DoubleDiscreteParameter.");
        ...
        if (!(constraint instanceof DoubleDiscreteConstraint))
            throw new ConstraintException(
                    S
                            + "Input model constraints must be a DoubleDiscreteConstraint.");
    ...
    /**
     * Allows customization of the IntegerTextField border. Currently set to do
     * nothing.
     */
     ...
     * larger than one, else sets to a non-editable label if there is only one
    ...
    protected void addWidget() {
        ...
        if (model != null) {
            DoubleDiscreteConstraint con =
                    ((DoubleDiscreteConstraint) ((DoubleDiscreteParameter) model)
                            .getConstraint());
