...
/**
 * <b>Title:</b> ConstrainedDoubleParameterEditor
 * <p>
 * 
 * <b>Description:</b> Special ParameterEditor for editing Constrained
 * DoubleParameters. The widget is a NumericTextField so that only numbers can
 * be typed in. When hitting <enter> or moving the mouse away from the
 * NumericField, the value will change back to the original if the new number is
 * outside the constraints range. The constraints also appear as a tool tip when
 * you hold the mouse cursor over the NumericTextField.
 * <p>
 * 
...
public class ConstrainedDoubleParameterEditor extends DoubleParameterEditor {
    ...
    /**
     * This is where the NumericTextField for the Constraint DoubleParameter It
    ...
    protected DoubleConstraint getConstraint() {
        ...
        if (ParamUtils.isWarningParameterAPI(model)) {
            constraint =
                    (DoubleConstraint) ((WarningParameterAPI) model)
