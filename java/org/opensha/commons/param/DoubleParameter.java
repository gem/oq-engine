...
/**
 * <b>Title:</b> DoubleParameter
 * <p>
 * 
 * <b>Description:</b> Generic Data Object that contains a Double and optionally
 * a min and max allowed values stored in a constraint object. If no constraint
 * object is present then all values should be permitted.
 * <p>
 * 
...
public class DoubleParameter extends DependentParameter<Double> implements
        DependentParameterAPI<Double>, ParameterAPI<Double> {
     ...
     *             Is thrown if the value is not allowed
     */
    public DoubleParameter(String name, double min, double max, String units)
            throws ConstraintException {
     ...
     *             Is thrown if the value is not allowed
     */
    public DoubleParameter(String name, DoubleConstraint constraint)
            throws ConstraintException {
     ...
     *             Is thrown if the value is not allowed
     */
    public DoubleParameter(String name, double min, double max, Double value)
            throws ConstraintException {
     ...
     *             Thrown if constraint is not a DoubleConstraint.
     * @throws EditableException
     *             Thrown if the parameter is currently uneditable.
     */
     ...
     */
    public void setValue(double value) throws ConstraintException,
            ParameterException {
    ...
    public Object clone() {
        ...
        if (value == null)
            param = new DoubleParameter(name, c1, units);
        else
            param =
                    new DoubleParameter(name, c1, units, new Double(
                            this.value.toString()));
        if (param == null)
            return null;
        param.editable = true;
