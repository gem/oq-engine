...
/**
 * <b>Title:</b> ParameterConstraint
 * <p>
 * 
 * <b>Description:</b> Partial (abstract) implementation of the
 * ParameterConstraintAPI. This class implements some of the simple common code
 * base for all subclasses. There are three fields and corresponding getters and
 * setters that are implemented. These fields are:
 * 
 * <ul>
 ...
 * @version 1.0
 */
public abstract class ParameterConstraint<E> implements
        ParameterConstraintAPI<E> {
    ...
    /**
     * Disables editing units, info, constraints, et. Basically all set()s
     * disabled except for setValue().
     */
    ...
    /**
     * Helper function that throws an EditableException if this constraint is
    ...
    /**
     * Returns a copy so you can't edit or damage the origial. All concrete
