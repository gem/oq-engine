...
/**
 * <b>Title:</b> DoubleDiscreteParameter
 * <p>
 * 
 * <b>Description:</b> Identical to the DoubleParameter except the constraints
 * are a finite set of valid Double choices instead of a Min/Max
 * DoubleConstraint with all possible values allowed in between.
 * <p>
 * 
 * @see DoubleParameter
 ...
 * @version 1.0
 */
public class DoubleDiscreteParameter extends DependentParameter<Double>
     ...
     *            Name of this parameter
     * @param units
     *            Units string for this parameter
     */
     ...
     *            Name of this parameter
     * @param doubles
     *            List of allowed doubles
     * @exception ConstraintException
     *                Description of the Exception
     */
    public DoubleDiscreteParameter(String name, ArrayList doubles)
     ...
     *                Description of the Exception
     */
    public DoubleDiscreteParameter(String name, ArrayList doubles, String units)
            throws ConstraintException {
     ...
     */
    public DoubleDiscreteParameter(String name,
            DoubleDiscreteConstraint constraint) throws ConstraintException {
     ...
     */
    public DoubleDiscreteParameter(String name,
            DoubleDiscreteConstraint constraint, String units)
            throws ConstraintException {
     ...
     *            The value to set this parameter to
     * @exception ConstraintException
     *                Thrown if value not allowed
     */
    public DoubleDiscreteParameter(String name, String units, Double value)
            throws ConstraintException {
     ...
     *                Thrown if value not allowed
     */
    public DoubleDiscreteParameter(String name, ArrayList doubles, Double value)
            throws ConstraintException {
     ...
     */
    public DoubleDiscreteParameter(String name, ArrayList doubles,
            String units, Double value) throws ConstraintException {
     ...
     */
    public DoubleDiscreteParameter(String name,
            DoubleDiscreteConstraint constraint, Double value)
            throws ConstraintException {
     ...
     */
    public DoubleDiscreteParameter(String name,
            DoubleDiscreteConstraint constraint, String units, Double value)
            throws ConstraintException {
     ...
     *             Thrown if constraint is not a DoubleDiscreteConstraint
     * @throws EditableException
     *             Thrown if Parameter is currently uneditable.
     */
     ...
     * 
     * @param obj
     *            Double Parameter to compare to
     * @return -1 if this < obj, 0 if this = obj, +1 if this > obj
     * @exception ClassCastException
     *                Thrown if passed in value is not a DoubleParameter
     */
    public int compareTo(Object obj) throws ClassCastException {
        ...
        if (!(obj instanceof DoubleParameter)
            ...
            throw new ClassCastException(
                    S
                            + "Object not a DoubleParameter, or DoubleDiscreteParameter, unable to compare");
        }
     ...
     * @param obj
     *            Double Parameter to compare to
     * @return true if these two parameter values are the same
     * @exception ClassCastException
     *                Thrown if passed in value is not a DoubleParameter
     */
    ...
    public Object clone() {
        ...
        if (value == null)
            param = new DoubleDiscreteParameter(name, c1, units);
        else
            param =
                    new DoubleDiscreteParameter(name, c1, units, new Double(
                            this.value.toString()));
        param.editable = true;
        param.info = info;
        return param;
    ...
    public ParameterEditor getEditor() {
        if (paramEdit == null) {
            if (constraint != null)
                try {
                    paramEdit =
                            new ConstrainedDoubleDiscreteParameterEditor(this);
                } catch (Exception e) {
