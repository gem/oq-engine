...
/**
 * <b>Title:</b> TimeSpanParameterChangeListener
 * <p>
 * 
 * <b>Description:</b> The timespan change listener receives change events
 * whenever one of the TimeSpan have been change. The listener is typically an
 * ERF that wants to do something with the changed timespan
 * <p>
 * 
 * @author
 * @created
