...
/**
 * <b>Title:</b> ParameterChangeWarningEvent
 * <p>
 * 
 * <b>Description:</b> This event is thrown when you try to modify a parameter's
 * value beyond it's recommended value. This event gives the calling class the
 * ability to either head the warnings or ignore it and update the parameter
 * anyways.
 * <p>
 * 
...
public class ParameterChangeWarningEvent extends EventObject {
     ...
     * 
     * @param reference
     *            Object which created this event, i.e. the parametr
     * @param parameterName
     *            Name of Parameter tried to change.
     * @param oldValue
     *            Old value for the Parameter
    ...
    public ParameterChangeWarningEvent(Object reference,
            WarningParameterAPI param, Object oldValue, Object newValue) {
        super(reference);
        this.param = param;
