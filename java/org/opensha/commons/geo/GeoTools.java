...
public class GeoTools {
    ...
    /**
     * Minimum earthquake depth value (-5 km) used for range checking. This
     * follows the positive-down depth convention of seismology.
     */
    public static final double DEPTH_MIN = -5.0;

    /**
     * Maximum earthquake depth value (700 km) used for range checking. This
     * follows the positive-down depth convention of seismology.
     */
     ...
     * 
     * @param lats
     *            latitudes to validate
     * @throws IllegalArgumentException
     *             if a <code>lat</code> value is out of range
     */
    ...
    /**
     * Verifies that a latitude value falls within range of <code>LAT_MIN</code>
     * and <code>LAT_MAX</code> (inclusive).
     * 
     * @param lat
     *            latitude to validate
     * @throws IllegalArgumentException
     *             if <code>lat</code> value is out of range
     */
     ...
     * 
     * @param lons
     *            longitudes to validate
     * @throws IllegalArgumentException
     *             if a <code>lon</code> value is out of range
     */
     ...
     * @throws IllegalArgumentException
     *             if <code>lon</code> value is out of range
     */
     ...
     *            depths to validate
     * @throws IllegalArgumentException
     *             if a <code>depth</code> value is out of range
     */
    ...
    /**
     * Verifies that a depth value falls within range of <code>DEPTH_MIN</code>
     * and <code>DEPTH_MAX</code> (inclusive).
     * 
     * @param depth
     *            depth to validate
     * @throws IllegalArgumentException
