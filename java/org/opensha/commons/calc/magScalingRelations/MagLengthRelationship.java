 ...
 * standard deviation of magnitude as a function of length (km) or visa versa.
 * The values can also be a function of rake. Note that the standard deviation
 * for length as a function of mag is given for natural-log(length) not length.
 * <p>
 * 
