 ...
 * standard deviation of the scalar value as a function of magnitude). The
 * values can also be a function of rake</b>
 * <p>
 * 
...
public abstract class MagScalingRelationship implements NamedObjectAPI {
    ...
    /**
     * Computes the median magnitude from some scalar value (for the previously
     * set or default rake)
     * 
    ...
    /**
     * This gives the magnitude standard deviation (for the previously set or
     * default rake)
     * 
     * @return median magnitude
     */
    ...
    /**
     * Computes the median scalar value from magnitude (for a previously set or
     * default rake)
     */
