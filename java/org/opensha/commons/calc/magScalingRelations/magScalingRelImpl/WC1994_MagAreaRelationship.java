 ...
 * Seism. Soc. Am., pages 974-2002) magnitude versus rupture area relationships.
 * The values are a function of rake. Setting the rake to Double.NaN causes
 * their "All" rupture-types to be applied (and this is the default value for
 * rake). Note that the standard deviation for area as a function of mag is
 * given for log(area) (base-10) not area.
 * <p>
 * 
...
public class WC1994_MagAreaRelationship extends MagAreaRelationship {
    ...
    /**
     * Computes the median magnitude from rupture area (for the previously set
     ...
     * the previously set or default rake). Note that thier "All" case is
     ...
     * void main(String args[]) { WC1994_MagAreaRelationship magRel = new
     ...
     * System.out.print("4 "); System.out.print(magRel.getMedianArea(4,
     * 0.0)+"  "); System.out.print(magRel.getMedianArea(4, 90.0)+"  ");
     * System.out.print(magRel.getMedianArea(4, -90.0)+"  ");
     * System.out.print(magRel.getMedianArea(4, Double.NaN)+"\n");
     * 
     * System.out.print("6  "); System.out.print(magRel.getMedianArea(6,
     * 0.0)+"  "); System.out.print(magRel.getMedianArea(6, 90.0)+"  ");
     * System.out.print(magRel.getMedianArea(6, -90.0)+"  ");
     * System.out.print(magRel.getMedianArea(6, Double.NaN)+"\n");
     * 
     * System.out.print("8  "); System.out.print(magRel.getMedianArea(8,
     * 0.0)+"  "); System.out.print(magRel.getMedianArea(8, 90.0)+"  ");
