 ...
 * 
 * <b>Description:</b> This implements the mag-area relationship defined for the
 * PEER PSHA test cases (based on log(A)=Mag-4.0 w/ stdDev=0.25. . All
 * calculations are completely independent of rake (i.e., you can set the rake
...
public class PEER_testsMagAreaRelationship extends MagAreaRelationship {
    ...
    /*
     * public static void main(String args[]) { PEER_testsMagAreaRelationship
     * magRel = new PEER_testsMagAreaRelationship();
