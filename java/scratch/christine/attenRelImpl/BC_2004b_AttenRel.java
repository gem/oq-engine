...
/**
 * <b>Title:</b> BC 2004_ Site Specific AttenRel with CB 2008<p>
 *
...
public class BC_2004b_AttenRel
  ...
  // debugging stuff:
  private final static String C = "BC_2004b_AttenRel";
  private final static boolean D = false;
  public final static String NAME = "Bazzuro and Cornell (2004) with CB 2008";
  public final static String SHORT_NAME = "BC2004b";
   ...
   */
  protected BC_2004b_AttenRelCoefficients coeffs = null;
  ...
  private transient ParameterChangeWarningListener warningListener = null;
   ...
   public BC_2004b_AttenRel(ParameterChangeWarningListener warningListener) {
...
//        cb_2008_attenRel.COMPONENT_AVE_HORZ);
  ...
  protected void updateCoefficients() throws ParameterException {
    ...
    if (horzCoeffs.containsKey(key.toString())) {
      coeffs = (BC_2004b_AttenRelCoefficients) horzCoeffs.get(key.toString());
    }
    else {
...
//    exceedProbIndependentParams.addParameter(componentParam);
  ...
  /**
   *  <b>Title:</b> BC_2004b_AttenRelCoefficients<br>
  ...
  class BC_2004b_AttenRelCoefficients
      implements NamedObjectAPI {

    protected final static String C = "BC_2004b_AttenRelCoefficients";
    ...
    /**
     *  Constructor for the BC_2004b_AttenRelCoefficients object that sets all values at once
     *
     * @param  name  Description of the Parameter
     */
    public BC_2004b_AttenRelCoefficients(String name, double period,
