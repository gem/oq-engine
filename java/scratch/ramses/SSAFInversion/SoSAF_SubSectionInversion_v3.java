...
public class SoSAF_SubSectionInversion_v3 {
 ...
 //System.out.println(faultSectionPrefData.getSectionName()+"\t"+numSubSections[i]);
	...
	public static void main(String[] args) {
		...
		double relative_smoothnessWt = 10; // 10 (Ned) or 10000(MP)
		double relativeSlipRateSmoothnessWt = 0; // 1000
		boolean wtedInversion = true;
		double minRupRate = 1e-6; // 1e-6
		...
		int slipRateSmoothing = 5; // Only used if slipRateConstraintAtSegCentersOnly=false
		double relativeGR_constraintWt = 1e6; // 1e6 (Ned) // 1e4 (Morgan)
