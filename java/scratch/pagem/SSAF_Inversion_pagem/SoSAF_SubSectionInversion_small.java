 ...
 * 
 */
public class SoSAF_SubSectionInversion_small {
	...
	public SoSAF_SubSectionInversion_small() {
	...
	private static double[] getSimulatedAnnealing_solution(double[][] A,
		...
		for (iter = 1; iter <= numiter; iter++) {
			...
			if ((double) iter / 10000000 == Math.floor(iter / 10000000)) {
	...
	public static void main(String[] args) {
		...
		SoSAF_SubSectionInversion_small soSAF_SubSections = new SoSAF_SubSectionInversion_small();
		...
		boolean transitionAseisAtEnds = false;
		boolean transitionSlipRateAtEnds = false;
