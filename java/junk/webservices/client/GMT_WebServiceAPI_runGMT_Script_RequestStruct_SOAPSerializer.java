...
public class GMT_WebServiceAPI_runGMT_Script_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        junk.webservices.client.GMT_WebServiceAPI_runGMT_Script_RequestStruct instance = new junk.webservices.client.GMT_WebServiceAPI_runGMT_Script_RequestStruct();
        junk.webservices.client.GMT_WebServiceAPI_runGMT_Script_RequestStruct_SOAPBuilder builder = null;
        Object member;
        ...
        for (int i=0; i<2; i++) {
            ...
            if (elementName.equals(ns1_arrayOfString_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new junk.webservices.client.GMT_WebServiceAPI_runGMT_Script_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeInstance(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        junk.webservices.client.GMT_WebServiceAPI_runGMT_Script_RequestStruct instance = (junk.webservices.client.GMT_WebServiceAPI_runGMT_Script_RequestStruct)obj;
