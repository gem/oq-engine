...
public class GMT_WebServiceAPI_runGMT_Script_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        junk.webservices.client.GMT_WebServiceAPI_runGMT_Script_ResponseStruct instance = new junk.webservices.client.GMT_WebServiceAPI_runGMT_Script_ResponseStruct();
        junk.webservices.client.GMT_WebServiceAPI_runGMT_Script_ResponseStruct_SOAPBuilder builder = null;
        Object member;
        ...
        if (reader.getState() == XMLReader.START) {
            ...
            if (member instanceof SOAPDeserializationState) {
                if (builder == null) {
                    builder = new junk.webservices.client.GMT_WebServiceAPI_runGMT_Script_ResponseStruct_SOAPBuilder();
                }
    ...
    public void doSerializeInstance(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        junk.webservices.client.GMT_WebServiceAPI_runGMT_Script_ResponseStruct instance = (junk.webservices.client.GMT_WebServiceAPI_runGMT_Script_ResponseStruct)obj;
