...
<pre>
oq-engine --run-hazard=/usr/share/openquake/risklib/demos/SimpleFaultSourceClassicalPSHA/job.ini --no-distribute
</pre>
...
<pre>
oq-engine --run-hazard=/usr/share/openquake/risklib/demos/SimpleFaultSourceClassicalPSHA/job.ini
</pre>
