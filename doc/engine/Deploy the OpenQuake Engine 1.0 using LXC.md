...
```
Download the OpenQuake LXC archive (current released version is [[http://ftp.openquake.org/oq-1.0/lxc/Ubuntu_lxc_12.04_64_oq_1.0-2.tar.bz2]])
```bash
$ cd ~ && wget http://ftp.openquake.org/oq-1.0/lxc/Ubuntu_lxc_12.04_64_oq_1.0-2.tar.bz2
```
### Extract the OpenQuake LXC archive
```bash
$ sudo tar --numeric-owner -C /var/lib/lxc -xpsjf ~/Ubuntu_lxc_12.04_64_oq_1.0-2.tar.bz2
```
...
### Useful links
* https://github.com/gem/oq-engine/wiki/Installing-the-OpenQuake-Engine-1.0
