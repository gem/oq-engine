...
(Listing~\ref{lst:config_scenario_damage}) are the \Verb+region+,
...
\begin{itemize}
  ...
  \item \Verb+region+: this is an optional parameter which defines the polygon
    ...
    region = lon\_1 lat\_1, lon\_2 lat\_2, ..., lon\_n lat\_n
    ...
    If the \Verb+region+ is not provided, all assets in the exposure
