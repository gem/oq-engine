...
htmlhelp_basename = 'OpenQuakeEngineManual'
...
man_pages = [
    (master_doc, 'openquakeenginemanual', u'OpenQuake Engine Manual',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OpenQuakeEngineManual', u'OpenQuake Engine Manual',
     author, 'OpenQuake Engine Manual', 'User manual for OpenQuake Engine',
     'Miscellaneous'),
]
