...
\noindent
   ...
   GEM (2019). The OpenQuake-engine User Manual.
   \textit{Global Earthquake Model (GEM) OpenQuake Manual for Engine version 3.4.0.\\
   doi: 10.13117/GEM.OPENQUAKE.MAN.ENGINE.3.4.0, \pageref{LastPage} pages.} \hfill \\
\noindent \hfill\\
\noindent
   {\bf{Disclaimer}} \hfill \\
...
\noindent \copyright\ \textsc{2013--2019 GEM Foundation}\\
\noindent \textit{marzo 2019} % Printing/edition date
