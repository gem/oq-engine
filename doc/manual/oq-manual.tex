...
\noindent
   ...
   GEM (2021). The OpenQuake-engine User Manual.
   \textit{Global Earthquake Model (GEM) OpenQuake Manual for Engine version 3.12.0.\\
   doi: 10.13117/GEM.OPENQUAKE.MAN.ENGINE.3.12.0, \pageref{LastPage} pages.} \hfill \\
\noindent \hfill\\
\noindent
   {\bf{Disclaimer}} \hfill \\
...
\noindent \copyright\ \textsc{2013--2021 GEM Foundation}\\
\noindent \textit{maggio 2021} % Printing/edition date
