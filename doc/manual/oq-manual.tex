...
\noindent
   ...
   Graeme Weatherill$^2$, Helen Crowley$^3$, Damiano Monelli\hfill \\
   \hfill \\
   \small
   ...
   Italy \hfill \newline
   &
   $^2$ Helmholtz Centre Potsdam - GFZ \hfill \newline
   Helmholtzstraße 6/7 \hfill \newline
   14467 Potsdam \hfill \newline
   Germany \hfill \newline
   graeme.weatherill@gfz-potsdam.de \hfill \newline
   &
   $^3$ EUCENTRE \hfill \newline
   via Ferrata, 1 \hfill \newline
   20133 Pavia \hfill \newline
   Italy \hfill \newline
   helen.crowley@eucentre.it \hfill \newline
   \end{tabular} \hfill \newline
   %
   Email address for authors at GEM Foundation:\hfill\\
...
\noindent
   ...
   doi: 10.13117/GEM.OPENQUAKE.MAN.ENGINE.2.6/01, 193 pages.} \hfill \\
\noindent \hfill\\
\noindent
   {\bf{Disclaimer}} \hfill \\
...
\noindent \textit{Twelfth printing, February 2017} % Printing/edition date
