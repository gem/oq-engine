...
Usually we create verification tables using an independent code provided by the original authors of the new GSIM. If this is not possible - if available - we use an independent implementation available within code accessible on the web. If verification tables are missing, this must be clearly stated as in this example https://github.com/gem/oq-engine/blob/engine-3.14/openquake/hazardlib/gsim/raghukanth_iyengar_2007.py#L119
...
https://github.com/gem/oq-engine/blob/engine-3.14/doc/sphinx/openquake.hazardlib.gsim.rst
...
https://github.com/gem/oq-engine/blob/engine-3.14/debian/changelog following the [Developers notes](updating-the-changelog.md)
