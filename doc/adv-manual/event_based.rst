...
*Proportional* treaties are identified by the parameter ``type="prop"``.
...
- **deductible**: only applicable to *non-proportional* treaties, the maximum retention
...
reinsurance treaties. The following output files are produced:
    ...
    3. ``Average reinsurance losses``: the average reinsurance losses
        ...
        cessions under each reinsurance treaty for all polciies in the
        Exposure Model.
