...
In engine 3.9 this feature has been hidden and it is not used anymore
by default. However, you will not get the same results than in engine
...
.. _rupture radius: https://github.com/gem/oq-engine/blob/engine-3.9/openquake/hazardlib/source/point.py
