...
if it_is_master:
    release = "development (%s)" % (engine.__version__,)
else:
...
#html_title = None
html_title = 'OpenQuake for Advanced Users %s%s' % (version, branch)
...
htmlhelp_basename = 'OpenQuakeforAdvancedUsersdoc'
...
man_pages = [
    (master_doc, 'openquakeforadvancedusers', u'OpenQuake for Advanced Users Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OpenQuakeforAdvancedUsers', u'OpenQuake for Advanced Users Documentation',
     author, 'OpenQuakeforAdvancedUsers', 'One line description of project.',
     'Miscellaneous'),
]
