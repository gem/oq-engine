...
The demo files are available `here <https://github.com/gem/oq-engine/tree/engine-3.22/demos/hazard>`__. Feel free to run such examples and to play with the inputs and the outputs.
...
link: `gem/oq-engine <https://github.com/gem/oq-engine/tree/engine-3.22/demos/risk>`_.
...
The documentation for the **bold** analysis cases is a work in progress. However, the demo files are available `here <https://github.com/gem/oq-engine/tree/engine-3.22/demos/risk>`__.
