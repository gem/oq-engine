...
Since version 3.11 of the OpenQuake-engine, there is a universal installation script that works on any platform, provided you have a suitable Python installed (currently Python 3.11, 3.12 and 3.13 are supported by the engine). If not, you should install a suitable version of Python according to your platform preferred mechanism.
...
> <br />
>_**Note 2.** Macs with the Apple silicon CPU are supported only if you're on macOS 14.x or MacOS 15.x and for python3.11 and python3.12 and python3.13
><br />_ Apple ships its own version of Python. However, we strongly recommend installing the Python  version from the official Python website (python.org)
> <br />
...
**on Windows:**
```
C:\>curl.exe -L -O https://github.com/gem/oq-engine/raw/engine-3.25/install.py
...
```
$ curl -L -O https://github.com/gem/oq-engine/raw/engine-3.25/install.py
