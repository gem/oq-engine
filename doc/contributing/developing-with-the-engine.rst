...
`gem/oq-engine <development>`_

It is also possible to develop on Windows (`gem/oq-engine <development>`_) but very few people in GEM are doing that, so you are on your
