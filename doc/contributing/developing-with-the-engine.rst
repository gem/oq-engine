...
which is tested and guaranteed to run is the one at https://github.com/gem/oq-engine/blob/engine-3.22/demos/risk/ScenarioRisk/sensitivity.py, which also sets the environment
