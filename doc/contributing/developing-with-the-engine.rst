...
:ref:`gem/oq-engine <development>`

It is also possible to develop on Windows (:ref:`gem/oq-engine <development>`) but very few people in GEM are doing that, so you are on your
