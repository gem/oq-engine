...
which is tested and guaranteed to run is the one at https://github.com/gem/oq-engine/blob/engine-3.25/demos/risk/ScenarioRisk/sensitivity.py, which also sets the environment
...
If you are an hazard scientist, you will likely want to interact with
