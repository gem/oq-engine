...
The demo files are located in `~/openquake/share/demos` for standard installations or *your_custom_folder*`/share/demos` if a different folder is specified during installation.
