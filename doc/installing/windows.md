...
Download the installer from https://downloads.openquake.org/pkgs/windows/oq-engine/OpenQuake_Engine_3.5.0-3.exe using any browser and run the installer, then follow the wizard on screen.
