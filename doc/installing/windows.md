...
Download the installer from http://www.globalquakemodel.org/pkgs/windows/oq-engine/OpenQuake_Engine_2.4.0-2.exe using any browser and run the installer, then follow the wizard on screen.
