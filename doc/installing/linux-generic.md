...
Download the installer from http://storage.globalquakemodel.org/pkgs/linux/oq-engine/openquake-setup-linux64-2.2.0-1.run using any browser

From a terminal run

```bash
cd Downloads
chmod +x openquake-setup-linux64-2.2.0-1.run
./openquake-setup-linux64-2.2.0-1.run
```
