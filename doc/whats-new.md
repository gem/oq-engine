...
The temporary pickled files generated by engine 3.2 has been
...
avoid slow tasks, which however ca be still an issue, unless you use
...
for Cat Risk purposes and has been finally fixed. Now an event belong
...
We disabled it by default, to avoid getting non-positive define
