...
Network is made with a link aggregation between two 10 gigabit connections; up to a couple hundred celery workers a single gigabit connection is enough.
