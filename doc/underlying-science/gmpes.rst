...
Ground-motion residual correlation
**********************************

The residuals around the median predicted by a GSIM can be correlated across
sites, across intensity measure types, or both. The scientifically appropriate
model also depends on whether within-event, between-event, or total residuals
are being considered. OpenQuake provides residual-specific configuration and
interfaces for spatial, cross-IMT and direct joint models.

See :doc:`correlation-models` for the scientific background, currently
available models, configuration and computational implications.
