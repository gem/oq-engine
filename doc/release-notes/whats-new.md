...
it was in past versions of the engine - excluding for the minimum
magnitude filter - and therefore you will see all the possible
ruptures generated by the sources, even at locations far away from the
given sites; however, they will be filtered and discarded when
