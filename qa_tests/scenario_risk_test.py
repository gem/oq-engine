...
class ScenarioRiskTestCase(unittest.TestCase):
    ...
    def test_mean_based(self):
        ...
        calculator = api.scenario_risk(vulnerability_model, None, None)
        ...
        self.assertAlmostEqual(440.147078317589, asset_output.mean)
        ...
        self.assertAlmostEqual(180.717534009275, asset_output.mean)
        ...
        self.assertAlmostEqual(432.225448142534, asset_output.mean)

        self.assertAlmostEqual(186.864456949986,
            asset_output.standard_deviation)

        total_losses = scenario.aggregate_losses([calculator.aggregate_losses])
    ...
    def test_sample_based(self):
        ...
        self.assertAlmostEqual(1233.26, total_losses[0], delta=0.05 * 1233.26)
