...
class EventBaseQATestCase2(risk.CompleteTestCase, risk.FixtureBasedQATestCase):
    ...
    expected_elt = [
        ('col=00|ses=0013|src=1|rup=003-01', 5.85, 2033.11562854),
        ('col=00|ses=0019|src=3|rup=004-01', 6.15, 1586.04744656),
        ('col=00|ses=0019|src=1|rup=004-01', 6.15, 1173.63337907),
        ('col=00|ses=0016|src=2|rup=005-01', 6.45, 1120.1768802),
        ('col=00|ses=0018|src=2|rup=001-01', 5.25, 1120.08595039),
        ('col=00|ses=0005|src=2|rup=001-01', 5.25, 1119.98450891),
        ('col=00|ses=0013|src=2|rup=001-01', 5.25, 1074.88832758),
        ('col=00|ses=0003|src=1|rup=001-01', 5.25, 815.483004866),
        ('col=00|ses=0004|src=1|rup=003-01', 5.85, 744.047680872),
        ('col=00|ses=0005|src=3|rup=002-01', 5.55, 575.464242323),
        ('col=00|ses=0018|src=3|rup=001-01', 5.25, 511.548977101),
        ('col=00|ses=0003|src=1|rup=001-02', 5.25, 432.753660021),
        ('col=00|ses=0006|src=1|rup=004-01', 6.15, 237.82338926),
        ('col=00|ses=0015|src=2|rup=001-01', 5.25, 217.751093258),
        ('col=00|ses=0009|src=2|rup=005-01', 6.45, 137.719501569),
        ('col=00|ses=0011|src=2|rup=002-01', 5.55, 124.731722658),
        ('col=00|ses=0018|src=2|rup=001-03', 5.25, 117.308215526),
        ('col=00|ses=0003|src=2|rup=001-01', 5.25, 96.5702659374),
        ('col=00|ses=0018|src=2|rup=001-02', 5.25, 71.8709085026),
    ]
