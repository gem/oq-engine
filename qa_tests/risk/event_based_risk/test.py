...
class EventBaseQATestCase1(risk.CompleteTestCase, risk.FixtureBasedQATestCase):
    ...
    expected_elt_b2 = [  # the first 10 values for structural
        ('col=00|ses=1250|src=3|rup=002-01', 5.55, 4598.15454207),
        ('col=00|ses=0899|src=3|rup=006-01', 6.75, 3229.03853895),
        ('col=00|ses=0236|src=3|rup=004-01', 6.15, 1429.41738598),
        ('col=00|ses=0833|src=3|rup=006-01', 6.75, 1333.06460009),
        ('col=00|ses=1159|src=3|rup=001-02', 5.25, 1027.93870557),
        ('col=00|ses=1395|src=3|rup=001-01', 5.25, 1004.52792749),
        ('col=00|ses=0410|src=3|rup=001-01', 5.25, 801.220856365),
        ('col=00|ses=1652|src=3|rup=003-01', 5.85, 710.514040648),
        ('col=00|ses=0986|src=3|rup=001-01', 5.25, 661.852362756),
        ('col=00|ses=0296|src=3|rup=002-01', 5.55, 605.144033155),
    ]
...
class EventBaseQATestCase2(risk.CompleteTestCase, risk.FixtureBasedQATestCase):
    ...
    expected_elt = [
        ('col=01|ses=0013|src=1|rup=003-01', 5.85, 2033.11562854),
        ('col=01|ses=0019|src=3|rup=004-01', 6.15, 1586.04744656),
        ('col=01|ses=0019|src=1|rup=004-01', 6.15, 1173.63337907),
        ('col=01|ses=0016|src=2|rup=005-01', 6.45, 1120.1768802),
        ('col=01|ses=0018|src=2|rup=001-01', 5.25, 1120.08595039),
        ('col=01|ses=0005|src=2|rup=001-01', 5.25, 1119.98450891),
        ('col=01|ses=0013|src=2|rup=001-01', 5.25, 1074.88832758),
        ('col=01|ses=0003|src=1|rup=001-01', 5.25, 815.483004866),
        ('col=01|ses=0004|src=1|rup=003-01', 5.85, 744.047680872),
        ('col=01|ses=0005|src=3|rup=002-01', 5.55, 575.464242323),
        ('col=01|ses=0018|src=3|rup=001-01', 5.25, 511.548977101),
        ('col=01|ses=0003|src=1|rup=001-02', 5.25, 432.753660021),
        ('col=01|ses=0006|src=1|rup=004-01', 6.15, 237.82338926),
        ('col=01|ses=0015|src=2|rup=001-01', 5.25, 217.751093258),
        ('col=01|ses=0009|src=2|rup=005-01', 6.45, 137.719501569),
        ('col=01|ses=0011|src=2|rup=002-01', 5.55, 124.731722658),
        ('col=01|ses=0018|src=2|rup=001-03', 5.25, 117.308215526),
        ('col=01|ses=0003|src=2|rup=001-01', 5.25, 96.5702659374),
        ('col=01|ses=0018|src=2|rup=001-02', 5.25, 71.8709085026),
    ]
