...
'''
Module: hmtk.parsers.strain.strain_csv_parser contains the :classes:
...
class WriteStrainCsv(object):
    '''
    :class: hmtk.parsers.strain_csv_parser.WriteStrainCsv writes a strain
    model (defined by :class: hmtk.strain.geodetic_strain.GeodeticStrain) to
    a headed csv file
    ...
    def write_file(self, strain, scaling_factor=1E-9):
        ...
        :param strain:
            Instance of :class: hmtk.strain.geodetic_strain.GeodeticStrain
        :param float scaling_factor:
            Scaling factor used for all strain values (default 1E-9 for
            nanostrain)
        '''
