...
class PlanarSurfaceGetMeshTestCase(utils.SurfaceTestCase):
    ...
    def test_2(self):
        self.assert_mesh_is(PlanarSurface(*test_data.TEST_2_CORNERS),
                mesh_spacing=1,
                expected_mesh=test_data.TEST_2_MESH)

    def test_3(self):
        self.assert_mesh_is(PlanarSurface(*test_data.TEST_3_CORNERS),
                mesh_spacing=1,
                expected_mesh=test_data.TEST_3_MESH)

    def test_4(self):
        self.assert_mesh_is(PlanarSurface(*test_data.TEST_4_CORNERS),
                mesh_spacing=1,
                expected_mesh=test_data.TEST_4_MESH)

    def test_5(self):
        self.assert_mesh_is(PlanarSurface(*test_data.TEST_5_CORNERS),
                mesh_spacing=1,
    ...
    def test_6(self):
        ...
        mesh = [[(0, 0, 9)]]
        self.assert_mesh_is(PlanarSurface(*corners),
                mesh_spacing=1,
                expected_mesh=mesh)

    def test_7_rupture_1(self):
        self.assert_mesh_is(PlanarSurface(*test_data.TEST_7_RUPTURE_1_CORNERS),
                mesh_spacing=1,
                expected_mesh=test_data.TEST_7_RUPTURE_1_MESH)

    def test_7_rupture_2(self):
        self.assert_mesh_is(PlanarSurface(*test_data.TEST_7_RUPTURE_2_CORNERS),
                mesh_spacing=1,
                expected_mesh=test_data.TEST_7_RUPTURE_2_MESH)

    def test_7_rupture_3(self):
        self.assert_mesh_is(PlanarSurface(*test_data.TEST_7_RUPTURE_3_CORNERS),
                mesh_spacing=1,
                expected_mesh=test_data.TEST_7_RUPTURE_3_MESH)

    def test_7_rupture_4(self):
        self.assert_mesh_is(PlanarSurface(*test_data.TEST_7_RUPTURE_4_CORNERS),
                mesh_spacing=1,
                expected_mesh=test_data.TEST_7_RUPTURE_4_MESH)

    def test_7_rupture_5(self):
        self.assert_mesh_is(PlanarSurface(*test_data.TEST_7_RUPTURE_5_CORNERS),
                mesh_spacing=1,
                expected_mesh=test_data.TEST_7_RUPTURE_5_MESH)

    def test_7_rupture_6(self):
        self.assert_mesh_is(PlanarSurface(*test_data.TEST_7_RUPTURE_6_CORNERS),
                mesh_spacing=1,
                expected_mesh=test_data.TEST_7_RUPTURE_6_MESH)

    def test_7_rupture_7(self):
        self.assert_mesh_is(PlanarSurface(*test_data.TEST_7_RUPTURE_7_CORNERS),
                mesh_spacing=1,
                expected_mesh=test_data.TEST_7_RUPTURE_7_MESH)

    def test_7_rupture_8(self):
        self.assert_mesh_is(PlanarSurface(*test_data.TEST_7_RUPTURE_8_CORNERS),
                mesh_spacing=1,
