...
INSERT INTO pshai.complex_fault(owner_id, gid, mfd_evd_id, fault_edge_id) SELECT 1, 'src/cfault/sa/ca/1', 1, fedge.id FROM pshai.fault_edge WHERE gid='fedge/sa/ca/1';

INSERT INTO pshai.source(owner_id, gid, si_type, tectonic_region, complex_fault_id) SELECT 1, 'complex-source/sa/ca/10', 'complex', 'active', cfault.id FROM pshai.complex_fault WHERE gid='src/cfault/sa/ca/1';

INSERT INTO pshai.r_rate_mdl(owner_id, gid, mfd_tgr_id, focal_mechanism_id, source_id) SELECT 1, 'src/1/r_rate_mdl/1', 1, 1, src.id FROM pshai.source WHERE gid='complex-source/sa/ca/10';

INSERT INTO pshai.r_depth_distr(owner_id, gid, magnitude, depth) VALUES(1, 'r_depth_distr/1', '{1.0, 2.0}', '{3.0, 4.0}');

INSERT INTO pshai.source(owner_id, gid, tectonic_region, rake, point, hypocentral_depth, r_depth_distr_id, si_type) VALUES(1, 'point-source/8', 1, 11.0, ST_GeomFromEWKT('SRID=4326;POINT(-80 28)'), 79.0, 1, 'point');
...
INSERT INTO pshai.rupture(owner_id, gid, tectonic_region, rake, magnitude, magnitude_type_id, simple_fault_id, point) VALUES(1, 'rupture/2', 1, 11.0, 7.6, 1, 1, ST_GeomFromEWKT('SRID=4326;POINT(-80 28 0)'));
...
INSERT INTO pshai.rupture(owner_id, gid, tectonic_region, rake, magnitude, magnitude_type_id)  VALUES(1, 'rupture/3', 1, 11.0, 7.6, 1);
