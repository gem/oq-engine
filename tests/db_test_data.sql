...
INSERT INTO pshai.rupture(owner_id, gid, tectonic_region, rake, magnitude, simple_fault_id) SELECT 1, 'rupture/1', 'volcanic', 11.0, 7.6, sfault.id from pshai.simple_fault AS sfault WHERE gid='sfault/1';

INSERT INTO pshai.source(owner_id, gid, tectonic_region, rake, simple_fault_id) SELECT 1, 'source/1', 'intraslab', 11.0, sfault.id from pshai.simple_fault AS sfault WHERE gid='sfault/1';
...
INSERT INTO pshai.complex_fault(owner_id, gid, mfd_evd_id, fault_edge_id) SELECT 1, 'src/cfault/sa/ca/1', 1, fedge.id FROM pshai.fault_edge AS fedge WHERE gid='fedge/sa/ca/1';

INSERT INTO pshai.source(owner_id, gid, si_type, tectonic_region, complex_fault_id) SELECT 1, 'complex-source/sa/ca/10', 'complex', 'active', cfault.id FROM pshai.complex_fault cfault WHERE gid='src/cfault/sa/ca/1';

INSERT INTO pshai.r_rate_mdl(owner_id, gid, mfd_tgr_id, focal_mechanism_id, source_id) SELECT 1, 'src/1/r_rate_mdl/1', 1, 1, src.id FROM pshai.source AS src WHERE gid='complex-source/sa/ca/10';

INSERT INTO pshai.r_depth_distr(owner_id, gid, magnitude, depth) VALUES(1, 'r_depth_distr/1', '{1.0, 2.0}', '{3.0, 4.0}');

INSERT INTO pshai.source(owner_id, gid, tectonic_region, rake, point, hypocentral_depth, r_depth_distr_id, si_type) VALUES(1, 'point-source/8', 'intraslab', 11.0, ST_GeomFromEWKT('SRID=4326;POINT(-80 28)'), 79.0, 1, 'point');
...
INSERT INTO pshai.rupture(owner_id, gid, tectonic_region, rake, magnitude, simple_fault_id, point) VALUES(1, 'rupture/2', 1, 11.0, 7.6, 1, ST_GeomFromEWKT('SRID=4326;POINT(-80 28 0)'));

-- Failure due to duplicate source (point)
UPDATE pshai.rupture SET point=ST_GeomFromEWKT('SRID=4326;POINT(-80 28 0)') WHERE id=1;

-- Failure due to duplicate source (point)
INSERT INTO pshai.source(owner_id, gid, tectonic_region, rake, simple_fault_id, point) VALUES(1, 'source/2', 1, 11.0, 1, ST_GeomFromEWKT('SRID=4326;POINT(-80 28)'));
...
INSERT INTO pshai.source(owner_id, gid, tectonic_region, rake)  VALUES(1, 'source/3', 1, 11.0);
INSERT INTO pshai.rupture(owner_id, gid, tectonic_region, rake, magnitude)  VALUES(1, 'rupture/3', 1, 11.0, 7.6);
...
INSERT INTO pshai.source(owner_id, gid, tectonic_region, rake, simple_fault_id, hypocentral_depth) VALUES(1, 'source/4', 1, 11.0, 1, 99.0);
INSERT INTO pshai.source(owner_id, gid, tectonic_region, rake, simple_fault_id, r_depth_distr_id) VALUES(1, 'source/5', 1, 11.0, 1, 1);
UPDATE pshai.source SET hypocentral_depth=1.1 WHERE id=1;
UPDATE pshai.source SET r_depth_distr_id=1 WHERE id=1;

-- Failure due to superfluous hypocentral_depth/r_depth_distr_id
INSERT INTO pshai.source(owner_id, gid, tectonic_region, rake, simple_fault_id, hypocentral_depth) VALUES(1, 'source/6', 1, 11.0, 1, 99.0);
INSERT INTO pshai.source(owner_id, gid, tectonic_region, rake, simple_fault_id, r_depth_distr_id) VALUES(1, 'source/7', 1, 11.0, 1, 1);
UPDATE pshai.source SET hypocentral_depth=1.1 WHERE id=1;
UPDATE pshai.source SET r_depth_distr_id=1 WHERE id=1;

-- Failure due to missing hypocentral_depth/r_depth_distr_id
INSERT INTO pshai.source(owner_id, gid, tectonic_region, rake, point, r_depth_distr_id) VALUES(1, 'source/8', 1, 11.0, ST_GeomFromEWKT('SRID=4326;POINT(-80 28)'), 1);
INSERT INTO pshai.source(owner_id, gid, tectonic_region, rake, point, hypocentral_depth) VALUES(1, 'source/8', 1, 11.0, ST_GeomFromEWKT('SRID=4326;POINT(-80 28)'), 79.0);
