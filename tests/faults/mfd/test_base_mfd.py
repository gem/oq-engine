...
function hmtk.faults.mfd.base._scale_moment
'''

import unittest
from math import log10
from hmtk.faults.mfd.base import BaseMFDfromSlip, _scale_moment

class TestScaleMoment(unittest.TestCase):
    '''
    Tests the small ancillary function hmtk.fault.mfd.base._scale_moment, which
