...
class PlanarSurfaceCreationTestCase(unittest.TestCase):
    def assert_failed_creation(self, mesh_spacing, corners, exc, msg):
        with self.assertRaises(exc) as ae:
            PlanarSurface(mesh_spacing, *corners)
    ...
    def test_top_edge_depth_differs(self):
        ...
        self.assert_failed_creation(1, corners, ValueError,
    ...
    def test_non_positive_mesh_spacing(self):
        ...
        self.assert_failed_creation(0, corners, ValueError, msg)
        self.assert_failed_creation(-1, corners, ValueError, msg)

    def assert_successfull_creation(self, tl, tr, br, bl):
        surface = PlanarSurface(1.33, tl, tr, br, bl)
        ...
        self.assertEqual(surface.mesh_spacing, 1.33)
...
class PlanarSurfaceGetMeshTestCase(unittest.TestCase):
    def _test(self, corner_points, mesh_spacing, expected_mesh):
        surface = PlanarSurface(mesh_spacing, *corner_points)
...
class PlanarSurfaceGetMinDistanceTestCase(unittest.TestCase):
    def test_1(self):
        surface = PlanarSurface(1, *test_data.TEST_7_RUPTURE_6_CORNERS)
    ...
    def test_3(self):
        surface = PlanarSurface(1, *test_data.TEST_7_RUPTURE_2_CORNERS)
