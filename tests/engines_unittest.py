...
GMF = {"IMLs": (0.079888, 0.273488, 0.115856, 0.034912, 0.271488, 0.00224, 0.04336, 0.099552, 0.071968,
...
class ProbabilisticEventBasedCalculatorTestCase(unittest.TestCase):
    ...
    def test_computes_the_loss_ratio_curve(self):
        ...
        vuln_curve = self.vuln_function = shapes.Curve([(0.01, (0.001, 1.00)), (0.04, (0.022, 1.0)), 
