...
class AbrahamsonEtAl2015SInterScaledTestCase(BaseGSIMTestCase):
    """
    Tests the Abrahamson et al. (2015) BC Hydro model for subduction
    interface earthquakes with the central magnitude scaling term
    """
    GSIM_CLASS = AbrahamsonEtAl2015SInter_scaled
    MEAN_FILE = "BCHYDRO/BCHYDRO_SINTER_CENTRAL_scaled_MEAN.csv"
...
class AbrahamsonEtAl2015SSlabScaledTestCase(BaseGSIMTestCase):
    """
    Tests the Abrahamson et al. (2015) BC Hydro model for subduction
    in-slab earthquakes with the central magnitude scaling term
    """
    GSIM_CLASS = AbrahamsonEtAl2015SSlab_scaled
    MEAN_FILE = "BCHYDRO/BCHYDRO_SSLAB_CENTRAL_scaled_MEAN.csv"
