...
_pkgtest_innervm_run () {
    ...
    ssh $lxc_ip "set -e ; sudo su postgres -c\"cd \$HOME/oq-engine ; bash openquake/engine/bin/oq_create_db --yes --db-name=openquake --schema-path=openquake/engine/db/schema\""
