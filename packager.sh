...
_builddoc_innervm_run () {
    ...
    ssh "$lxc_ip" "set -e ; export PATH=/opt/openquake/bin:\$PATH ; sudo -E pip install sphinx ; cd oq-engine; export PYTHONPATH=\$PWD ; cd doc/sphinx ; MPLBACKEND=Agg make html"
