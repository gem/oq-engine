...
* [Continuous integration and testing](https://github.com/gem/oq-hazardlib/blob/master/doc/testing.md)
...
* [Implementing a new GSIM](https://github.com/gem/oq-hazardlib/blob/master/doc/implementing-new-gsim.md)

## License

The OpenQuake Hazardlib is released under the **[GNU Affero Public License 3](https://github.com/gem/oq-hazardlib/blob/master/LICENSE)**.
