...
Current stable version is the **OpenQuake Engine 2.8** 'Housner'. The documentation is available at https://github.com/gem/oq-engine/tree/engine-2.8#openquake-engine.
